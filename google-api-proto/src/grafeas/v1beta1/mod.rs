#[cfg(any(feature = "grafeas-v1beta1-attestation"))]
pub mod attestation;
#[cfg(any(feature = "grafeas-v1beta1-build"))]
pub mod build;
#[cfg(any(feature = "grafeas-v1beta1-deployment"))]
pub mod deployment;
#[cfg(any(feature = "grafeas-v1beta1-discovery"))]
pub mod discovery;
#[cfg(any(feature = "grafeas-v1beta1-image"))]
pub mod image;
#[cfg(any(feature = "grafeas-v1beta1-package"))]
pub mod package;
#[cfg(any(feature = "grafeas-v1beta1-provenance"))]
pub mod provenance;
#[cfg(any(feature = "grafeas-v1beta1-source"))]
pub mod source;
#[cfg(any(feature = "grafeas-v1beta1-vulnerability"))]
