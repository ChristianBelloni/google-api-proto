...
pub mod grafeas_server {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with GrafeasServer.
    #[async_trait]
    pub trait Grafeas: std::marker::Send + std::marker::Sync + 'static {
        /// Gets the specified occurrence.
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for GrafeasServer<T>
    where
        T: Grafeas,
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/grafeas.v1.Grafeas/GetOccurrence" => {
                    ...
                    for GetOccurrenceSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as Grafeas>::get_occurrence(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/grafeas.v1.Grafeas/ListOccurrences" => {
                    ...
                    for ListOccurrencesSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Grafeas>::list_occurrences(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/grafeas.v1.Grafeas/DeleteOccurrence" => {
                    ...
                    for DeleteOccurrenceSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Grafeas>::delete_occurrence(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/grafeas.v1.Grafeas/CreateOccurrence" => {
                    ...
                    for CreateOccurrenceSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Grafeas>::create_occurrence(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/grafeas.v1.Grafeas/BatchCreateOccurrences" => {
                    ...
                    for BatchCreateOccurrencesSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Grafeas>::batch_create_occurrences(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/grafeas.v1.Grafeas/UpdateOccurrence" => {
                    ...
                    for UpdateOccurrenceSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Grafeas>::update_occurrence(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/grafeas.v1.Grafeas/GetOccurrenceNote" => {
                    ...
                    for GetOccurrenceNoteSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Grafeas>::get_occurrence_note(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/grafeas.v1.Grafeas/GetNote" => {
                    ...
                    impl<T: Grafeas> tonic::server::UnaryService<super::GetNoteRequest>
                    for GetNoteSvc<T> {
                        type Response = super::Note;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Grafeas>::get_note(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/grafeas.v1.Grafeas/ListNotes" => {
                    ...
                    impl<T: Grafeas> tonic::server::UnaryService<super::ListNotesRequest>
                    for ListNotesSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Grafeas>::list_notes(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/grafeas.v1.Grafeas/DeleteNote" => {
                    ...
                    for DeleteNoteSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Grafeas>::delete_note(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/grafeas.v1.Grafeas/CreateNote" => {
                    ...
                    for CreateNoteSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Grafeas>::create_note(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/grafeas.v1.Grafeas/BatchCreateNotes" => {
                    ...
                    for BatchCreateNotesSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Grafeas>::batch_create_notes(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/grafeas.v1.Grafeas/UpdateNote" => {
                    ...
                    for UpdateNoteSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Grafeas>::update_note(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/grafeas.v1.Grafeas/ListNoteOccurrences" => {
                    ...
                    for ListNoteOccurrencesSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Grafeas>::list_note_occurrences(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T> Clone for GrafeasServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "grafeas.v1.Grafeas";
    impl<T> tonic::server::NamedService for GrafeasServer<T> {
