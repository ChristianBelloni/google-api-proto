...
pub mod datastore_admin_server {
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/google.datastore.admin.v1.DatastoreAdmin/CreateIndex" => {
                    #[allow(non_camel_case_types)]
                    struct CreateIndexSvc<T: DatastoreAdmin>(pub Arc<T>);
                    impl<
                        T: DatastoreAdmin,
                    ...
                    for CreateIndexSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DatastoreAdmin>::create_index(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.datastore.admin.v1.DatastoreAdmin/DeleteIndex" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteIndexSvc<T: DatastoreAdmin>(pub Arc<T>);
                    impl<
                        T: DatastoreAdmin,
                    ...
                    for DeleteIndexSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DatastoreAdmin>::delete_index(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.datastore.admin.v1.DatastoreAdmin/GetIndex" => {
                    #[allow(non_camel_case_types)]
                    struct GetIndexSvc<T: DatastoreAdmin>(pub Arc<T>);
                    impl<
                        T: DatastoreAdmin,
                    ...
                    for GetIndexSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DatastoreAdmin>::get_index(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.datastore.admin.v1.DatastoreAdmin/ListIndexes" => {
                    #[allow(non_camel_case_types)]
                    struct ListIndexesSvc<T: DatastoreAdmin>(pub Arc<T>);
                    impl<
                        T: DatastoreAdmin,
                    ...
                    for ListIndexesSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DatastoreAdmin>::list_indexes(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "google.datastore.admin.v1.DatastoreAdmin";
