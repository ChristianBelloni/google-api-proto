...
pub mod dashboards_service_server {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with DashboardsServiceServer.
    #[async_trait]
    pub trait DashboardsService: std::marker::Send + std::marker::Sync + 'static {
        /// Creates a new custom dashboard. For examples on how you can use this API to
        /// create dashboards, see [Managing dashboards by
        /// API](https://cloud.google.com/monitoring/dashboards/api-dashboard). This
        /// method requires the `monitoring.dashboards.create` permission on the
    ...
    /// widgets in a specific layout.
    #[derive(Debug)]
    pub struct DashboardsServiceServer<T> {
        inner: Arc<T>,
    ...
    impl<T> DashboardsServiceServer<T> {
        pub fn new(inner: T) -> Self {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for DashboardsServiceServer<T>
    where
        T: DashboardsService,
                ...
                "/google.monitoring.dashboard.v1.DashboardsService/CreateDashboard" => {
                    ...
                    for CreateDashboardSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as DashboardsService>::create_dashboard(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.monitoring.dashboard.v1.DashboardsService/ListDashboards" => {
                    ...
                    for ListDashboardsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DashboardsService>::list_dashboards(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.monitoring.dashboard.v1.DashboardsService/GetDashboard" => {
                    ...
                    for GetDashboardSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DashboardsService>::get_dashboard(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.monitoring.dashboard.v1.DashboardsService/DeleteDashboard" => {
                    ...
                    for DeleteDashboardSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DashboardsService>::delete_dashboard(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.monitoring.dashboard.v1.DashboardsService/UpdateDashboard" => {
                    ...
                    for UpdateDashboardSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DashboardsService>::update_dashboard(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
    ...
    impl<T> Clone for DashboardsServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "google.monitoring.dashboard.v1.DashboardsService";
    impl<T> tonic::server::NamedService for DashboardsServiceServer<T> {
