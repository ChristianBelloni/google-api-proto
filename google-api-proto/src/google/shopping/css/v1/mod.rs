...
pub mod accounts_service_server {
    ...
    #[async_trait]
    pub trait AccountsService: std::marker::Send + std::marker::Sync + 'static {
        /// Lists all the accounts under the specified CSS account ID, and
        /// optionally filters by label ID and account name.
        async fn list_child_accounts(
            &self,
            request: tonic::Request<super::ListChildAccountsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListChildAccountsResponse>,
            tonic::Status,
        >;
        ...
        async fn update_labels(
            &self,
            request: tonic::Request<super::UpdateAccountLabelsRequest>,
        ) -> std::result::Result<tonic::Response<super::Account>, tonic::Status>;
    }
    /// Service for managing CSS/MC account information.
    #[derive(Debug)]
    pub struct AccountsServiceServer<T> {
        inner: Arc<T>,
    ...
    impl<T> AccountsServiceServer<T> {
        pub fn new(inner: T) -> Self {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.shopping.css.v1.AccountsService/ListChildAccounts" => {
                    ...
                    struct ListChildAccountsSvc<T: AccountsService>(pub Arc<T>);
                    impl<
                        T: AccountsService,
                    > tonic::server::UnaryService<super::ListChildAccountsRequest>
                    for ListChildAccountsSvc<T> {
                        type Response = super::ListChildAccountsResponse;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as AccountsService>::list_child_accounts(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let fut = async move {
                        let method = ListChildAccountsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                ...
                "/google.shopping.css.v1.AccountsService/UpdateLabels" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateLabelsSvc<T: AccountsService>(pub Arc<T>);
                    impl<
                        T: AccountsService,
                    > tonic::server::UnaryService<super::UpdateAccountLabelsRequest>
                    for UpdateLabelsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AccountsService>::update_labels(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T> Clone for AccountsServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "google.shopping.css.v1.AccountsService";
    impl<T> tonic::server::NamedService for AccountsServiceServer<T> {
...
/// Generated server implementations.
pub mod account_labels_service_server {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with AccountLabelsServiceServer.
    #[async_trait]
    pub trait AccountLabelsService: std::marker::Send + std::marker::Sync + 'static {
        /// Lists the labels assigned to an account.
        async fn list_account_labels(
            &self,
            request: tonic::Request<super::ListAccountLabelsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListAccountLabelsResponse>,
            tonic::Status,
        >;
        ...
        async fn create_account_label(
            &self,
            request: tonic::Request<super::CreateAccountLabelRequest>,
        ) -> std::result::Result<tonic::Response<super::AccountLabel>, tonic::Status>;
        /// Updates a label.
        async fn update_account_label(
            &self,
            request: tonic::Request<super::UpdateAccountLabelRequest>,
        ) -> std::result::Result<tonic::Response<super::AccountLabel>, tonic::Status>;
        /// Deletes a label and removes it from all accounts to which it was assigned.
        async fn delete_account_label(
            &self,
            request: tonic::Request<super::DeleteAccountLabelRequest>,
        ) -> std::result::Result<tonic::Response<()>, tonic::Status>;
    }
    /// Manages Merchant Center and CSS accounts labels.
    #[derive(Debug)]
    pub struct AccountLabelsServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> AccountLabelsServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    for AccountLabelsServiceServer<T>
    where
        T: AccountLabelsService,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        type Response = http::Response<tonic::body::BoxBody>;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.shopping.css.v1.AccountLabelsService/ListAccountLabels" => {
                    #[allow(non_camel_case_types)]
                    struct ListAccountLabelsSvc<T: AccountLabelsService>(pub Arc<T>);
                    impl<
                        T: AccountLabelsService,
                    > tonic::server::UnaryService<super::ListAccountLabelsRequest>
                    for ListAccountLabelsSvc<T> {
                        type Response = super::ListAccountLabelsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AccountLabelsService>::list_account_labels(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ListAccountLabelsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.shopping.css.v1.AccountLabelsService/CreateAccountLabel" => {
                    #[allow(non_camel_case_types)]
                    struct CreateAccountLabelSvc<T: AccountLabelsService>(pub Arc<T>);
                    impl<
                        T: AccountLabelsService,
                    > tonic::server::UnaryService<super::CreateAccountLabelRequest>
                    for CreateAccountLabelSvc<T> {
                        type Response = super::AccountLabel;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AccountLabelsService>::create_account_label(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = CreateAccountLabelSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.shopping.css.v1.AccountLabelsService/UpdateAccountLabel" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateAccountLabelSvc<T: AccountLabelsService>(pub Arc<T>);
                    impl<
                        T: AccountLabelsService,
                    > tonic::server::UnaryService<super::UpdateAccountLabelRequest>
                    for UpdateAccountLabelSvc<T> {
                        type Response = super::AccountLabel;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AccountLabelsService>::update_account_label(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = UpdateAccountLabelSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.shopping.css.v1.AccountLabelsService/DeleteAccountLabel" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteAccountLabelSvc<T: AccountLabelsService>(pub Arc<T>);
                    impl<
                        T: AccountLabelsService,
                    > tonic::server::UnaryService<super::DeleteAccountLabelRequest>
                    for DeleteAccountLabelSvc<T> {
                        type Response = ();
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AccountLabelsService>::delete_account_label(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = DeleteAccountLabelSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for AccountLabelsServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.shopping.css.v1.AccountLabelsService";
    impl<T> tonic::server::NamedService for AccountLabelsServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
...
/// Generated server implementations.
pub mod css_products_service_server {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with CssProductsServiceServer.
    #[async_trait]
    pub trait CssProductsService: std::marker::Send + std::marker::Sync + 'static {
        /// Retrieves the processed CSS Product from your CSS Center account. After
        /// inserting, updating, or deleting a product input, it may take several
        /// minutes before the updated final product can be retrieved.
        async fn get_css_product(
            &self,
            request: tonic::Request<super::GetCssProductRequest>,
        ) -> std::result::Result<tonic::Response<super::CssProduct>, tonic::Status>;
        /// Lists the processed CSS Products in your CSS Center account. The response
        /// might contain fewer items than specified by pageSize. Rely on pageToken to
        /// determine if there are more items to be requested.
        ...
        async fn list_css_products(
            &self,
            request: tonic::Request<super::ListCssProductsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListCssProductsResponse>,
            tonic::Status,
        >;
    ...
    /// internally).
    #[derive(Debug)]
    pub struct CssProductsServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> CssProductsServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for CssProductsServiceServer<T>
    where
        T: CssProductsService,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        type Response = http::Response<tonic::body::BoxBody>;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.shopping.css.v1.CssProductsService/GetCssProduct" => {
                    #[allow(non_camel_case_types)]
                    struct GetCssProductSvc<T: CssProductsService>(pub Arc<T>);
                    impl<
                        T: CssProductsService,
                    > tonic::server::UnaryService<super::GetCssProductRequest>
                    for GetCssProductSvc<T> {
                        type Response = super::CssProduct;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as CssProductsService>::get_css_product(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetCssProductSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.shopping.css.v1.CssProductsService/ListCssProducts" => {
                    #[allow(non_camel_case_types)]
                    struct ListCssProductsSvc<T: CssProductsService>(pub Arc<T>);
                    impl<
                        T: CssProductsService,
                    > tonic::server::UnaryService<super::ListCssProductsRequest>
                    for ListCssProductsSvc<T> {
                        type Response = super::ListCssProductsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as CssProductsService>::list_css_products(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ListCssProductsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for CssProductsServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.shopping.css.v1.CssProductsService";
    impl<T> tonic::server::NamedService for CssProductsServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
...
/// Generated server implementations.
pub mod css_product_inputs_service_server {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with CssProductInputsServiceServer.
    #[async_trait]
    pub trait CssProductInputsService: std::marker::Send + std::marker::Sync + 'static {
        /// Uploads a CssProductInput to your CSS Center account. If an
        /// input with the same contentLanguage, identity, feedLabel and feedId already
        /// exists, this method replaces that entry.
        ///
        ...
        async fn insert_css_product_input(
            &self,
            request: tonic::Request<super::InsertCssProductInputRequest>,
        ...
        async fn delete_css_product_input(
            &self,
            request: tonic::Request<super::DeleteCssProductInputRequest>,
        ) -> std::result::Result<tonic::Response<()>, tonic::Status>;
    }
    /// Service to use CssProductInput resource.
    /// This service helps to insert/update/delete CSS Products.
    #[derive(Debug)]
    pub struct CssProductInputsServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> CssProductInputsServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>>
    for CssProductInputsServiceServer<T>
    where
        T: CssProductInputsService,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        type Response = http::Response<tonic::body::BoxBody>;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.shopping.css.v1.CssProductInputsService/InsertCssProductInput" => {
                    #[allow(non_camel_case_types)]
                    struct InsertCssProductInputSvc<T: CssProductInputsService>(
                        pub Arc<T>,
                    );
                    impl<
                        T: CssProductInputsService,
                    > tonic::server::UnaryService<super::InsertCssProductInputRequest>
                    for InsertCssProductInputSvc<T> {
                        type Response = super::CssProductInput;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as CssProductInputsService>::insert_css_product_input(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = InsertCssProductInputSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.shopping.css.v1.CssProductInputsService/DeleteCssProductInput" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteCssProductInputSvc<T: CssProductInputsService>(
                        pub Arc<T>,
                    );
                    impl<
                        T: CssProductInputsService,
                    > tonic::server::UnaryService<super::DeleteCssProductInputRequest>
                    for DeleteCssProductInputSvc<T> {
                        type Response = ();
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as CssProductInputsService>::delete_css_product_input(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = DeleteCssProductInputSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for CssProductInputsServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.shopping.css.v1.CssProductInputsService";
    impl<T> tonic::server::NamedService for CssProductInputsServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
