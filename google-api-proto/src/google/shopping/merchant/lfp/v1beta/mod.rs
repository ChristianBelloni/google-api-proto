...
pub mod lfp_store_service_server {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with LfpStoreServiceServer.
    #[async_trait]
    pub trait LfpStoreService: std::marker::Send + std::marker::Sync + 'static {
        /// Retrieves information about a store.
        async fn get_lfp_store(
            &self,
            request: tonic::Request<super::GetLfpStoreRequest>,
        ) -> std::result::Result<tonic::Response<super::LfpStore>, tonic::Status>;
        /// Inserts a store for the target merchant. If the store with the same store
        /// code already exists, it will be replaced.
        async fn insert_lfp_store(
            &self,
            request: tonic::Request<super::InsertLfpStoreRequest>,
        ) -> std::result::Result<tonic::Response<super::LfpStore>, tonic::Status>;
        /// Deletes a store for a target merchant.
        async fn delete_lfp_store(
            &self,
            request: tonic::Request<super::DeleteLfpStoreRequest>,
        ) -> std::result::Result<tonic::Response<()>, tonic::Status>;
        /// Lists the stores of the target merchant, specified by the filter in
        /// `ListLfpStoresRequest`.
        async fn list_lfp_stores(
            &self,
            request: tonic::Request<super::ListLfpStoresRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListLfpStoresResponse>,
            tonic::Status,
        >;
    ...
    /// stores for a merchant.
    #[derive(Debug)]
    pub struct LfpStoreServiceServer<T> {
        inner: Arc<T>,
    ...
    impl<T> LfpStoreServiceServer<T> {
        pub fn new(inner: T) -> Self {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for LfpStoreServiceServer<T>
    where
        T: LfpStoreService,
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.shopping.merchant.lfp.v1beta.LfpStoreService/GetLfpStore" => {
                    ...
                    struct GetLfpStoreSvc<T: LfpStoreService>(pub Arc<T>);
                    impl<
                        T: LfpStoreService,
                    > tonic::server::UnaryService<super::GetLfpStoreRequest>
                    for GetLfpStoreSvc<T> {
                        type Response = super::LfpStore;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as LfpStoreService>::get_lfp_store(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let fut = async move {
                        let method = GetLfpStoreSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                ...
                "/google.shopping.merchant.lfp.v1beta.LfpStoreService/InsertLfpStore" => {
                    #[allow(non_camel_case_types)]
                    struct InsertLfpStoreSvc<T: LfpStoreService>(pub Arc<T>);
                    impl<
                        T: LfpStoreService,
                    > tonic::server::UnaryService<super::InsertLfpStoreRequest>
                    for InsertLfpStoreSvc<T> {
                        type Response = super::LfpStore;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LfpStoreService>::insert_lfp_store(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = InsertLfpStoreSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.shopping.merchant.lfp.v1beta.LfpStoreService/DeleteLfpStore" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteLfpStoreSvc<T: LfpStoreService>(pub Arc<T>);
                    impl<
                        T: LfpStoreService,
                    > tonic::server::UnaryService<super::DeleteLfpStoreRequest>
                    for DeleteLfpStoreSvc<T> {
                        type Response = ();
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LfpStoreService>::delete_lfp_store(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = DeleteLfpStoreSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.shopping.merchant.lfp.v1beta.LfpStoreService/ListLfpStores" => {
                    #[allow(non_camel_case_types)]
                    struct ListLfpStoresSvc<T: LfpStoreService>(pub Arc<T>);
                    impl<
                        T: LfpStoreService,
                    > tonic::server::UnaryService<super::ListLfpStoresRequest>
                    for ListLfpStoresSvc<T> {
                        type Response = super::ListLfpStoresResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LfpStoreService>::list_lfp_stores(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ListLfpStoresSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for LfpStoreServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "google.shopping.merchant.lfp.v1beta.LfpStoreService";
    impl<T> tonic::server::NamedService for LfpStoreServiceServer<T> {
...
/// Generated server implementations.
pub mod lfp_sale_service_server {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with LfpSaleServiceServer.
    #[async_trait]
    pub trait LfpSaleService: std::marker::Send + std::marker::Sync + 'static {
        /// Inserts a `LfpSale` for the given merchant.
        async fn insert_lfp_sale(
            &self,
            request: tonic::Request<super::InsertLfpSaleRequest>,
        ) -> std::result::Result<tonic::Response<super::LfpSale>, tonic::Status>;
    }
    /// Service for a [LFP
    /// partner](https://support.google.com/merchants/answer/7676652) to submit sales
    /// data for a merchant.
    #[derive(Debug)]
    pub struct LfpSaleServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for LfpSaleServiceServer<T>
    where
        T: LfpSaleService,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.shopping.merchant.lfp.v1beta.LfpSaleService/InsertLfpSale" => {
                    #[allow(non_camel_case_types)]
                    struct InsertLfpSaleSvc<T: LfpSaleService>(pub Arc<T>);
                    impl<
                        T: LfpSaleService,
                    > tonic::server::UnaryService<super::InsertLfpSaleRequest>
                    for InsertLfpSaleSvc<T> {
                        type Response = super::LfpSale;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LfpSaleService>::insert_lfp_sale(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = InsertLfpSaleSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for LfpSaleServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.shopping.merchant.lfp.v1beta.LfpSaleService";
    impl<T> tonic::server::NamedService for LfpSaleServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
...
/// Generated server implementations.
pub mod lfp_inventory_service_server {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with LfpInventoryServiceServer.
    #[async_trait]
    pub trait LfpInventoryService: std::marker::Send + std::marker::Sync + 'static {
        /// Inserts a `LfpInventory` resource for the given target merchant account. If
        /// the resource already exists, it will be replaced. The inventory
        /// automatically expires after 30 days.
        async fn insert_lfp_inventory(
            &self,
            request: tonic::Request<super::InsertLfpInventoryRequest>,
        ) -> std::result::Result<tonic::Response<super::LfpInventory>, tonic::Status>;
    }
    /// Service for a [LFP
    /// partner](https://support.google.com/merchants/answer/7676652) to submit local
    /// inventories for a merchant.
    #[derive(Debug)]
    pub struct LfpInventoryServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> LfpInventoryServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for LfpInventoryServiceServer<T>
    where
        T: LfpInventoryService,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        type Response = http::Response<tonic::body::BoxBody>;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.shopping.merchant.lfp.v1beta.LfpInventoryService/InsertLfpInventory" => {
                    #[allow(non_camel_case_types)]
                    struct InsertLfpInventorySvc<T: LfpInventoryService>(pub Arc<T>);
                    impl<
                        T: LfpInventoryService,
                    > tonic::server::UnaryService<super::InsertLfpInventoryRequest>
                    for InsertLfpInventorySvc<T> {
                        type Response = super::LfpInventory;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LfpInventoryService>::insert_lfp_inventory(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = InsertLfpInventorySvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for LfpInventoryServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.shopping.merchant.lfp.v1beta.LfpInventoryService";
    impl<T> tonic::server::NamedService for LfpInventoryServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
