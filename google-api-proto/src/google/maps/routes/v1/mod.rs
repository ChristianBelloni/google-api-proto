...
pub mod routes_preferred_server {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with RoutesPreferredServer.
    #[async_trait]
    pub trait RoutesPreferred: std::marker::Send + std::marker::Sync + 'static {
        /// Returns the primary route along with optional alternate routes, given a set
        /// of terminal and intermediate waypoints.
        ///
        /// **NOTE:** This method requires that you specify a response field mask in
        ...
        type ComputeRouteMatrixStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<super::RouteMatrixElement, tonic::Status>,
            >
            + std::marker::Send
            + 'static;
        /// Takes in a list of origins and destinations and returns a stream containing
        ...
        async fn compute_route_matrix(
            &self,
            request: tonic::Request<super::ComputeRouteMatrixRequest>,
        ) -> std::result::Result<
        ...
        async fn compute_custom_routes(
            &self,
            request: tonic::Request<super::ComputeCustomRoutesRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ComputeCustomRoutesResponse>,
            tonic::Status,
        >;
    ...
    /// The Routes Preferred API.
    #[derive(Debug)]
    pub struct RoutesPreferredServer<T> {
        inner: Arc<T>,
    ...
    impl<T> RoutesPreferredServer<T> {
        pub fn new(inner: T) -> Self {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for RoutesPreferredServer<T>
    where
        T: RoutesPreferred,
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.maps.routes.v1.RoutesPreferred/ComputeRoutes" => {
                    ...
                    for ComputeRoutesSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as RoutesPreferred>::compute_routes(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.maps.routes.v1.RoutesPreferred/ComputeRouteMatrix" => {
                    #[allow(non_camel_case_types)]
                    struct ComputeRouteMatrixSvc<T: RoutesPreferred>(pub Arc<T>);
                    impl<
                        T: RoutesPreferred,
                    > tonic::server::ServerStreamingService<
                        super::ComputeRouteMatrixRequest,
                    > for ComputeRouteMatrixSvc<T> {
                        type Response = super::RouteMatrixElement;
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RoutesPreferred>::compute_route_matrix(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/google.maps.routes.v1.RoutesPreferred/ComputeCustomRoutes" => {
                    #[allow(non_camel_case_types)]
                    struct ComputeCustomRoutesSvc<T: RoutesPreferred>(pub Arc<T>);
                    impl<
                        T: RoutesPreferred,
                    > tonic::server::UnaryService<super::ComputeCustomRoutesRequest>
                    for ComputeCustomRoutesSvc<T> {
                        type Response = super::ComputeCustomRoutesResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RoutesPreferred>::compute_custom_routes(
                                        &inner,
                                        request,
                                    )
                                    .await
    ...
    impl<T> Clone for RoutesPreferredServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "google.maps.routes.v1.RoutesPreferred";
    impl<T> tonic::server::NamedService for RoutesPreferredServer<T> {
