        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.maps.routeoptimization.v1.RouteOptimization/OptimizeTours" => {
                    ...
                    struct OptimizeToursSvc<T: RouteOptimization>(pub Arc<T>);
                    impl<
                        T: RouteOptimization,
                    ...
                    for OptimizeToursSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as RouteOptimization>::optimize_tours(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.maps.routeoptimization.v1.RouteOptimization/BatchOptimizeTours" => {
                    #[allow(non_camel_case_types)]
                    struct BatchOptimizeToursSvc<T: RouteOptimization>(pub Arc<T>);
                    impl<
                        T: RouteOptimization,
                    ...
                    for BatchOptimizeToursSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RouteOptimization>::batch_optimize_tours(
                                        &inner,
                                        request,
                                    )
                                    .await
