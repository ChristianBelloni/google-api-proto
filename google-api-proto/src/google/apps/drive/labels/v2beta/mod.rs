...
pub mod label_service_server {
    ...
    pub trait LabelService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn get_user_capabilities(
            &self,
            request: tonic::Request<super::GetUserCapabilitiesRequest>,
        ) -> std::result::Result<
            tonic::Response<super::UserCapabilities>,
            tonic::Status,
        >;
        ...
        async fn list_labels(
            &self,
            request: tonic::Request<super::ListLabelsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListLabelsResponse>,
            tonic::Status,
        >;
        ...
        /// Get the constraints on the structure of a Label; such as, the maximum
        /// number of Fields allowed and maximum length of the label title.
        async fn get_label_limits(
            &self,
            request: tonic::Request<super::GetLabelLimitsRequest>,
        ) -> std::result::Result<tonic::Response<super::LabelLimits>, tonic::Status>;
        /// Creates a new Label.
        async fn create_label(
            &self,
            request: tonic::Request<super::CreateLabelRequest>,
        ) -> std::result::Result<tonic::Response<super::Label>, tonic::Status>;
        /// Updates a single Label by applying a set of update requests resulting in a
        /// new draft revision. The batch update is all-or-nothing: If any of the
        /// update requests are invalid, no changes are applied. The resulting draft
        /// revision must be published before the changes may be used with Drive Items.
        async fn delta_update_label(
            &self,
            request: tonic::Request<super::DeltaUpdateLabelRequest>,
        ) -> std::result::Result<
            tonic::Response<super::DeltaUpdateLabelResponse>,
            tonic::Status,
        >;
        /// Updates a Label's `CopyMode`. Changes to this policy are not revisioned, do
        /// not require publishing, and take effect immediately.
        async fn update_label_copy_mode(
            &self,
            request: tonic::Request<super::UpdateLabelCopyModeRequest>,
        ) -> std::result::Result<tonic::Response<super::Label>, tonic::Status>;
        /// Publish all draft changes to the Label. Once published, the Label may not
        /// return to its draft state. See
        /// `google.apps.drive.labels.v2.Lifecycle` for more information.
        ...
        async fn publish_label(
            &self,
            request: tonic::Request<super::PublishLabelRequest>,
        ) -> std::result::Result<tonic::Response<super::Label>, tonic::Status>;
        /// Disable a published Label.
        /// Disabling a Label will result in a new disabled published revision based on
        /// the current published revision. If there is a draft revision, a new
        ...
        ///
        /// Once disabled, a label may be deleted with `DeleteLabel`.
        async fn disable_label(
            &self,
            request: tonic::Request<super::DisableLabelRequest>,
        ) -> std::result::Result<tonic::Response<super::Label>, tonic::Status>;
        /// Enable a disabled Label and restore it to its published state.
        /// This will result in a new published revision based on the current disabled
        /// published revision. If there is an existing disabled draft revision, a new
        /// revision will be created based on that draft and will be enabled.
        async fn enable_label(
            &self,
            request: tonic::Request<super::EnableLabelRequest>,
        ) -> std::result::Result<tonic::Response<super::Label>, tonic::Status>;
        /// Permanently deletes a Label and related metadata on Drive Items.
        ///
        /// Once deleted, the Label and related Drive item metadata will be deleted.
        ...
        async fn delete_label(
            &self,
            request: tonic::Request<super::DeleteLabelRequest>,
        ) -> std::result::Result<tonic::Response<()>, tonic::Status>;
        /// Lists a Label's permissions.
        async fn list_label_permissions(
            &self,
            request: tonic::Request<super::ListLabelPermissionsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListLabelPermissionsResponse>,
            tonic::Status,
        >;
        ...
        /// permission is updated. Permissions affect the Label resource as a whole,
        /// are not revisioned, and do not require publishing.
        async fn create_label_permission(
            &self,
            request: tonic::Request<super::CreateLabelPermissionRequest>,
        ) -> std::result::Result<tonic::Response<super::LabelPermission>, tonic::Status>;
        /// Updates a Label's permissions. If a permission for the indicated principal
        /// doesn't exist, a new Label Permission is created, otherwise the existing
        /// permission is updated. Permissions affect the Label resource as a whole,
        /// are not revisioned, and do not require publishing.
        async fn update_label_permission(
            &self,
            request: tonic::Request<super::UpdateLabelPermissionRequest>,
        ) -> std::result::Result<tonic::Response<super::LabelPermission>, tonic::Status>;
        /// Deletes a Label's permission. Permissions affect the Label resource as a
        /// whole, are not revisioned, and do not require publishing.
        async fn delete_label_permission(
            &self,
            request: tonic::Request<super::DeleteLabelPermissionRequest>,
        ) -> std::result::Result<tonic::Response<()>, tonic::Status>;
        /// Updates Label permissions. If a permission for the
        /// indicated principal doesn't exist, a new Label Permission is created,
        /// otherwise the existing permission is updated. Permissions affect the Label
        /// resource as a whole, are not revisioned, and do not require publishing.
        async fn batch_update_label_permissions(
            &self,
            request: tonic::Request<super::BatchUpdateLabelPermissionsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::BatchUpdateLabelPermissionsResponse>,
            tonic::Status,
        >;
        /// Deletes Label permissions. Permissions affect the Label resource as a
        /// whole, are not revisioned, and do not require publishing.
        async fn batch_delete_label_permissions(
            &self,
            request: tonic::Request<super::BatchDeleteLabelPermissionsRequest>,
        ) -> std::result::Result<tonic::Response<()>, tonic::Status>;
        /// Lists the LabelLocks on a Label.
        async fn list_label_locks(
            &self,
            request: tonic::Request<super::ListLabelLocksRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListLabelLocksResponse>,
            tonic::Status,
        >;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.apps.drive.labels.v2beta.LabelService/GetUserCapabilities" => {
                    ...
                    struct GetUserCapabilitiesSvc<T: LabelService>(pub Arc<T>);
                    impl<
                        T: LabelService,
                    > tonic::server::UnaryService<super::GetUserCapabilitiesRequest>
                    for GetUserCapabilitiesSvc<T> {
                        type Response = super::UserCapabilities;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as LabelService>::get_user_capabilities(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let fut = async move {
                        let method = GetUserCapabilitiesSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                ...
                "/google.apps.drive.labels.v2beta.LabelService/ListLabels" => {
                    #[allow(non_camel_case_types)]
                    struct ListLabelsSvc<T: LabelService>(pub Arc<T>);
                    impl<
                        T: LabelService,
                    > tonic::server::UnaryService<super::ListLabelsRequest>
                    for ListLabelsSvc<T> {
                        type Response = super::ListLabelsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LabelService>::list_labels(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.apps.drive.labels.v2beta.LabelService/GetLabel" => {
                    ...
                    impl<
                        T: LabelService,
                    > tonic::server::UnaryService<super::GetLabelRequest>
                    for GetLabelSvc<T> {
                        type Response = super::Label;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LabelService>::get_label(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.apps.drive.labels.v2beta.LabelService/GetLabelLimits" => {
                    #[allow(non_camel_case_types)]
                    struct GetLabelLimitsSvc<T: LabelService>(pub Arc<T>);
                    impl<
                        T: LabelService,
                    > tonic::server::UnaryService<super::GetLabelLimitsRequest>
                    for GetLabelLimitsSvc<T> {
                        type Response = super::LabelLimits;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LabelService>::get_label_limits(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetLabelLimitsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.apps.drive.labels.v2beta.LabelService/CreateLabel" => {
                    #[allow(non_camel_case_types)]
                    struct CreateLabelSvc<T: LabelService>(pub Arc<T>);
                    impl<
                        T: LabelService,
                    > tonic::server::UnaryService<super::CreateLabelRequest>
                    for CreateLabelSvc<T> {
                        type Response = super::Label;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LabelService>::create_label(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = CreateLabelSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.apps.drive.labels.v2beta.LabelService/DeltaUpdateLabel" => {
                    #[allow(non_camel_case_types)]
                    struct DeltaUpdateLabelSvc<T: LabelService>(pub Arc<T>);
                    impl<
                        T: LabelService,
                    > tonic::server::UnaryService<super::DeltaUpdateLabelRequest>
                    for DeltaUpdateLabelSvc<T> {
                        type Response = super::DeltaUpdateLabelResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LabelService>::delta_update_label(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = DeltaUpdateLabelSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.apps.drive.labels.v2beta.LabelService/UpdateLabelCopyMode" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateLabelCopyModeSvc<T: LabelService>(pub Arc<T>);
                    impl<
                        T: LabelService,
                    > tonic::server::UnaryService<super::UpdateLabelCopyModeRequest>
                    for UpdateLabelCopyModeSvc<T> {
                        type Response = super::Label;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LabelService>::update_label_copy_mode(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = UpdateLabelCopyModeSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.apps.drive.labels.v2beta.LabelService/PublishLabel" => {
                    #[allow(non_camel_case_types)]
                    struct PublishLabelSvc<T: LabelService>(pub Arc<T>);
                    impl<
                        T: LabelService,
                    > tonic::server::UnaryService<super::PublishLabelRequest>
                    for PublishLabelSvc<T> {
                        type Response = super::Label;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LabelService>::publish_label(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = PublishLabelSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.apps.drive.labels.v2beta.LabelService/DisableLabel" => {
                    #[allow(non_camel_case_types)]
                    struct DisableLabelSvc<T: LabelService>(pub Arc<T>);
                    impl<
                        T: LabelService,
                    > tonic::server::UnaryService<super::DisableLabelRequest>
                    for DisableLabelSvc<T> {
                        type Response = super::Label;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LabelService>::disable_label(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = DisableLabelSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.apps.drive.labels.v2beta.LabelService/EnableLabel" => {
                    #[allow(non_camel_case_types)]
                    struct EnableLabelSvc<T: LabelService>(pub Arc<T>);
                    impl<
                        T: LabelService,
                    > tonic::server::UnaryService<super::EnableLabelRequest>
                    for EnableLabelSvc<T> {
                        type Response = super::Label;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LabelService>::enable_label(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = EnableLabelSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.apps.drive.labels.v2beta.LabelService/DeleteLabel" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteLabelSvc<T: LabelService>(pub Arc<T>);
                    impl<
                        T: LabelService,
                    > tonic::server::UnaryService<super::DeleteLabelRequest>
                    for DeleteLabelSvc<T> {
                        type Response = ();
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LabelService>::delete_label(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = DeleteLabelSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.apps.drive.labels.v2beta.LabelService/ListLabelPermissions" => {
                    #[allow(non_camel_case_types)]
                    struct ListLabelPermissionsSvc<T: LabelService>(pub Arc<T>);
                    impl<
                        T: LabelService,
                    > tonic::server::UnaryService<super::ListLabelPermissionsRequest>
                    for ListLabelPermissionsSvc<T> {
                        type Response = super::ListLabelPermissionsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LabelService>::list_label_permissions(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ListLabelPermissionsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.apps.drive.labels.v2beta.LabelService/CreateLabelPermission" => {
                    #[allow(non_camel_case_types)]
                    struct CreateLabelPermissionSvc<T: LabelService>(pub Arc<T>);
                    impl<
                        T: LabelService,
                    > tonic::server::UnaryService<super::CreateLabelPermissionRequest>
                    for CreateLabelPermissionSvc<T> {
                        type Response = super::LabelPermission;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LabelService>::create_label_permission(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = CreateLabelPermissionSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.apps.drive.labels.v2beta.LabelService/UpdateLabelPermission" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateLabelPermissionSvc<T: LabelService>(pub Arc<T>);
                    impl<
                        T: LabelService,
                    > tonic::server::UnaryService<super::UpdateLabelPermissionRequest>
                    for UpdateLabelPermissionSvc<T> {
                        type Response = super::LabelPermission;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LabelService>::update_label_permission(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = UpdateLabelPermissionSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.apps.drive.labels.v2beta.LabelService/DeleteLabelPermission" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteLabelPermissionSvc<T: LabelService>(pub Arc<T>);
                    impl<
                        T: LabelService,
                    > tonic::server::UnaryService<super::DeleteLabelPermissionRequest>
                    for DeleteLabelPermissionSvc<T> {
                        type Response = ();
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LabelService>::delete_label_permission(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = DeleteLabelPermissionSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.apps.drive.labels.v2beta.LabelService/BatchUpdateLabelPermissions" => {
                    #[allow(non_camel_case_types)]
                    struct BatchUpdateLabelPermissionsSvc<T: LabelService>(pub Arc<T>);
                    impl<
                        T: LabelService,
                    > tonic::server::UnaryService<
                        super::BatchUpdateLabelPermissionsRequest,
                    > for BatchUpdateLabelPermissionsSvc<T> {
                        type Response = super::BatchUpdateLabelPermissionsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LabelService>::batch_update_label_permissions(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = BatchUpdateLabelPermissionsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.apps.drive.labels.v2beta.LabelService/BatchDeleteLabelPermissions" => {
                    #[allow(non_camel_case_types)]
                    struct BatchDeleteLabelPermissionsSvc<T: LabelService>(pub Arc<T>);
                    impl<
                        T: LabelService,
                    > tonic::server::UnaryService<
                        super::BatchDeleteLabelPermissionsRequest,
                    > for BatchDeleteLabelPermissionsSvc<T> {
                        type Response = ();
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LabelService>::batch_delete_label_permissions(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = BatchDeleteLabelPermissionsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.apps.drive.labels.v2beta.LabelService/ListLabelLocks" => {
                    #[allow(non_camel_case_types)]
                    struct ListLabelLocksSvc<T: LabelService>(pub Arc<T>);
                    impl<
                        T: LabelService,
                    > tonic::server::UnaryService<super::ListLabelLocksRequest>
                    for ListLabelLocksSvc<T> {
                        type Response = super::ListLabelLocksResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LabelService>::list_label_locks(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ListLabelLocksSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    pub const SERVICE_NAME: &str = "google.apps.drive.labels.v2beta.LabelService";
