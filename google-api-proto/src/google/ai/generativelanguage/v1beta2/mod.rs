...
pub mod text_service_server {
    ...
    pub const SERVICE_NAME: &str = "google.ai.generativelanguage.v1beta2.TextService";
...
pub mod discuss_service_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.ai.generativelanguage.v1beta2.DiscussService";
...
pub mod model_service_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.ai.generativelanguage.v1beta2.ModelService";
