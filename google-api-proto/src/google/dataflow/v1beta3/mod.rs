...
pub mod snapshots_v1_beta3_server {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with SnapshotsV1Beta3Server.
    #[async_trait]
    pub trait SnapshotsV1Beta3: std::marker::Send + std::marker::Sync + 'static {
        /// Gets information about a snapshot.
    ...
    /// Provides methods to manage snapshots of Google Cloud Dataflow jobs.
    #[derive(Debug)]
    pub struct SnapshotsV1Beta3Server<T> {
        inner: Arc<T>,
    ...
    impl<T> SnapshotsV1Beta3Server<T> {
        pub fn new(inner: T) -> Self {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for SnapshotsV1Beta3Server<T>
    where
        T: SnapshotsV1Beta3,
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.dataflow.v1beta3.SnapshotsV1Beta3/GetSnapshot" => {
                    ...
                    struct GetSnapshotSvc<T: SnapshotsV1Beta3>(pub Arc<T>);
                    impl<
                        T: SnapshotsV1Beta3,
                    ...
                    for GetSnapshotSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as SnapshotsV1Beta3>::get_snapshot(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.dataflow.v1beta3.SnapshotsV1Beta3/DeleteSnapshot" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteSnapshotSvc<T: SnapshotsV1Beta3>(pub Arc<T>);
                    impl<
                        T: SnapshotsV1Beta3,
                    ...
                    for DeleteSnapshotSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SnapshotsV1Beta3>::delete_snapshot(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.dataflow.v1beta3.SnapshotsV1Beta3/ListSnapshots" => {
                    #[allow(non_camel_case_types)]
                    struct ListSnapshotsSvc<T: SnapshotsV1Beta3>(pub Arc<T>);
                    impl<
                        T: SnapshotsV1Beta3,
                    ...
                    for ListSnapshotsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SnapshotsV1Beta3>::list_snapshots(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
    ...
    impl<T> Clone for SnapshotsV1Beta3Server<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "google.dataflow.v1beta3.SnapshotsV1Beta3";
    impl<T> tonic::server::NamedService for SnapshotsV1Beta3Server<T> {
...
/// Generated server implementations.
pub mod jobs_v1_beta3_server {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with JobsV1Beta3Server.
    #[async_trait]
    pub trait JobsV1Beta3: std::marker::Send + std::marker::Sync + 'static {
        /// Creates a Cloud Dataflow job.
        ///
        /// To create a job, we recommend using `projects.locations.jobs.create` with a
        /// [regional endpoint]
        ...
        >;
        /// Check for existence of active jobs in the given project across all regions.
        async fn check_active_jobs(
            &self,
            request: tonic::Request<super::CheckActiveJobsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::CheckActiveJobsResponse>,
            tonic::Status,
        >;
        ...
        async fn snapshot_job(
            &self,
            request: tonic::Request<super::SnapshotJobRequest>,
        ) -> std::result::Result<tonic::Response<super::Snapshot>, tonic::Status>;
    }
    /// Provides a method to create and modify Google Cloud Dataflow jobs.
    /// A Job is a multi-stage computation graph run by the Cloud Dataflow service.
    #[derive(Debug)]
    pub struct JobsV1Beta3Server<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for JobsV1Beta3Server<T>
    where
        T: JobsV1Beta3,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.dataflow.v1beta3.JobsV1Beta3/CreateJob" => {
                    #[allow(non_camel_case_types)]
                    struct CreateJobSvc<T: JobsV1Beta3>(pub Arc<T>);
                    impl<
                        T: JobsV1Beta3,
                    ...
                    for CreateJobSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as JobsV1Beta3>::create_job(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.dataflow.v1beta3.JobsV1Beta3/GetJob" => {
                    #[allow(non_camel_case_types)]
                    struct GetJobSvc<T: JobsV1Beta3>(pub Arc<T>);
                    impl<
                        T: JobsV1Beta3,
                    ...
                    for GetJobSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as JobsV1Beta3>::get_job(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.dataflow.v1beta3.JobsV1Beta3/UpdateJob" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateJobSvc<T: JobsV1Beta3>(pub Arc<T>);
                    impl<
                        T: JobsV1Beta3,
                    ...
                    for UpdateJobSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as JobsV1Beta3>::update_job(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.dataflow.v1beta3.JobsV1Beta3/ListJobs" => {
                    #[allow(non_camel_case_types)]
                    struct ListJobsSvc<T: JobsV1Beta3>(pub Arc<T>);
                    impl<
                        T: JobsV1Beta3,
                    ...
                    for ListJobsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as JobsV1Beta3>::list_jobs(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.dataflow.v1beta3.JobsV1Beta3/AggregatedListJobs" => {
                    #[allow(non_camel_case_types)]
                    struct AggregatedListJobsSvc<T: JobsV1Beta3>(pub Arc<T>);
                    impl<
                        T: JobsV1Beta3,
                    > tonic::server::UnaryService<super::ListJobsRequest>
                    for AggregatedListJobsSvc<T> {
                        type Response = super::ListJobsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as JobsV1Beta3>::aggregated_list_jobs(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = AggregatedListJobsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.dataflow.v1beta3.JobsV1Beta3/CheckActiveJobs" => {
                    #[allow(non_camel_case_types)]
                    struct CheckActiveJobsSvc<T: JobsV1Beta3>(pub Arc<T>);
                    impl<
                        T: JobsV1Beta3,
                    > tonic::server::UnaryService<super::CheckActiveJobsRequest>
                    for CheckActiveJobsSvc<T> {
                        type Response = super::CheckActiveJobsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as JobsV1Beta3>::check_active_jobs(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = CheckActiveJobsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.dataflow.v1beta3.JobsV1Beta3/SnapshotJob" => {
                    #[allow(non_camel_case_types)]
                    struct SnapshotJobSvc<T: JobsV1Beta3>(pub Arc<T>);
                    impl<
                        T: JobsV1Beta3,
                    > tonic::server::UnaryService<super::SnapshotJobRequest>
                    for SnapshotJobSvc<T> {
                        type Response = super::Snapshot;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as JobsV1Beta3>::snapshot_job(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = SnapshotJobSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for JobsV1Beta3Server<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.dataflow.v1beta3.JobsV1Beta3";
    impl<T> tonic::server::NamedService for JobsV1Beta3Server<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
...
/// Generated server implementations.
pub mod metrics_v1_beta3_server {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with MetricsV1Beta3Server.
    #[async_trait]
    pub trait MetricsV1Beta3: std::marker::Send + std::marker::Sync + 'static {
        /// Request the job status.
        ///
        /// To request the status of a job, we recommend using
        /// `projects.locations.jobs.getMetrics` with a [regional endpoint]
        ...
        ///
        /// EXPERIMENTAL.  This API is subject to change or removal without notice.
        async fn get_job_execution_details(
            &self,
            request: tonic::Request<super::GetJobExecutionDetailsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::JobExecutionDetails>,
            tonic::Status,
        >;
        ...
        ///
        /// EXPERIMENTAL.  This API is subject to change or removal without notice.
        async fn get_stage_execution_details(
            &self,
            request: tonic::Request<super::GetStageExecutionDetailsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::StageExecutionDetails>,
            tonic::Status,
        >;
    ...
    /// jobs.
    #[derive(Debug)]
    pub struct MetricsV1Beta3Server<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for MetricsV1Beta3Server<T>
    where
        T: MetricsV1Beta3,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.dataflow.v1beta3.MetricsV1Beta3/GetJobMetrics" => {
                    #[allow(non_camel_case_types)]
                    struct GetJobMetricsSvc<T: MetricsV1Beta3>(pub Arc<T>);
                    impl<
                        T: MetricsV1Beta3,
                    > tonic::server::UnaryService<super::GetJobMetricsRequest>
                    for GetJobMetricsSvc<T> {
                        type Response = super::JobMetrics;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as MetricsV1Beta3>::get_job_metrics(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.dataflow.v1beta3.MetricsV1Beta3/GetJobExecutionDetails" => {
                    #[allow(non_camel_case_types)]
                    struct GetJobExecutionDetailsSvc<T: MetricsV1Beta3>(pub Arc<T>);
                    impl<
                        T: MetricsV1Beta3,
                    > tonic::server::UnaryService<super::GetJobExecutionDetailsRequest>
                    for GetJobExecutionDetailsSvc<T> {
                        type Response = super::JobExecutionDetails;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as MetricsV1Beta3>::get_job_execution_details(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetJobExecutionDetailsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.dataflow.v1beta3.MetricsV1Beta3/GetStageExecutionDetails" => {
                    #[allow(non_camel_case_types)]
                    struct GetStageExecutionDetailsSvc<T: MetricsV1Beta3>(pub Arc<T>);
                    impl<
                        T: MetricsV1Beta3,
                    > tonic::server::UnaryService<super::GetStageExecutionDetailsRequest>
                    for GetStageExecutionDetailsSvc<T> {
                        type Response = super::StageExecutionDetails;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            request: tonic::Request<
                                super::GetStageExecutionDetailsRequest,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as MetricsV1Beta3>::get_stage_execution_details(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetStageExecutionDetailsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for MetricsV1Beta3Server<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.dataflow.v1beta3.MetricsV1Beta3";
    impl<T> tonic::server::NamedService for MetricsV1Beta3Server<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
...
/// Generated server implementations.
pub mod messages_v1_beta3_server {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with MessagesV1Beta3Server.
    #[async_trait]
    pub trait MessagesV1Beta3: std::marker::Send + std::marker::Sync + 'static {
        /// Request the job status.
        ///
        /// To request the status of a job, we recommend using
        /// `projects.locations.jobs.messages.list` with a [regional endpoint]
        ...
        async fn list_job_messages(
            &self,
            request: tonic::Request<super::ListJobMessagesRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListJobMessagesResponse>,
            tonic::Status,
        >;
    ...
    /// Dataflow jobs.
    #[derive(Debug)]
    pub struct MessagesV1Beta3Server<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> MessagesV1Beta3Server<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for MessagesV1Beta3Server<T>
    where
        T: MessagesV1Beta3,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.dataflow.v1beta3.MessagesV1Beta3/ListJobMessages" => {
                    #[allow(non_camel_case_types)]
                    struct ListJobMessagesSvc<T: MessagesV1Beta3>(pub Arc<T>);
                    impl<
                        T: MessagesV1Beta3,
                    > tonic::server::UnaryService<super::ListJobMessagesRequest>
                    for ListJobMessagesSvc<T> {
                        type Response = super::ListJobMessagesResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as MessagesV1Beta3>::list_job_messages(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ListJobMessagesSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for MessagesV1Beta3Server<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.dataflow.v1beta3.MessagesV1Beta3";
    impl<T> tonic::server::NamedService for MessagesV1Beta3Server<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
...
/// Generated server implementations.
pub mod templates_service_server {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with TemplatesServiceServer.
    #[async_trait]
    pub trait TemplatesService: std::marker::Send + std::marker::Sync + 'static {
        /// Creates a Cloud Dataflow job from a template.
        async fn create_job_from_template(
            &self,
            request: tonic::Request<super::CreateJobFromTemplateRequest>,
        ) -> std::result::Result<tonic::Response<super::Job>, tonic::Status>;
        /// Launch a template.
        async fn launch_template(
            &self,
            request: tonic::Request<super::LaunchTemplateRequest>,
        ) -> std::result::Result<
            tonic::Response<super::LaunchTemplateResponse>,
            tonic::Status,
        >;
    ...
    /// Provides a method to create Cloud Dataflow jobs from templates.
    #[derive(Debug)]
    pub struct TemplatesServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> TemplatesServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for TemplatesServiceServer<T>
    where
        T: TemplatesService,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.dataflow.v1beta3.TemplatesService/CreateJobFromTemplate" => {
                    #[allow(non_camel_case_types)]
                    struct CreateJobFromTemplateSvc<T: TemplatesService>(pub Arc<T>);
                    impl<
                        T: TemplatesService,
                    > tonic::server::UnaryService<super::CreateJobFromTemplateRequest>
                    for CreateJobFromTemplateSvc<T> {
                        type Response = super::Job;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as TemplatesService>::create_job_from_template(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = CreateJobFromTemplateSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.dataflow.v1beta3.TemplatesService/LaunchTemplate" => {
                    #[allow(non_camel_case_types)]
                    struct LaunchTemplateSvc<T: TemplatesService>(pub Arc<T>);
                    impl<
                        T: TemplatesService,
                    > tonic::server::UnaryService<super::LaunchTemplateRequest>
                    for LaunchTemplateSvc<T> {
                        type Response = super::LaunchTemplateResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as TemplatesService>::launch_template(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = LaunchTemplateSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.dataflow.v1beta3.TemplatesService/GetTemplate" => {
                    #[allow(non_camel_case_types)]
                    struct GetTemplateSvc<T: TemplatesService>(pub Arc<T>);
                    impl<
                        T: TemplatesService,
                    ...
                    for GetTemplateSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as TemplatesService>::get_template(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T> Clone for TemplatesServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.dataflow.v1beta3.TemplatesService";
    impl<T> tonic::server::NamedService for TemplatesServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
/// Generated server implementations.
pub mod flex_templates_service_server {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with FlexTemplatesServiceServer.
    #[async_trait]
    pub trait FlexTemplatesService: std::marker::Send + std::marker::Sync + 'static {
        /// Launch a job with a FlexTemplate.
        async fn launch_flex_template(
            &self,
            request: tonic::Request<super::LaunchFlexTemplateRequest>,
        ) -> std::result::Result<
            tonic::Response<super::LaunchFlexTemplateResponse>,
            tonic::Status,
        >;
    ...
    /// Provides a service for Flex templates. This feature is not ready yet.
    #[derive(Debug)]
    pub struct FlexTemplatesServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> FlexTemplatesServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    for FlexTemplatesServiceServer<T>
    where
        T: FlexTemplatesService,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        type Response = http::Response<tonic::body::BoxBody>;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.dataflow.v1beta3.FlexTemplatesService/LaunchFlexTemplate" => {
                    #[allow(non_camel_case_types)]
                    struct LaunchFlexTemplateSvc<T: FlexTemplatesService>(pub Arc<T>);
                    impl<
                        T: FlexTemplatesService,
                    > tonic::server::UnaryService<super::LaunchFlexTemplateRequest>
                    for LaunchFlexTemplateSvc<T> {
                        type Response = super::LaunchFlexTemplateResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as FlexTemplatesService>::launch_flex_template(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = LaunchFlexTemplateSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for FlexTemplatesServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.dataflow.v1beta3.FlexTemplatesService";
    impl<T> tonic::server::NamedService for FlexTemplatesServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
