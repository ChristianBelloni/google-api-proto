...
pub mod customer_service_server {
    ...
    pub const SERVICE_NAME: &str = "google.ads.searchads360.v0.services.CustomerService";
...
pub mod custom_column_service_server {
    ...
    #[async_trait]
    pub trait CustomColumnService: std::marker::Send + std::marker::Sync + 'static {
        /// Returns the requested custom column in full detail.
    ...
    /// Service to manage custom columns.
    #[derive(Debug)]
    pub struct CustomColumnServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> CustomColumnServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T> Clone for CustomColumnServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.ads.searchads360.v0.services.CustomColumnService";
    impl<T> tonic::server::NamedService for CustomColumnServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
/// Request message for
...
pub mod search_ads360_service_server {
    ...
    #[async_trait]
    pub trait SearchAds360Service: std::marker::Send + std::marker::Sync + 'static {
        /// Returns all rows that match the search query.
        ///
        /// List of thrown errors:
        ///   [AuthenticationError]()
    ...
    /// Service to fetch data and metrics across resources.
    #[derive(Debug)]
    pub struct SearchAds360ServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> SearchAds360ServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T> Clone for SearchAds360ServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.ads.searchads360.v0.services.SearchAds360Service";
    impl<T> tonic::server::NamedService for SearchAds360ServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
/// Request message for
...
pub mod search_ads360_field_service_server {
    ...
    #[async_trait]
    pub trait SearchAds360FieldService: std::marker::Send + std::marker::Sync + 'static {
        /// Returns just the requested field.
        ///
        /// List of thrown errors:
        ///   [AuthenticationError]()
    ...
    /// Service to fetch Search Ads 360 API fields.
    #[derive(Debug)]
    pub struct SearchAds360FieldServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> SearchAds360FieldServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T> Clone for SearchAds360FieldServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.ads.searchads360.v0.services.SearchAds360FieldService";
    impl<T> tonic::server::NamedService for SearchAds360FieldServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
