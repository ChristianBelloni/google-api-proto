...
pub mod ad_partner_service_server {
    ...
    pub trait AdPartnerService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn get_ad_partner(
            &self,
            request: tonic::Request<super::GetAdPartnerRequest>,
        ) -> std::result::Result<tonic::Response<super::AdPartner>, tonic::Status>;
        /// API to retrieve a list of AdPartner objects.
        async fn list_ad_partners(
            &self,
            request: tonic::Request<super::ListAdPartnersRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListAdPartnersResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.ads.admanager.v1.AdPartnerService/GetAdPartner" => {
                    #[allow(non_camel_case_types)]
                    struct GetAdPartnerSvc<T: AdPartnerService>(pub Arc<T>);
                    impl<
                        T: AdPartnerService,
                    > tonic::server::UnaryService<super::GetAdPartnerRequest>
                    for GetAdPartnerSvc<T> {
                        type Response = super::AdPartner;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AdPartnerService>::get_ad_partner(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.ads.admanager.v1.AdPartnerService/ListAdPartners" => {
                    #[allow(non_camel_case_types)]
                    struct ListAdPartnersSvc<T: AdPartnerService>(pub Arc<T>);
                    impl<
                        T: AdPartnerService,
                    > tonic::server::UnaryService<super::ListAdPartnersRequest>
                    for ListAdPartnersSvc<T> {
                        type Response = super::ListAdPartnersResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AdPartnerService>::list_ad_partners(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.ads.admanager.v1.NetworkService/GetNetwork" => {
                    #[allow(non_camel_case_types)]
                    struct GetNetworkSvc<T: NetworkService>(pub Arc<T>);
                    impl<
                        T: NetworkService,
                    ...
                    for GetNetworkSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as NetworkService>::get_network(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
...
pub mod report_service_server {
    ...
    pub trait ReportService: std::marker::Send + std::marker::Sync + 'static {
        ...
        /// backoff. Once a report is complete, the operation will contain a
        /// ExportSavedReportResponse in its response field.
        async fn export_saved_report(
            &self,
            request: tonic::Request<super::ExportSavedReportRequest>,
        ) -> std::result::Result<
            tonic::Response<super::super::super::super::longrunning::Operation>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.ads.admanager.v1.ReportService/ExportSavedReport" => {
                    #[allow(non_camel_case_types)]
                    struct ExportSavedReportSvc<T: ReportService>(pub Arc<T>);
                    impl<
                        T: ReportService,
                    > tonic::server::UnaryService<super::ExportSavedReportRequest>
                    for ExportSavedReportSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ReportService>::export_saved_report(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.ads.admanager.v1.ContactService/GetContact" => {
                    #[allow(non_camel_case_types)]
                    struct GetContactSvc<T: ContactService>(pub Arc<T>);
                    impl<
                        T: ContactService,
                    ...
                    for GetContactSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ContactService>::get_contact(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
...
pub mod line_item_service_server {
    ...
    pub trait LineItemService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn get_line_item(
            &self,
            request: tonic::Request<super::GetLineItemRequest>,
        ) -> std::result::Result<tonic::Response<super::LineItem>, tonic::Status>;
        /// API to retrieve a list of LineItem objects.
        async fn list_line_items(
            &self,
            request: tonic::Request<super::ListLineItemsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListLineItemsResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.ads.admanager.v1.LineItemService/GetLineItem" => {
                    #[allow(non_camel_case_types)]
                    struct GetLineItemSvc<T: LineItemService>(pub Arc<T>);
                    impl<
                        T: LineItemService,
                    > tonic::server::UnaryService<super::GetLineItemRequest>
                    for GetLineItemSvc<T> {
                        type Response = super::LineItem;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LineItemService>::get_line_item(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.ads.admanager.v1.LineItemService/ListLineItems" => {
                    #[allow(non_camel_case_types)]
                    struct ListLineItemsSvc<T: LineItemService>(pub Arc<T>);
                    impl<
                        T: LineItemService,
                    > tonic::server::UnaryService<super::ListLineItemsRequest>
                    for ListLineItemsSvc<T> {
                        type Response = super::ListLineItemsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LineItemService>::list_line_items(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
...
pub mod custom_field_service_server {
    ...
    pub trait CustomFieldService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn get_custom_field(
            &self,
            request: tonic::Request<super::GetCustomFieldRequest>,
        ) -> std::result::Result<tonic::Response<super::CustomField>, tonic::Status>;
        /// API to retrieve a list of `CustomField` objects.
        async fn list_custom_fields(
            &self,
            request: tonic::Request<super::ListCustomFieldsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListCustomFieldsResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.ads.admanager.v1.CustomFieldService/GetCustomField" => {
                    #[allow(non_camel_case_types)]
                    struct GetCustomFieldSvc<T: CustomFieldService>(pub Arc<T>);
                    impl<
                        T: CustomFieldService,
                    > tonic::server::UnaryService<super::GetCustomFieldRequest>
                    for GetCustomFieldSvc<T> {
                        type Response = super::CustomField;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as CustomFieldService>::get_custom_field(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.ads.admanager.v1.CustomFieldService/ListCustomFields" => {
                    #[allow(non_camel_case_types)]
                    struct ListCustomFieldsSvc<T: CustomFieldService>(pub Arc<T>);
                    impl<
                        T: CustomFieldService,
                    > tonic::server::UnaryService<super::ListCustomFieldsRequest>
                    for ListCustomFieldsSvc<T> {
                        type Response = super::ListCustomFieldsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as CustomFieldService>::list_custom_fields(
                                        &inner,
                                        request,
                                    )
                                    .await
...
pub mod ad_unit_service_server {
    ...
    pub trait AdUnitService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn get_ad_unit(
            &self,
            request: tonic::Request<super::GetAdUnitRequest>,
        ) -> std::result::Result<tonic::Response<super::AdUnit>, tonic::Status>;
        /// API to retrieve a list of AdUnit objects.
        async fn list_ad_units(
            &self,
            request: tonic::Request<super::ListAdUnitsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListAdUnitsResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.ads.admanager.v1.AdUnitService/GetAdUnit" => {
                    #[allow(non_camel_case_types)]
                    struct GetAdUnitSvc<T: AdUnitService>(pub Arc<T>);
                    impl<
                        T: AdUnitService,
                    > tonic::server::UnaryService<super::GetAdUnitRequest>
                    for GetAdUnitSvc<T> {
                        type Response = super::AdUnit;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AdUnitService>::get_ad_unit(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.ads.admanager.v1.AdUnitService/ListAdUnits" => {
                    #[allow(non_camel_case_types)]
                    struct ListAdUnitsSvc<T: AdUnitService>(pub Arc<T>);
                    impl<
                        T: AdUnitService,
                    > tonic::server::UnaryService<super::ListAdUnitsRequest>
                    for ListAdUnitsSvc<T> {
                        type Response = super::ListAdUnitsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AdUnitService>::list_ad_units(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
...
pub mod custom_targeting_key_service_server {
    ...
    pub trait CustomTargetingKeyService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn get_custom_targeting_key(
            &self,
            request: tonic::Request<super::GetCustomTargetingKeyRequest>,
        ) -> std::result::Result<
            tonic::Response<super::CustomTargetingKey>,
            tonic::Status,
        >;
        /// API to retrieve a list of `CustomTargetingKey` objects.
        async fn list_custom_targeting_keys(
            &self,
            request: tonic::Request<super::ListCustomTargetingKeysRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListCustomTargetingKeysResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.ads.admanager.v1.CustomTargetingKeyService/GetCustomTargetingKey" => {
                    #[allow(non_camel_case_types)]
                    struct GetCustomTargetingKeySvc<T: CustomTargetingKeyService>(
                        pub Arc<T>,
                    );
                    impl<
                        T: CustomTargetingKeyService,
                    > tonic::server::UnaryService<super::GetCustomTargetingKeyRequest>
                    for GetCustomTargetingKeySvc<T> {
                        type Response = super::CustomTargetingKey;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as CustomTargetingKeyService>::get_custom_targeting_key(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/google.ads.admanager.v1.CustomTargetingKeyService/ListCustomTargetingKeys" => {
                    #[allow(non_camel_case_types)]
                    struct ListCustomTargetingKeysSvc<T: CustomTargetingKeyService>(
                        pub Arc<T>,
                    );
                    impl<
                        T: CustomTargetingKeyService,
                    > tonic::server::UnaryService<super::ListCustomTargetingKeysRequest>
                    for ListCustomTargetingKeysSvc<T> {
                        type Response = super::ListCustomTargetingKeysResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            request: tonic::Request<
                                super::ListCustomTargetingKeysRequest,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as CustomTargetingKeyService>::list_custom_targeting_keys(
                                        &inner,
                                        request,
                                    )
                                    .await
...
pub mod custom_targeting_value_service_server {
    ...
    pub trait CustomTargetingValueService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn get_custom_targeting_value(
            &self,
            request: tonic::Request<super::GetCustomTargetingValueRequest>,
        ) -> std::result::Result<
            tonic::Response<super::CustomTargetingValue>,
            tonic::Status,
        >;
        /// API to retrieve a list of `CustomTargetingValue` objects.
        async fn list_custom_targeting_values(
            &self,
            request: tonic::Request<super::ListCustomTargetingValuesRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListCustomTargetingValuesResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.ads.admanager.v1.CustomTargetingValueService/GetCustomTargetingValue" => {
                    #[allow(non_camel_case_types)]
                    struct GetCustomTargetingValueSvc<T: CustomTargetingValueService>(
                        pub Arc<T>,
                    );
                    impl<
                        T: CustomTargetingValueService,
                    > tonic::server::UnaryService<super::GetCustomTargetingValueRequest>
                    for GetCustomTargetingValueSvc<T> {
                        type Response = super::CustomTargetingValue;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            &mut self,
                            request: tonic::Request<
                                super::GetCustomTargetingValueRequest,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as CustomTargetingValueService>::get_custom_targeting_value(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/google.ads.admanager.v1.CustomTargetingValueService/ListCustomTargetingValues" => {
                    #[allow(non_camel_case_types)]
                    struct ListCustomTargetingValuesSvc<T: CustomTargetingValueService>(
                        pub Arc<T>,
                    );
                    impl<
                        T: CustomTargetingValueService,
                    > tonic::server::UnaryService<
                        super::ListCustomTargetingValuesRequest,
                    > for ListCustomTargetingValuesSvc<T> {
                        type Response = super::ListCustomTargetingValuesResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as CustomTargetingValueService>::list_custom_targeting_values(
                                        &inner,
                                        request,
                                    )
                                    .await
...
pub mod placement_service_server {
    ...
    pub trait PlacementService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn get_placement(
            &self,
            request: tonic::Request<super::GetPlacementRequest>,
        ) -> std::result::Result<tonic::Response<super::Placement>, tonic::Status>;
        /// API to retrieve a list of `Placement` objects.
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.ads.admanager.v1.PlacementService/GetPlacement" => {
                    #[allow(non_camel_case_types)]
                    struct GetPlacementSvc<T: PlacementService>(pub Arc<T>);
                    impl<
                        T: PlacementService,
                    > tonic::server::UnaryService<super::GetPlacementRequest>
                    for GetPlacementSvc<T> {
                        type Response = super::Placement;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PlacementService>::get_placement(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.ads.admanager.v1.PlacementService/ListPlacements" => {
                    #[allow(non_camel_case_types)]
                    struct ListPlacementsSvc<T: PlacementService>(pub Arc<T>);
                    impl<
                        T: PlacementService,
                    ...
                    for ListPlacementsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PlacementService>::list_placements(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.ads.admanager.v1.CompanyService/GetCompany" => {
                    ...
                    impl<
                        T: CompanyService,
                    > tonic::server::UnaryService<super::GetCompanyRequest>
                    for GetCompanySvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as CompanyService>::get_company(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.ads.admanager.v1.CompanyService/ListCompanies" => {
                    ...
                    impl<
                        T: CompanyService,
                    > tonic::server::UnaryService<super::ListCompaniesRequest>
                    for ListCompaniesSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as CompanyService>::list_companies(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
...
pub mod creative_service_server {
    ...
    pub trait CreativeService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn get_creative(
            &self,
            request: tonic::Request<super::GetCreativeRequest>,
        ) -> std::result::Result<tonic::Response<super::Creative>, tonic::Status>;
        /// API to retrieve a list of Creative objects.
        async fn list_creatives(
            &self,
            request: tonic::Request<super::ListCreativesRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListCreativesResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.ads.admanager.v1.CreativeService/GetCreative" => {
                    #[allow(non_camel_case_types)]
                    struct GetCreativeSvc<T: CreativeService>(pub Arc<T>);
                    impl<
                        T: CreativeService,
                    > tonic::server::UnaryService<super::GetCreativeRequest>
                    for GetCreativeSvc<T> {
                        type Response = super::Creative;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as CreativeService>::get_creative(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.ads.admanager.v1.CreativeService/ListCreatives" => {
                    #[allow(non_camel_case_types)]
                    struct ListCreativesSvc<T: CreativeService>(pub Arc<T>);
                    impl<
                        T: CreativeService,
                    > tonic::server::UnaryService<super::ListCreativesRequest>
                    for ListCreativesSvc<T> {
                        type Response = super::ListCreativesResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as CreativeService>::list_creatives(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
