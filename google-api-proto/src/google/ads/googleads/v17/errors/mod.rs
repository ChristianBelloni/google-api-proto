    ...
    impl CampaignError {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                CampaignError::CannotSetCampaignKeywordMatchType => {
                    "CANNOT_SET_CAMPAIGN_KEYWORD_MATCH_TYPE"
                }
                CampaignError::CannotDisableBroadMatchWhenKeywordConversionInProcess => {
                    "CANNOT_DISABLE_BROAD_MATCH_WHEN_KEYWORD_CONVERSION_IN_PROCESS"
                }
                CampaignError::CannotDisableBroadMatchWhenTargetingBrands => {
                    "CANNOT_DISABLE_BROAD_MATCH_WHEN_TARGETING_BRANDS"
                }
                CampaignError::CannotEnableBroadMatchForBaseCampaignWithPromotingTrial => {
                    "CANNOT_ENABLE_BROAD_MATCH_FOR_BASE_CAMPAIGN_WITH_PROMOTING_TRIAL"
                }
                CampaignError::CannotEnableBroadMatchForPromotingTrialCampaign => {
...
pub mod user_list_customer_type_error_enum {
    ...
    impl UserListCustomerTypeError {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                UserListCustomerTypeError::Unspecified => "UNSPECIFIED",
                UserListCustomerTypeError::Unknown => "UNKNOWN",
                UserListCustomerTypeError::ConflictingCustomerTypes => {
                    "CONFLICTING_CUSTOMER_TYPES"
                }
                UserListCustomerTypeError::NoAccessToUserList => "NO_ACCESS_TO_USER_LIST",
                UserListCustomerTypeError::UserlistNotEligible => "USERLIST_NOT_ELIGIBLE",
                UserListCustomerTypeError::ConversionTrackingNotEnabledOrNotMccManagerAccount => {
                    "CONVERSION_TRACKING_NOT_ENABLED_OR_NOT_MCC_MANAGER_ACCOUNT"
                }
                UserListCustomerTypeError::TooManyUserListsForTheCustomerType => {
    ...
    impl BatchJobError {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                BatchJobError::AssetGroupAndAssetGroupAssetTransactionFailure => {
                    "ASSET_GROUP_AND_ASSET_GROUP_ASSET_TRANSACTION_FAILURE"
                }
                BatchJobError::AssetGroupListingGroupFilterTransactionFailure => {
                    "ASSET_GROUP_LISTING_GROUP_FILTER_TRANSACTION_FAILURE"
                }
                BatchJobError::RequestTooLarge => "REQUEST_TOO_LARGE",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
pub mod automatically_created_asset_removal_error_enum {
    ...
    impl AutomaticallyCreatedAssetRemovalError {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                AutomaticallyCreatedAssetRemovalError::Unspecified => "UNSPECIFIED",
                AutomaticallyCreatedAssetRemovalError::Unknown => "UNKNOWN",
                AutomaticallyCreatedAssetRemovalError::AdDoesNotExist => {
                    "AD_DOES_NOT_EXIST"
                }
                AutomaticallyCreatedAssetRemovalError::InvalidAdType => "INVALID_AD_TYPE",
                AutomaticallyCreatedAssetRemovalError::AssetDoesNotExist => {
                    "ASSET_DOES_NOT_EXIST"
                }
                AutomaticallyCreatedAssetRemovalError::AssetFieldTypeDoesNotMatch => {
                    "ASSET_FIELD_TYPE_DOES_NOT_MATCH"
                }
                AutomaticallyCreatedAssetRemovalError::NotAnAutomaticallyCreatedAsset => {
    ...
    impl OfflineUserDataJobError {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                OfflineUserDataJobError::OperationLevelConsentProvided => {
...
pub mod shopping_product_error_enum {
    ...
    impl ShoppingProductError {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ShoppingProductError::Unspecified => "UNSPECIFIED",
                ShoppingProductError::Unknown => "UNKNOWN",
                ShoppingProductError::MissingCampaignFilter => "MISSING_CAMPAIGN_FILTER",
                ShoppingProductError::MissingAdGroupFilter => "MISSING_AD_GROUP_FILTER",
                ShoppingProductError::UnsupportedDateSegmentation => {
...
pub mod shareable_preview_error_enum {
    ...
    impl ShareablePreviewError {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ShareablePreviewError::Unspecified => "UNSPECIFIED",
                ShareablePreviewError::Unknown => "UNKNOWN",
                ShareablePreviewError::TooManyAssetGroupsInRequest => {
                    "TOO_MANY_ASSET_GROUPS_IN_REQUEST"
                }
                ShareablePreviewError::AssetGroupDoesNotExistUnderThisCustomer => {
