...
pub mod test_environment_discovery_service_server {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with TestEnvironmentDiscoveryServiceServer.
    #[async_trait]
    pub trait TestEnvironmentDiscoveryService: std::marker::Send + std::marker::Sync + 'static {
        /// Gets the catalog of supported test environments.
        ///
        /// May return any of the following canonical error codes:
        ///
        ...
        /// - NOT_FOUND - if the environment type does not exist
        /// - INTERNAL - if an internal error occurred
        async fn get_test_environment_catalog(
            &self,
            request: tonic::Request<super::GetTestEnvironmentCatalogRequest>,
        ) -> std::result::Result<
            tonic::Response<super::TestEnvironmentCatalog>,
            tonic::Status,
        >;
    ...
    ///   IosRuntimeConfiguration.
    #[derive(Debug)]
    pub struct TestEnvironmentDiscoveryServiceServer<T> {
        inner: Arc<T>,
    ...
    impl<T> TestEnvironmentDiscoveryServiceServer<T> {
        pub fn new(inner: T) -> Self {
    ...
    for TestEnvironmentDiscoveryServiceServer<T>
    where
        T: TestEnvironmentDiscoveryService,
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.devtools.testing.v1.TestEnvironmentDiscoveryService/GetTestEnvironmentCatalog" => {
                    ...
                    struct GetTestEnvironmentCatalogSvc<
                        T: TestEnvironmentDiscoveryService,
                    >(
                        pub Arc<T>,
                    );
                    ...
                    > tonic::server::UnaryService<
                        super::GetTestEnvironmentCatalogRequest,
                    > for GetTestEnvironmentCatalogSvc<T> {
                        type Response = super::TestEnvironmentCatalog;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as TestEnvironmentDiscoveryService>::get_test_environment_catalog(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let fut = async move {
                        let method = GetTestEnvironmentCatalogSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
    ...
    impl<T> Clone for TestEnvironmentDiscoveryServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "google.devtools.testing.v1.TestEnvironmentDiscoveryService";
    impl<T> tonic::server::NamedService for TestEnvironmentDiscoveryServiceServer<T> {
...
pub mod test_execution_service_server {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with TestExecutionServiceServer.
    #[async_trait]
    pub trait TestExecutionService: std::marker::Send + std::marker::Sync + 'static {
        /// Creates and runs a matrix of tests according to the given specifications.
        /// Unsupported environments will be returned in the state UNSUPPORTED.
        /// A test matrix is limited to use at most 2000 devices in parallel.
        ///
        ...
        /// - INVALID_ARGUMENT - if the request is malformed or if the matrix tries
        ///                      to use too many simultaneous devices.
        async fn create_test_matrix(
            &self,
            request: tonic::Request<super::CreateTestMatrixRequest>,
        ) -> std::result::Result<tonic::Response<super::TestMatrix>, tonic::Status>;
        /// Checks the status of a test matrix and the executions once they
        /// are created.
        ///
        ...
        /// - INVALID_ARGUMENT - if the request is malformed
        /// - NOT_FOUND - if the Test Matrix does not exist
        async fn get_test_matrix(
            &self,
            request: tonic::Request<super::GetTestMatrixRequest>,
        ) -> std::result::Result<tonic::Response<super::TestMatrix>, tonic::Status>;
        /// Cancels unfinished test executions in a test matrix.
        /// This call returns immediately and cancellation proceeds asynchronously.
        /// If the matrix is already final, this operation will have no effect.
        ...
        /// - INVALID_ARGUMENT - if the request is malformed
        /// - NOT_FOUND - if the Test Matrix does not exist
        async fn cancel_test_matrix(
            &self,
            request: tonic::Request<super::CancelTestMatrixRequest>,
        ) -> std::result::Result<
            tonic::Response<super::CancelTestMatrixResponse>,
            tonic::Status,
        >;
    ...
    /// method. In addition, any method may return UNAVAILABLE or INTERNAL.
    #[derive(Debug)]
    pub struct TestExecutionServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> TestExecutionServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>>
    for TestExecutionServiceServer<T>
    where
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.devtools.testing.v1.TestExecutionService/CreateTestMatrix" => {
                    #[allow(non_camel_case_types)]
                    struct CreateTestMatrixSvc<T: TestExecutionService>(pub Arc<T>);
                    impl<
                        T: TestExecutionService,
                    > tonic::server::UnaryService<super::CreateTestMatrixRequest>
                    for CreateTestMatrixSvc<T> {
                        type Response = super::TestMatrix;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as TestExecutionService>::create_test_matrix(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = CreateTestMatrixSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.devtools.testing.v1.TestExecutionService/GetTestMatrix" => {
                    #[allow(non_camel_case_types)]
                    struct GetTestMatrixSvc<T: TestExecutionService>(pub Arc<T>);
                    impl<
                        T: TestExecutionService,
                    > tonic::server::UnaryService<super::GetTestMatrixRequest>
                    for GetTestMatrixSvc<T> {
                        type Response = super::TestMatrix;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as TestExecutionService>::get_test_matrix(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetTestMatrixSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.devtools.testing.v1.TestExecutionService/CancelTestMatrix" => {
                    #[allow(non_camel_case_types)]
                    struct CancelTestMatrixSvc<T: TestExecutionService>(pub Arc<T>);
                    impl<
                        T: TestExecutionService,
                    > tonic::server::UnaryService<super::CancelTestMatrixRequest>
                    for CancelTestMatrixSvc<T> {
                        type Response = super::CancelTestMatrixResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as TestExecutionService>::cancel_test_matrix(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = CancelTestMatrixSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for TestExecutionServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.devtools.testing.v1.TestExecutionService";
    impl<T> tonic::server::NamedService for TestExecutionServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
...
/// Generated server implementations.
pub mod direct_access_service_server {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with DirectAccessServiceServer.
    #[async_trait]
    pub trait DirectAccessService: std::marker::Send + std::marker::Sync + 'static {
        /// POST /v1/projects/{project_id}/deviceSessions
        async fn create_device_session(
            &self,
            request: tonic::Request<super::CreateDeviceSessionRequest>,
        ) -> std::result::Result<tonic::Response<super::DeviceSession>, tonic::Status>;
        /// GET /v1/projects/{project_id}/deviceSessions
        /// Lists device Sessions owned by the project user.
        async fn list_device_sessions(
            &self,
            request: tonic::Request<super::ListDeviceSessionsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListDeviceSessionsResponse>,
            tonic::Status,
        >;
        ...
        async fn get_device_session(
            &self,
            request: tonic::Request<super::GetDeviceSessionRequest>,
        ) -> std::result::Result<tonic::Response<super::DeviceSession>, tonic::Status>;
        /// POST
        /// /v1/projects/{project_id}/deviceSessions/{device_session_id}:cancel
        /// Changes the DeviceSession to state FINISHED and terminates all connections.
        ...
        async fn cancel_device_session(
            &self,
            request: tonic::Request<super::CancelDeviceSessionRequest>,
        ) -> std::result::Result<tonic::Response<()>, tonic::Status>;
        /// PATCH
        /// /v1/projects/{projectId}/deviceSessions/deviceSessionId}:updateDeviceSession
        /// Updates the current device session to the fields described by the
        ...
        async fn update_device_session(
            &self,
            request: tonic::Request<super::UpdateDeviceSessionRequest>,
        ) -> std::result::Result<tonic::Response<super::DeviceSession>, tonic::Status>;
        /// Server streaming response type for the AdbConnect method.
        type AdbConnectStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<super::DeviceMessage, tonic::Status>,
            >
            + std::marker::Send
            + 'static;
        /// Exposes ADB connection for use with the Adb Device Forwarder project
        ...
        async fn adb_connect(
            &self,
            request: tonic::Request<tonic::Streaming<super::AdbMessage>>,
        ) -> std::result::Result<tonic::Response<Self::AdbConnectStream>, tonic::Status>;
    }
    /// A service for allocating devices and interacting with the live-allocated
    /// devices.
    ///
    ...
    /// https://developer.android.com/studio/preview/android-device-streaming
    #[derive(Debug)]
    pub struct DirectAccessServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> DirectAccessServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for DirectAccessServiceServer<T>
    where
        T: DirectAccessService,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        type Response = http::Response<tonic::body::BoxBody>;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.devtools.testing.v1.DirectAccessService/CreateDeviceSession" => {
                    #[allow(non_camel_case_types)]
                    struct CreateDeviceSessionSvc<T: DirectAccessService>(pub Arc<T>);
                    impl<
                        T: DirectAccessService,
                    > tonic::server::UnaryService<super::CreateDeviceSessionRequest>
                    for CreateDeviceSessionSvc<T> {
                        type Response = super::DeviceSession;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DirectAccessService>::create_device_session(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = CreateDeviceSessionSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.devtools.testing.v1.DirectAccessService/ListDeviceSessions" => {
                    #[allow(non_camel_case_types)]
                    struct ListDeviceSessionsSvc<T: DirectAccessService>(pub Arc<T>);
                    impl<
                        T: DirectAccessService,
                    > tonic::server::UnaryService<super::ListDeviceSessionsRequest>
                    for ListDeviceSessionsSvc<T> {
                        type Response = super::ListDeviceSessionsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DirectAccessService>::list_device_sessions(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ListDeviceSessionsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.devtools.testing.v1.DirectAccessService/GetDeviceSession" => {
                    #[allow(non_camel_case_types)]
                    struct GetDeviceSessionSvc<T: DirectAccessService>(pub Arc<T>);
                    impl<
                        T: DirectAccessService,
                    > tonic::server::UnaryService<super::GetDeviceSessionRequest>
                    for GetDeviceSessionSvc<T> {
                        type Response = super::DeviceSession;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DirectAccessService>::get_device_session(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetDeviceSessionSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.devtools.testing.v1.DirectAccessService/CancelDeviceSession" => {
                    #[allow(non_camel_case_types)]
                    struct CancelDeviceSessionSvc<T: DirectAccessService>(pub Arc<T>);
                    impl<
                        T: DirectAccessService,
                    > tonic::server::UnaryService<super::CancelDeviceSessionRequest>
                    for CancelDeviceSessionSvc<T> {
                        type Response = ();
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DirectAccessService>::cancel_device_session(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = CancelDeviceSessionSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.devtools.testing.v1.DirectAccessService/UpdateDeviceSession" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateDeviceSessionSvc<T: DirectAccessService>(pub Arc<T>);
                    impl<
                        T: DirectAccessService,
                    > tonic::server::UnaryService<super::UpdateDeviceSessionRequest>
                    for UpdateDeviceSessionSvc<T> {
                        type Response = super::DeviceSession;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DirectAccessService>::update_device_session(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = UpdateDeviceSessionSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.devtools.testing.v1.DirectAccessService/AdbConnect" => {
                    #[allow(non_camel_case_types)]
                    struct AdbConnectSvc<T: DirectAccessService>(pub Arc<T>);
                    impl<
                        T: DirectAccessService,
                    > tonic::server::StreamingService<super::AdbMessage>
                    for AdbConnectSvc<T> {
                        type Response = super::DeviceMessage;
                        type ResponseStream = T::AdbConnectStream;
                        type Future = BoxFuture<
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DirectAccessService>::adb_connect(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = AdbConnectSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for DirectAccessServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.devtools.testing.v1.DirectAccessService";
    impl<T> tonic::server::NamedService for DirectAccessServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
...
/// Generated server implementations.
pub mod application_detail_service_server {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with ApplicationDetailServiceServer.
    #[async_trait]
    pub trait ApplicationDetailService: std::marker::Send + std::marker::Sync + 'static {
        /// Gets the details of an Android application APK.
        async fn get_apk_details(
            &self,
            request: tonic::Request<super::GetApkDetailsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetApkDetailsResponse>,
            tonic::Status,
        >;
    ...
    /// useful in the context of testing.
    #[derive(Debug)]
    pub struct ApplicationDetailServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> ApplicationDetailServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>>
    for ApplicationDetailServiceServer<T>
    where
        T: ApplicationDetailService,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        type Response = http::Response<tonic::body::BoxBody>;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.devtools.testing.v1.ApplicationDetailService/GetApkDetails" => {
                    #[allow(non_camel_case_types)]
                    struct GetApkDetailsSvc<T: ApplicationDetailService>(pub Arc<T>);
                    impl<
                        T: ApplicationDetailService,
                    > tonic::server::UnaryService<super::GetApkDetailsRequest>
                    for GetApkDetailsSvc<T> {
                        type Response = super::GetApkDetailsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ApplicationDetailService>::get_apk_details(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetApkDetailsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for ApplicationDetailServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.devtools.testing.v1.ApplicationDetailService";
    impl<T> tonic::server::NamedService for ApplicationDetailServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
