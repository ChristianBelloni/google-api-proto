        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.devtools.cloudtrace.v2.TraceService/BatchWriteSpans" => {
                    ...
                    impl<
                        T: TraceService,
                    > tonic::server::UnaryService<super::BatchWriteSpansRequest>
                    for BatchWriteSpansSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as TraceService>::batch_write_spans(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.devtools.cloudtrace.v2.TraceService/CreateSpan" => {
                    ...
                    impl<T: TraceService> tonic::server::UnaryService<super::Span>
                    for CreateSpanSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as TraceService>::create_span(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
