...
pub mod metastore_partition_service_server {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with MetastorePartitionServiceServer.
    #[async_trait]
    pub trait MetastorePartitionService: std::marker::Send + std::marker::Sync + 'static {
        /// Adds metastore partitions to a table.
        async fn batch_create_metastore_partitions(
            &self,
            request: tonic::Request<super::BatchCreateMetastorePartitionsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::BatchCreateMetastorePartitionsResponse>,
            tonic::Status,
        >;
        /// Deletes metastore partitions from a table.
        async fn batch_delete_metastore_partitions(
            &self,
            request: tonic::Request<super::BatchDeleteMetastorePartitionsRequest>,
        ) -> std::result::Result<tonic::Response<()>, tonic::Status>;
        /// Updates metastore partitions in a table.
        async fn batch_update_metastore_partitions(
            &self,
            request: tonic::Request<super::BatchUpdateMetastorePartitionsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::BatchUpdateMetastorePartitionsResponse>,
            tonic::Status,
        >;
        /// Gets metastore partitions from a table.
        async fn list_metastore_partitions(
            &self,
            request: tonic::Request<super::ListMetastorePartitionsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListMetastorePartitionsResponse>,
            tonic::Status,
        >;
        /// Server streaming response type for the StreamMetastorePartitions method.
        type StreamMetastorePartitionsStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<
                    super::StreamMetastorePartitionsResponse,
                    tonic::Status,
                >,
            >
            + std::marker::Send
        ...
        /// partitions or other reason), the server will close the stream with an
        /// error. This method is only available via the gRPC API (not REST).
        async fn stream_metastore_partitions(
            &self,
            request: tonic::Request<
                tonic::Streaming<super::StreamMetastorePartitionsRequest>,
            >,
        ) -> std::result::Result<
            tonic::Response<Self::StreamMetastorePartitionsStream>,
            tonic::Status,
        >;
    }
    /// BigQuery Metastore Partition Service API.
    ...
    /// The service supports only batch operations for write.
    #[derive(Debug)]
    pub struct MetastorePartitionServiceServer<T> {
        inner: Arc<T>,
    ...
    impl<T> MetastorePartitionServiceServer<T> {
        pub fn new(inner: T) -> Self {
    ...
    for MetastorePartitionServiceServer<T>
    where
        T: MetastorePartitionService,
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.cloud.bigquery.storage.v1alpha.MetastorePartitionService/BatchCreateMetastorePartitions" => {
                    ...
                    struct BatchCreateMetastorePartitionsSvc<
                        T: MetastorePartitionService,
                    >(
                        pub Arc<T>,
                    );
                    ...
                    > tonic::server::UnaryService<
                        super::BatchCreateMetastorePartitionsRequest,
                    > for BatchCreateMetastorePartitionsSvc<T> {
                        type Response = super::BatchCreateMetastorePartitionsResponse;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as MetastorePartitionService>::batch_create_metastore_partitions(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let fut = async move {
                        let method = BatchCreateMetastorePartitionsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                ...
                "/google.cloud.bigquery.storage.v1alpha.MetastorePartitionService/BatchDeleteMetastorePartitions" => {
                    #[allow(non_camel_case_types)]
                    struct BatchDeleteMetastorePartitionsSvc<
                        T: MetastorePartitionService,
                    >(
                        pub Arc<T>,
                    );
                    ...
                    > tonic::server::UnaryService<
                        super::BatchDeleteMetastorePartitionsRequest,
                    > for BatchDeleteMetastorePartitionsSvc<T> {
                        type Response = ();
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as MetastorePartitionService>::batch_delete_metastore_partitions(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = BatchDeleteMetastorePartitionsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.bigquery.storage.v1alpha.MetastorePartitionService/BatchUpdateMetastorePartitions" => {
                    #[allow(non_camel_case_types)]
                    struct BatchUpdateMetastorePartitionsSvc<
                        T: MetastorePartitionService,
                    >(
                        pub Arc<T>,
                    );
                    ...
                    > tonic::server::UnaryService<
                        super::BatchUpdateMetastorePartitionsRequest,
                    > for BatchUpdateMetastorePartitionsSvc<T> {
                        type Response = super::BatchUpdateMetastorePartitionsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as MetastorePartitionService>::batch_update_metastore_partitions(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = BatchUpdateMetastorePartitionsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.bigquery.storage.v1alpha.MetastorePartitionService/ListMetastorePartitions" => {
                    #[allow(non_camel_case_types)]
                    struct ListMetastorePartitionsSvc<T: MetastorePartitionService>(
                        pub Arc<T>,
                    );
                    impl<
                        T: MetastorePartitionService,
                    > tonic::server::UnaryService<super::ListMetastorePartitionsRequest>
                    for ListMetastorePartitionsSvc<T> {
                        type Response = super::ListMetastorePartitionsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            &mut self,
                            request: tonic::Request<
                                super::ListMetastorePartitionsRequest,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as MetastorePartitionService>::list_metastore_partitions(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ListMetastorePartitionsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.bigquery.storage.v1alpha.MetastorePartitionService/StreamMetastorePartitions" => {
                    #[allow(non_camel_case_types)]
                    struct StreamMetastorePartitionsSvc<T: MetastorePartitionService>(
                        pub Arc<T>,
                    );
                    impl<
                        T: MetastorePartitionService,
                    > tonic::server::StreamingService<
                        super::StreamMetastorePartitionsRequest,
                    > for StreamMetastorePartitionsSvc<T> {
                        type Response = super::StreamMetastorePartitionsResponse;
                        type ResponseStream = T::StreamMetastorePartitionsStream;
                        type Future = BoxFuture<
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as MetastorePartitionService>::stream_metastore_partitions(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = StreamMetastorePartitionsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for MetastorePartitionServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "google.cloud.bigquery.storage.v1alpha.MetastorePartitionService";
    impl<T> tonic::server::NamedService for MetastorePartitionServiceServer<T> {
