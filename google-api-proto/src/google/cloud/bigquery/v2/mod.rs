...
pub mod project_service_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.cloud.bigquery.v2.ProjectService/GetServiceAccount" => {
                    ...
                    struct GetServiceAccountSvc<T: ProjectService>(pub Arc<T>);
                    impl<
                        T: ProjectService,
                    ...
                    for GetServiceAccountSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as ProjectService>::get_service_account(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
    ...
    pub const SERVICE_NAME: &str = "google.cloud.bigquery.v2.ProjectService";
...
pub mod dataset_service_server {
    ...
    pub trait DatasetService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn insert_dataset(
            &self,
            request: tonic::Request<super::InsertDatasetRequest>,
        ) -> std::result::Result<tonic::Response<super::Dataset>, tonic::Status>;
        /// Updates information in an existing dataset. The update method replaces the
        /// entire dataset resource, whereas the patch method only replaces fields that
        /// are provided in the submitted dataset resource.
        ...
        async fn patch_dataset(
            &self,
            request: tonic::Request<super::UpdateOrPatchDatasetRequest>,
        ) -> std::result::Result<tonic::Response<super::Dataset>, tonic::Status>;
        /// Updates information in an existing dataset. The update method replaces the
        /// entire dataset resource, whereas the patch method only replaces fields that
        /// are provided in the submitted dataset resource.
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/google.cloud.bigquery.v2.DatasetService/InsertDataset" => {
                    #[allow(non_camel_case_types)]
                    struct InsertDatasetSvc<T: DatasetService>(pub Arc<T>);
                    impl<
                        T: DatasetService,
                    > tonic::server::UnaryService<super::InsertDatasetRequest>
                    for InsertDatasetSvc<T> {
                        type Response = super::Dataset;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DatasetService>::insert_dataset(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = InsertDatasetSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.bigquery.v2.DatasetService/PatchDataset" => {
                    #[allow(non_camel_case_types)]
                    struct PatchDatasetSvc<T: DatasetService>(pub Arc<T>);
                    impl<
                        T: DatasetService,
                    > tonic::server::UnaryService<super::UpdateOrPatchDatasetRequest>
                    for PatchDatasetSvc<T> {
                        type Response = super::Dataset;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DatasetService>::patch_dataset(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = PatchDatasetSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.bigquery.v2.DatasetService/UndeleteDataset" => {
                    #[allow(non_camel_case_types)]
                    struct UndeleteDatasetSvc<T: DatasetService>(pub Arc<T>);
                    impl<
                        T: DatasetService,
                    ...
                    for UndeleteDatasetSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DatasetService>::undelete_dataset(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.cloud.bigquery.v2.DatasetService";
...
/// Generated server implementations.
pub mod routine_service_server {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with RoutineServiceServer.
    #[async_trait]
    pub trait RoutineService: std::marker::Send + std::marker::Sync + 'static {
        /// Gets the specified routine resource by routine ID.
        async fn get_routine(
            &self,
            request: tonic::Request<super::GetRoutineRequest>,
        ) -> std::result::Result<tonic::Response<super::Routine>, tonic::Status>;
        /// Creates a new routine in the dataset.
        async fn insert_routine(
            &self,
            request: tonic::Request<super::InsertRoutineRequest>,
        ) -> std::result::Result<tonic::Response<super::Routine>, tonic::Status>;
        /// Updates information in an existing routine. The update method replaces the
        /// entire Routine resource.
        async fn update_routine(
            &self,
            request: tonic::Request<super::UpdateRoutineRequest>,
        ) -> std::result::Result<tonic::Response<super::Routine>, tonic::Status>;
        /// Patches information in an existing routine. The patch method does a partial
        /// update to an existing Routine resource.
        async fn patch_routine(
            &self,
            request: tonic::Request<super::PatchRoutineRequest>,
        ) -> std::result::Result<tonic::Response<super::Routine>, tonic::Status>;
        /// Deletes the routine specified by routineId from the dataset.
        async fn delete_routine(
            &self,
            request: tonic::Request<super::DeleteRoutineRequest>,
        ) -> std::result::Result<tonic::Response<()>, tonic::Status>;
        /// Lists all routines in the specified dataset. Requires the READER dataset
        /// role.
        async fn list_routines(
            &self,
            request: tonic::Request<super::ListRoutinesRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListRoutinesResponse>,
            tonic::Status,
        >;
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for RoutineServiceServer<T>
    where
        T: RoutineService,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.cloud.bigquery.v2.RoutineService/GetRoutine" => {
                    #[allow(non_camel_case_types)]
                    struct GetRoutineSvc<T: RoutineService>(pub Arc<T>);
                    impl<
                        T: RoutineService,
                    > tonic::server::UnaryService<super::GetRoutineRequest>
                    for GetRoutineSvc<T> {
                        type Response = super::Routine;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RoutineService>::get_routine(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetRoutineSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.bigquery.v2.RoutineService/InsertRoutine" => {
                    #[allow(non_camel_case_types)]
                    struct InsertRoutineSvc<T: RoutineService>(pub Arc<T>);
                    impl<
                        T: RoutineService,
                    > tonic::server::UnaryService<super::InsertRoutineRequest>
                    for InsertRoutineSvc<T> {
                        type Response = super::Routine;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RoutineService>::insert_routine(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = InsertRoutineSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.bigquery.v2.RoutineService/UpdateRoutine" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateRoutineSvc<T: RoutineService>(pub Arc<T>);
                    impl<
                        T: RoutineService,
                    > tonic::server::UnaryService<super::UpdateRoutineRequest>
                    for UpdateRoutineSvc<T> {
                        type Response = super::Routine;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RoutineService>::update_routine(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = UpdateRoutineSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.bigquery.v2.RoutineService/PatchRoutine" => {
                    #[allow(non_camel_case_types)]
                    struct PatchRoutineSvc<T: RoutineService>(pub Arc<T>);
                    impl<
                        T: RoutineService,
                    > tonic::server::UnaryService<super::PatchRoutineRequest>
                    for PatchRoutineSvc<T> {
                        type Response = super::Routine;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RoutineService>::patch_routine(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = PatchRoutineSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.bigquery.v2.RoutineService/DeleteRoutine" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteRoutineSvc<T: RoutineService>(pub Arc<T>);
                    impl<
                        T: RoutineService,
                    > tonic::server::UnaryService<super::DeleteRoutineRequest>
                    for DeleteRoutineSvc<T> {
                        type Response = ();
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RoutineService>::delete_routine(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = DeleteRoutineSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.bigquery.v2.RoutineService/ListRoutines" => {
                    #[allow(non_camel_case_types)]
                    struct ListRoutinesSvc<T: RoutineService>(pub Arc<T>);
                    impl<
                        T: RoutineService,
                    > tonic::server::UnaryService<super::ListRoutinesRequest>
                    for ListRoutinesSvc<T> {
                        type Response = super::ListRoutinesResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RoutineService>::list_routines(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ListRoutinesSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.cloud.bigquery.v2.RoutineService";
    impl<T> tonic::server::NamedService for RoutineServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
...
/// Generated server implementations.
pub mod row_access_policy_service_server {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with RowAccessPolicyServiceServer.
    #[async_trait]
    pub trait RowAccessPolicyService: std::marker::Send + std::marker::Sync + 'static {
        /// Lists all row access policies on the specified table.
        async fn list_row_access_policies(
            &self,
            request: tonic::Request<super::ListRowAccessPoliciesRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListRowAccessPoliciesResponse>,
            tonic::Status,
        >;
    ...
    /// Service for interacting with row access policies.
    #[derive(Debug)]
    pub struct RowAccessPolicyServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> RowAccessPolicyServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    for RowAccessPolicyServiceServer<T>
    where
        T: RowAccessPolicyService,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        type Response = http::Response<tonic::body::BoxBody>;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.cloud.bigquery.v2.RowAccessPolicyService/ListRowAccessPolicies" => {
                    #[allow(non_camel_case_types)]
                    struct ListRowAccessPoliciesSvc<T: RowAccessPolicyService>(
                        pub Arc<T>,
                    );
                    impl<
                        T: RowAccessPolicyService,
                    > tonic::server::UnaryService<super::ListRowAccessPoliciesRequest>
                    for ListRowAccessPoliciesSvc<T> {
                        type Response = super::ListRowAccessPoliciesResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RowAccessPolicyService>::list_row_access_policies(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ListRowAccessPoliciesSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for RowAccessPolicyServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.cloud.bigquery.v2.RowAccessPolicyService";
    impl<T> tonic::server::NamedService for RowAccessPolicyServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
...
pub mod model_service_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/google.cloud.bigquery.v2.ModelService/PatchModel" => {
                    ...
                    impl<
                        T: ModelService,
                    > tonic::server::UnaryService<super::PatchModelRequest>
                    for PatchModelSvc<T> {
                        type Response = super::Model;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ModelService>::patch_model(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.cloud.bigquery.v2.ModelService";
...
pub mod job_service_server {
    ...
    pub trait JobService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn insert_job(
            &self,
            request: tonic::Request<super::InsertJobRequest>,
        ) -> std::result::Result<tonic::Response<super::Job>, tonic::Status>;
        /// Requests the deletion of the metadata of a job. This call returns when the
        /// job's metadata is deleted.
        async fn delete_job(
        ...
        async fn get_query_results(
            &self,
            request: tonic::Request<super::GetQueryResultsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetQueryResultsResponse>,
            tonic::Status,
        >;
        ...
        async fn query(
            &self,
            request: tonic::Request<super::PostQueryRequest>,
        ) -> std::result::Result<tonic::Response<super::QueryResponse>, tonic::Status>;
    }
    /// This is an experimental RPC service definition for the BigQuery
    /// Job Service.
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.cloud.bigquery.v2.JobService/CancelJob" => {
                    ...
                    for CancelJobSvc<T> {
                        type Response = super::JobCancelResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                ...
                "/google.cloud.bigquery.v2.JobService/InsertJob" => {
                    #[allow(non_camel_case_types)]
                    struct InsertJobSvc<T: JobService>(pub Arc<T>);
                    impl<
                        T: JobService,
                    > tonic::server::UnaryService<super::InsertJobRequest>
                    for InsertJobSvc<T> {
                        type Response = super::Job;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as JobService>::insert_job(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.bigquery.v2.JobService/GetQueryResults" => {
                    #[allow(non_camel_case_types)]
                    struct GetQueryResultsSvc<T: JobService>(pub Arc<T>);
                    impl<
                        T: JobService,
                    > tonic::server::UnaryService<super::GetQueryResultsRequest>
                    for GetQueryResultsSvc<T> {
                        type Response = super::GetQueryResultsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as JobService>::get_query_results(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetQueryResultsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.bigquery.v2.JobService/Query" => {
                    #[allow(non_camel_case_types)]
                    struct QuerySvc<T: JobService>(pub Arc<T>);
                    impl<
                        T: JobService,
                    > tonic::server::UnaryService<super::PostQueryRequest>
                    for QuerySvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as JobService>::query(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.cloud.bigquery.v2.JobService";
...
pub mod table_service_server {
    ...
    pub trait TableService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn insert_table(
            &self,
            request: tonic::Request<super::InsertTableRequest>,
        ) -> std::result::Result<tonic::Response<super::Table>, tonic::Status>;
        /// Updates information in an existing table. The update method replaces the
        /// entire table resource, whereas the patch method only replaces fields that
        /// are provided in the submitted table resource.
        ...
        async fn patch_table(
            &self,
            request: tonic::Request<super::UpdateOrPatchTableRequest>,
        ) -> std::result::Result<tonic::Response<super::Table>, tonic::Status>;
        /// Updates information in an existing table. The update method replaces the
        /// entire Table resource, whereas the patch method only replaces fields that
        /// are provided in the submitted Table resource.
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.cloud.bigquery.v2.TableService/GetTable" => {
                    #[allow(non_camel_case_types)]
                    struct GetTableSvc<T: TableService>(pub Arc<T>);
                    impl<
                        T: TableService,
                    ...
                    for GetTableSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as TableService>::get_table(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.bigquery.v2.TableService/InsertTable" => {
                    #[allow(non_camel_case_types)]
                    struct InsertTableSvc<T: TableService>(pub Arc<T>);
                    impl<
                        T: TableService,
                    > tonic::server::UnaryService<super::InsertTableRequest>
                    for InsertTableSvc<T> {
                        type Response = super::Table;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as TableService>::insert_table(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = InsertTableSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.bigquery.v2.TableService/PatchTable" => {
                    #[allow(non_camel_case_types)]
                    struct PatchTableSvc<T: TableService>(pub Arc<T>);
                    impl<
                        T: TableService,
                    > tonic::server::UnaryService<super::UpdateOrPatchTableRequest>
                    for PatchTableSvc<T> {
                        type Response = super::Table;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as TableService>::patch_table(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = PatchTableSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.bigquery.v2.TableService/UpdateTable" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateTableSvc<T: TableService>(pub Arc<T>);
                    impl<
                        T: TableService,
                    > tonic::server::UnaryService<super::UpdateOrPatchTableRequest>
                    for UpdateTableSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as TableService>::update_table(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.bigquery.v2.TableService/DeleteTable" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteTableSvc<T: TableService>(pub Arc<T>);
                    impl<
                        T: TableService,
                    ...
                    for DeleteTableSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as TableService>::delete_table(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.bigquery.v2.TableService/ListTables" => {
                    #[allow(non_camel_case_types)]
                    struct ListTablesSvc<T: TableService>(pub Arc<T>);
                    impl<
                        T: TableService,
                    > tonic::server::UnaryService<super::ListTablesRequest>
                    for ListTablesSvc<T> {
                        type Response = super::TableList;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as TableService>::list_tables(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.cloud.bigquery.v2.TableService";
