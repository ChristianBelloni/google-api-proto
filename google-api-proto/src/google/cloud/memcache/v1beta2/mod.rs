...
pub mod cloud_memcache_server {
    ...
    pub trait CloudMemcache: std::marker::Send + std::marker::Sync + 'static {
        ...
        >;
        /// Updates software on the selected nodes of the Instance.
        async fn apply_software_update(
            &self,
            request: tonic::Request<super::ApplySoftwareUpdateRequest>,
        ) -> std::result::Result<
            tonic::Response<super::super::super::super::longrunning::Operation>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/google.cloud.memcache.v1beta2.CloudMemcache/ApplySoftwareUpdate" => {
                    #[allow(non_camel_case_types)]
                    struct ApplySoftwareUpdateSvc<T: CloudMemcache>(pub Arc<T>);
                    impl<
                        T: CloudMemcache,
                    > tonic::server::UnaryService<super::ApplySoftwareUpdateRequest>
                    for ApplySoftwareUpdateSvc<T> {
                        type Response = super::super::super::super::longrunning::Operation;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as CloudMemcache>::apply_software_update(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ApplySoftwareUpdateSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    pub const SERVICE_NAME: &str = "google.cloud.memcache.v1beta2.CloudMemcache";
