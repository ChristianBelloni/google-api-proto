...
pub mod assured_workloads_service_server {
    ...
    pub trait AssuredWorkloadsService: std::marker::Send + std::marker::Sync + 'static {
        ...
        /// Analyze if the source Assured Workloads can be moved to the target Assured
        /// Workload
        async fn analyze_workload_move(
            &self,
            request: tonic::Request<super::AnalyzeWorkloadMoveRequest>,
        ) -> std::result::Result<
            tonic::Response<super::AnalyzeWorkloadMoveResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/google.cloud.assuredworkloads.v1beta1.AssuredWorkloadsService/AnalyzeWorkloadMove" => {
                    #[allow(non_camel_case_types)]
                    struct AnalyzeWorkloadMoveSvc<T: AssuredWorkloadsService>(
                        pub Arc<T>,
                    );
                    impl<
                        T: AssuredWorkloadsService,
                    > tonic::server::UnaryService<super::AnalyzeWorkloadMoveRequest>
                    for AnalyzeWorkloadMoveSvc<T> {
                        type Response = super::AnalyzeWorkloadMoveResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AssuredWorkloadsService>::analyze_workload_move(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = AnalyzeWorkloadMoveSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    pub const SERVICE_NAME: &str = "google.cloud.assuredworkloads.v1beta1.AssuredWorkloadsService";
