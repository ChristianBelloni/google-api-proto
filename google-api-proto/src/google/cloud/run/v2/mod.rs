...
pub mod tasks_server {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with TasksServer.
    #[async_trait]
    pub trait Tasks: std::marker::Send + std::marker::Sync + 'static {
        /// Gets information about a Task.
        async fn get_task(
            &self,
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for TasksServer<T>
    where
        T: Tasks,
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.cloud.run.v2.Tasks/GetTask" => {
                    ...
                    impl<T: Tasks> tonic::server::UnaryService<super::GetTaskRequest>
                    for GetTaskSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as Tasks>::get_task(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.run.v2.Tasks/ListTasks" => {
                    #[allow(non_camel_case_types)]
                    struct ListTasksSvc<T: Tasks>(pub Arc<T>);
                    impl<T: Tasks> tonic::server::UnaryService<super::ListTasksRequest>
                    for ListTasksSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Tasks>::list_tasks(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T> Clone for TasksServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "google.cloud.run.v2.Tasks";
    impl<T> tonic::server::NamedService for TasksServer<T> {
...
pub mod jobs_server {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with JobsServer.
    #[async_trait]
    pub trait Jobs: std::marker::Send + std::marker::Sync + 'static {
        /// Creates a Job.
        async fn create_job(
            &self,
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for JobsServer<T>
    where
        T: Jobs,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.cloud.run.v2.Jobs/CreateJob" => {
                    #[allow(non_camel_case_types)]
                    struct CreateJobSvc<T: Jobs>(pub Arc<T>);
                    impl<T: Jobs> tonic::server::UnaryService<super::CreateJobRequest>
                    for CreateJobSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Jobs>::create_job(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.run.v2.Jobs/GetJob" => {
                    #[allow(non_camel_case_types)]
                    struct GetJobSvc<T: Jobs>(pub Arc<T>);
                    impl<T: Jobs> tonic::server::UnaryService<super::GetJobRequest>
                    for GetJobSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Jobs>::get_job(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.run.v2.Jobs/ListJobs" => {
                    #[allow(non_camel_case_types)]
                    struct ListJobsSvc<T: Jobs>(pub Arc<T>);
                    impl<T: Jobs> tonic::server::UnaryService<super::ListJobsRequest>
                    for ListJobsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Jobs>::list_jobs(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.run.v2.Jobs/UpdateJob" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateJobSvc<T: Jobs>(pub Arc<T>);
                    impl<T: Jobs> tonic::server::UnaryService<super::UpdateJobRequest>
                    for UpdateJobSvc<T> {
                        type Response = super::super::super::super::longrunning::Operation;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Jobs>::update_job(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.run.v2.Jobs/DeleteJob" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteJobSvc<T: Jobs>(pub Arc<T>);
                    impl<T: Jobs> tonic::server::UnaryService<super::DeleteJobRequest>
                    for DeleteJobSvc<T> {
                        type Response = super::super::super::super::longrunning::Operation;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Jobs>::delete_job(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.run.v2.Jobs/RunJob" => {
                    #[allow(non_camel_case_types)]
                    struct RunJobSvc<T: Jobs>(pub Arc<T>);
                    impl<T: Jobs> tonic::server::UnaryService<super::RunJobRequest>
                    for RunJobSvc<T> {
                        type Response = super::super::super::super::longrunning::Operation;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Jobs>::run_job(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.run.v2.Jobs/GetIamPolicy" => {
                    #[allow(non_camel_case_types)]
                    struct GetIamPolicySvc<T: Jobs>(pub Arc<T>);
                    impl<
                        T: Jobs,
                    ...
                    > for GetIamPolicySvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Jobs>::get_iam_policy(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.run.v2.Jobs/SetIamPolicy" => {
                    #[allow(non_camel_case_types)]
                    struct SetIamPolicySvc<T: Jobs>(pub Arc<T>);
                    impl<
                        T: Jobs,
                    > tonic::server::UnaryService<
                        super::super::super::super::iam::v1::SetIamPolicyRequest,
                    > for SetIamPolicySvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Jobs>::set_iam_policy(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.run.v2.Jobs/TestIamPermissions" => {
                    #[allow(non_camel_case_types)]
                    struct TestIamPermissionsSvc<T: Jobs>(pub Arc<T>);
                    impl<
                        T: Jobs,
                    > tonic::server::UnaryService<
                        super::super::super::super::iam::v1::TestIamPermissionsRequest,
                    > for TestIamPermissionsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Jobs>::test_iam_permissions(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.cloud.run.v2.Jobs";
    impl<T> tonic::server::NamedService for JobsServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
...
/// Generated server implementations.
pub mod revisions_server {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with RevisionsServer.
    #[async_trait]
    pub trait Revisions: std::marker::Send + std::marker::Sync + 'static {
        /// Gets information about a Revision.
        ...
        async fn delete_revision(
            &self,
            request: tonic::Request<super::DeleteRevisionRequest>,
        ) -> std::result::Result<
            tonic::Response<super::super::super::super::longrunning::Operation>,
            tonic::Status,
        >;
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for RevisionsServer<T>
    where
        T: Revisions,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.cloud.run.v2.Revisions/GetRevision" => {
                    #[allow(non_camel_case_types)]
                    struct GetRevisionSvc<T: Revisions>(pub Arc<T>);
                    impl<
                        T: Revisions,
                    ...
                    for GetRevisionSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Revisions>::get_revision(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.run.v2.Revisions/ListRevisions" => {
                    #[allow(non_camel_case_types)]
                    struct ListRevisionsSvc<T: Revisions>(pub Arc<T>);
                    impl<
                        T: Revisions,
                    ...
                    for ListRevisionsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Revisions>::list_revisions(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.run.v2.Revisions/DeleteRevision" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteRevisionSvc<T: Revisions>(pub Arc<T>);
                    impl<
                        T: Revisions,
                    > tonic::server::UnaryService<super::DeleteRevisionRequest>
                    for DeleteRevisionSvc<T> {
                        type Response = super::super::super::super::longrunning::Operation;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Revisions>::delete_revision(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = DeleteRevisionSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for RevisionsServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.cloud.run.v2.Revisions";
    impl<T> tonic::server::NamedService for RevisionsServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
...
pub mod executions_server {
    ...
    #[async_trait]
    pub trait Executions: std::marker::Send + std::marker::Sync + 'static {
        /// Gets information about an Execution.
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/google.cloud.run.v2.Executions/DeleteExecution" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteExecutionSvc<T: Executions>(pub Arc<T>);
                    impl<
                        T: Executions,
                    ...
                    for DeleteExecutionSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Executions>::delete_execution(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T> Clone for ExecutionsServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.cloud.run.v2.Executions";
    impl<T> tonic::server::NamedService for ExecutionsServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
...
pub mod services_server {
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.cloud.run.v2.Services/CreateService" => {
                    #[allow(non_camel_case_types)]
                    struct CreateServiceSvc<T: Services>(pub Arc<T>);
                    impl<
                        T: Services,
                    ...
                    for CreateServiceSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Services>::create_service(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.run.v2.Services/GetIamPolicy" => {
                    #[allow(non_camel_case_types)]
                    struct GetIamPolicySvc<T: Services>(pub Arc<T>);
                    impl<
                        T: Services,
                    > tonic::server::UnaryService<
                        super::super::super::super::iam::v1::GetIamPolicyRequest,
                    > for GetIamPolicySvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Services>::get_iam_policy(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.run.v2.Services/SetIamPolicy" => {
                    #[allow(non_camel_case_types)]
                    struct SetIamPolicySvc<T: Services>(pub Arc<T>);
                    impl<
                        T: Services,
                    > tonic::server::UnaryService<
                        super::super::super::super::iam::v1::SetIamPolicyRequest,
                    > for SetIamPolicySvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Services>::set_iam_policy(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.run.v2.Services/TestIamPermissions" => {
                    #[allow(non_camel_case_types)]
                    struct TestIamPermissionsSvc<T: Services>(pub Arc<T>);
                    impl<
                        T: Services,
                    > tonic::server::UnaryService<
                        super::super::super::super::iam::v1::TestIamPermissionsRequest,
                    > for TestIamPermissionsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Services>::test_iam_permissions(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.cloud.run.v2.Services";
