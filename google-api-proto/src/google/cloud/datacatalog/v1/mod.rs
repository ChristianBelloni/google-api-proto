...
pub mod data_catalog_server {
    ...
    pub trait DataCatalog: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn modify_entry_overview(
            &self,
            request: tonic::Request<super::ModifyEntryOverviewRequest>,
        ) -> std::result::Result<tonic::Response<super::EntryOverview>, tonic::Status>;
        /// Modifies contacts, part of the business context of an
        /// [Entry][google.cloud.datacatalog.v1.Entry].
        ///
        ...
        async fn modify_entry_contacts(
            &self,
            request: tonic::Request<super::ModifyEntryContactsRequest>,
        ) -> std::result::Result<tonic::Response<super::Contacts>, tonic::Status>;
        /// Creates a tag template.
        ///
        /// You must enable the Data Catalog API in the project identified by the
        ...
        async fn rename_tag_template_field_enum_value(
            &self,
            request: tonic::Request<super::RenameTagTemplateFieldEnumValueRequest>,
        ) -> std::result::Result<
            tonic::Response<super::TagTemplateField>,
            tonic::Status,
        >;
        ...
        async fn reconcile_tags(
            &self,
            request: tonic::Request<super::ReconcileTagsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::super::super::super::longrunning::Operation>,
            tonic::Status,
        >;
        ...
        async fn star_entry(
            &self,
            request: tonic::Request<super::StarEntryRequest>,
        ) -> std::result::Result<
            tonic::Response<super::StarEntryResponse>,
            tonic::Status,
        >;
        ...
        async fn unstar_entry(
            &self,
            request: tonic::Request<super::UnstarEntryRequest>,
        ) -> std::result::Result<
            tonic::Response<super::UnstarEntryResponse>,
            tonic::Status,
        >;
        ...
        async fn import_entries(
            &self,
            request: tonic::Request<super::ImportEntriesRequest>,
        ) -> std::result::Result<
            tonic::Response<super::super::super::super::longrunning::Operation>,
            tonic::Status,
        >;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.cloud.datacatalog.v1.DataCatalog/SearchCatalog" => {
                    ...
                    impl<
                        T: DataCatalog,
                    > tonic::server::UnaryService<super::SearchCatalogRequest>
                    for SearchCatalogSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as DataCatalog>::search_catalog(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.datacatalog.v1.DataCatalog/CreateEntryGroup" => {
                    ...
                    for CreateEntryGroupSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DataCatalog>::create_entry_group(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.cloud.datacatalog.v1.DataCatalog/GetEntryGroup" => {
                    ...
                    for GetEntryGroupSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DataCatalog>::get_entry_group(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.datacatalog.v1.DataCatalog/UpdateEntryGroup" => {
                    ...
                    for UpdateEntryGroupSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DataCatalog>::update_entry_group(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.cloud.datacatalog.v1.DataCatalog/DeleteEntryGroup" => {
                    ...
                    for DeleteEntryGroupSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DataCatalog>::delete_entry_group(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.cloud.datacatalog.v1.DataCatalog/ListEntryGroups" => {
                    ...
                    for ListEntryGroupsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DataCatalog>::list_entry_groups(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.datacatalog.v1.DataCatalog/CreateEntry" => {
                    ...
                    for CreateEntrySvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DataCatalog>::create_entry(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.datacatalog.v1.DataCatalog/UpdateEntry" => {
                    ...
                    for UpdateEntrySvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DataCatalog>::update_entry(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.datacatalog.v1.DataCatalog/DeleteEntry" => {
                    ...
                    for DeleteEntrySvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DataCatalog>::delete_entry(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.datacatalog.v1.DataCatalog/GetEntry" => {
                    ...
                    for GetEntrySvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DataCatalog>::get_entry(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.datacatalog.v1.DataCatalog/LookupEntry" => {
                    ...
                    for LookupEntrySvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DataCatalog>::lookup_entry(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.datacatalog.v1.DataCatalog/ListEntries" => {
                    ...
                    for ListEntriesSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DataCatalog>::list_entries(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.datacatalog.v1.DataCatalog/ModifyEntryOverview" => {
                    #[allow(non_camel_case_types)]
                    struct ModifyEntryOverviewSvc<T: DataCatalog>(pub Arc<T>);
                    impl<
                        T: DataCatalog,
                    > tonic::server::UnaryService<super::ModifyEntryOverviewRequest>
                    for ModifyEntryOverviewSvc<T> {
                        type Response = super::EntryOverview;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DataCatalog>::modify_entry_overview(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ModifyEntryOverviewSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.datacatalog.v1.DataCatalog/ModifyEntryContacts" => {
                    #[allow(non_camel_case_types)]
                    struct ModifyEntryContactsSvc<T: DataCatalog>(pub Arc<T>);
                    impl<
                        T: DataCatalog,
                    > tonic::server::UnaryService<super::ModifyEntryContactsRequest>
                    for ModifyEntryContactsSvc<T> {
                        type Response = super::Contacts;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DataCatalog>::modify_entry_contacts(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ModifyEntryContactsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.datacatalog.v1.DataCatalog/CreateTagTemplate" => {
                    ...
                    for CreateTagTemplateSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DataCatalog>::create_tag_template(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.cloud.datacatalog.v1.DataCatalog/GetTagTemplate" => {
                    ...
                    impl<
                        T: DataCatalog,
                    > tonic::server::UnaryService<super::GetTagTemplateRequest>
                    for GetTagTemplateSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DataCatalog>::get_tag_template(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.datacatalog.v1.DataCatalog/UpdateTagTemplate" => {
                    ...
                    for UpdateTagTemplateSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DataCatalog>::update_tag_template(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.cloud.datacatalog.v1.DataCatalog/DeleteTagTemplate" => {
                    ...
                    for DeleteTagTemplateSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DataCatalog>::delete_tag_template(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.cloud.datacatalog.v1.DataCatalog/CreateTagTemplateField" => {
                    ...
                    for CreateTagTemplateFieldSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DataCatalog>::create_tag_template_field(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/google.cloud.datacatalog.v1.DataCatalog/UpdateTagTemplateField" => {
                    ...
                    for UpdateTagTemplateFieldSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DataCatalog>::update_tag_template_field(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/google.cloud.datacatalog.v1.DataCatalog/RenameTagTemplateField" => {
                    ...
                    for RenameTagTemplateFieldSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DataCatalog>::rename_tag_template_field(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/google.cloud.datacatalog.v1.DataCatalog/RenameTagTemplateFieldEnumValue" => {
                    #[allow(non_camel_case_types)]
                    struct RenameTagTemplateFieldEnumValueSvc<T: DataCatalog>(
                        pub Arc<T>,
                    );
                    impl<
                        T: DataCatalog,
                    > tonic::server::UnaryService<
                        super::RenameTagTemplateFieldEnumValueRequest,
                    > for RenameTagTemplateFieldEnumValueSvc<T> {
                        type Response = super::TagTemplateField;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DataCatalog>::rename_tag_template_field_enum_value(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/google.cloud.datacatalog.v1.DataCatalog/DeleteTagTemplateField" => {
                    ...
                    for DeleteTagTemplateFieldSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DataCatalog>::delete_tag_template_field(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/google.cloud.datacatalog.v1.DataCatalog/CreateTag" => {
                    ...
                    for CreateTagSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DataCatalog>::create_tag(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.datacatalog.v1.DataCatalog/UpdateTag" => {
                    ...
                    for UpdateTagSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DataCatalog>::update_tag(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.datacatalog.v1.DataCatalog/DeleteTag" => {
                    ...
                    for DeleteTagSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DataCatalog>::delete_tag(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.datacatalog.v1.DataCatalog/ListTags" => {
                    ...
                    for ListTagsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DataCatalog>::list_tags(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.datacatalog.v1.DataCatalog/ReconcileTags" => {
                    #[allow(non_camel_case_types)]
                    struct ReconcileTagsSvc<T: DataCatalog>(pub Arc<T>);
                    impl<
                        T: DataCatalog,
                    > tonic::server::UnaryService<super::ReconcileTagsRequest>
                    for ReconcileTagsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DataCatalog>::reconcile_tags(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ReconcileTagsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.datacatalog.v1.DataCatalog/StarEntry" => {
                    #[allow(non_camel_case_types)]
                    struct StarEntrySvc<T: DataCatalog>(pub Arc<T>);
                    impl<
                        T: DataCatalog,
                    > tonic::server::UnaryService<super::StarEntryRequest>
                    for StarEntrySvc<T> {
                        type Response = super::StarEntryResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DataCatalog>::star_entry(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.datacatalog.v1.DataCatalog/UnstarEntry" => {
                    #[allow(non_camel_case_types)]
                    struct UnstarEntrySvc<T: DataCatalog>(pub Arc<T>);
                    impl<
                        T: DataCatalog,
                    > tonic::server::UnaryService<super::UnstarEntryRequest>
                    for UnstarEntrySvc<T> {
                        type Response = super::UnstarEntryResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DataCatalog>::unstar_entry(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = UnstarEntrySvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.datacatalog.v1.DataCatalog/SetIamPolicy" => {
                    ...
                    > for SetIamPolicySvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DataCatalog>::set_iam_policy(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.datacatalog.v1.DataCatalog/GetIamPolicy" => {
                    ...
                    > for GetIamPolicySvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DataCatalog>::get_iam_policy(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.datacatalog.v1.DataCatalog/TestIamPermissions" => {
                    ...
                    > for TestIamPermissionsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DataCatalog>::test_iam_permissions(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.cloud.datacatalog.v1.DataCatalog/ImportEntries" => {
                    #[allow(non_camel_case_types)]
                    struct ImportEntriesSvc<T: DataCatalog>(pub Arc<T>);
                    impl<
                        T: DataCatalog,
                    > tonic::server::UnaryService<super::ImportEntriesRequest>
                    for ImportEntriesSvc<T> {
                        type Response = super::super::super::super::longrunning::Operation;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DataCatalog>::import_entries(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ImportEntriesSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    pub const SERVICE_NAME: &str = "google.cloud.datacatalog.v1.DataCatalog";
...
pub mod policy_tag_manager_server {
    ...
    pub trait PolicyTagManager: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn create_taxonomy(
            &self,
            request: tonic::Request<super::CreateTaxonomyRequest>,
        ) -> std::result::Result<tonic::Response<super::Taxonomy>, tonic::Status>;
        /// Deletes a taxonomy, including all policy tags in this
        /// taxonomy, their associated policies, and the policy tags references from
        /// BigQuery columns.
        async fn delete_taxonomy(
            &self,
            request: tonic::Request<super::DeleteTaxonomyRequest>,
        ) -> std::result::Result<tonic::Response<()>, tonic::Status>;
        /// Updates a taxonomy, including its display name,
        /// description, and activated policy types.
        async fn update_taxonomy(
            &self,
            request: tonic::Request<super::UpdateTaxonomyRequest>,
        ) -> std::result::Result<tonic::Response<super::Taxonomy>, tonic::Status>;
        /// Lists all taxonomies in a project in a particular location that you
        /// have a permission to view.
        async fn list_taxonomies(
            &self,
            request: tonic::Request<super::ListTaxonomiesRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListTaxonomiesResponse>,
            tonic::Status,
        >;
        ...
        async fn create_policy_tag(
            &self,
            request: tonic::Request<super::CreatePolicyTagRequest>,
        ) -> std::result::Result<tonic::Response<super::PolicyTag>, tonic::Status>;
        /// Deletes a policy tag together with the following:
        ///
        /// * All of its descendant policy tags, if any
        ...
        async fn delete_policy_tag(
            &self,
            request: tonic::Request<super::DeletePolicyTagRequest>,
        ) -> std::result::Result<tonic::Response<()>, tonic::Status>;
        /// Updates a policy tag, including its display
        /// name, description, and parent policy tag.
        async fn update_policy_tag(
            &self,
            request: tonic::Request<super::UpdatePolicyTagRequest>,
        ) -> std::result::Result<tonic::Response<super::PolicyTag>, tonic::Status>;
        /// Lists all policy tags in a taxonomy.
        async fn list_policy_tags(
            &self,
            request: tonic::Request<super::ListPolicyTagsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListPolicyTagsResponse>,
            tonic::Status,
        >;
        ...
        async fn get_policy_tag(
            &self,
            request: tonic::Request<super::GetPolicyTagRequest>,
        ) -> std::result::Result<tonic::Response<super::PolicyTag>, tonic::Status>;
        /// Gets the IAM policy for a policy tag or a taxonomy.
        async fn get_iam_policy(
            &self,
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.cloud.datacatalog.v1.PolicyTagManager/CreateTaxonomy" => {
                    #[allow(non_camel_case_types)]
                    struct CreateTaxonomySvc<T: PolicyTagManager>(pub Arc<T>);
                    impl<
                        T: PolicyTagManager,
                    > tonic::server::UnaryService<super::CreateTaxonomyRequest>
                    for CreateTaxonomySvc<T> {
                        type Response = super::Taxonomy;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PolicyTagManager>::create_taxonomy(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.cloud.datacatalog.v1.PolicyTagManager/DeleteTaxonomy" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteTaxonomySvc<T: PolicyTagManager>(pub Arc<T>);
                    impl<
                        T: PolicyTagManager,
                    > tonic::server::UnaryService<super::DeleteTaxonomyRequest>
                    for DeleteTaxonomySvc<T> {
                        type Response = ();
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PolicyTagManager>::delete_taxonomy(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.cloud.datacatalog.v1.PolicyTagManager/UpdateTaxonomy" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateTaxonomySvc<T: PolicyTagManager>(pub Arc<T>);
                    impl<
                        T: PolicyTagManager,
                    > tonic::server::UnaryService<super::UpdateTaxonomyRequest>
                    for UpdateTaxonomySvc<T> {
                        type Response = super::Taxonomy;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PolicyTagManager>::update_taxonomy(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.cloud.datacatalog.v1.PolicyTagManager/ListTaxonomies" => {
                    #[allow(non_camel_case_types)]
                    struct ListTaxonomiesSvc<T: PolicyTagManager>(pub Arc<T>);
                    impl<
                        T: PolicyTagManager,
                    > tonic::server::UnaryService<super::ListTaxonomiesRequest>
                    for ListTaxonomiesSvc<T> {
                        type Response = super::ListTaxonomiesResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PolicyTagManager>::list_taxonomies(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.cloud.datacatalog.v1.PolicyTagManager/GetTaxonomy" => {
                    #[allow(non_camel_case_types)]
                    struct GetTaxonomySvc<T: PolicyTagManager>(pub Arc<T>);
                    impl<
                        T: PolicyTagManager,
                    ...
                    for GetTaxonomySvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PolicyTagManager>::get_taxonomy(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.datacatalog.v1.PolicyTagManager/CreatePolicyTag" => {
                    #[allow(non_camel_case_types)]
                    struct CreatePolicyTagSvc<T: PolicyTagManager>(pub Arc<T>);
                    impl<
                        T: PolicyTagManager,
                    > tonic::server::UnaryService<super::CreatePolicyTagRequest>
                    for CreatePolicyTagSvc<T> {
                        type Response = super::PolicyTag;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PolicyTagManager>::create_policy_tag(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.cloud.datacatalog.v1.PolicyTagManager/DeletePolicyTag" => {
                    #[allow(non_camel_case_types)]
                    struct DeletePolicyTagSvc<T: PolicyTagManager>(pub Arc<T>);
                    impl<
                        T: PolicyTagManager,
                    > tonic::server::UnaryService<super::DeletePolicyTagRequest>
                    for DeletePolicyTagSvc<T> {
                        type Response = ();
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PolicyTagManager>::delete_policy_tag(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.cloud.datacatalog.v1.PolicyTagManager/UpdatePolicyTag" => {
                    #[allow(non_camel_case_types)]
                    struct UpdatePolicyTagSvc<T: PolicyTagManager>(pub Arc<T>);
                    impl<
                        T: PolicyTagManager,
                    > tonic::server::UnaryService<super::UpdatePolicyTagRequest>
                    for UpdatePolicyTagSvc<T> {
                        type Response = super::PolicyTag;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PolicyTagManager>::update_policy_tag(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.cloud.datacatalog.v1.PolicyTagManager/ListPolicyTags" => {
                    #[allow(non_camel_case_types)]
                    struct ListPolicyTagsSvc<T: PolicyTagManager>(pub Arc<T>);
                    impl<
                        T: PolicyTagManager,
                    > tonic::server::UnaryService<super::ListPolicyTagsRequest>
                    for ListPolicyTagsSvc<T> {
                        type Response = super::ListPolicyTagsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PolicyTagManager>::list_policy_tags(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.cloud.datacatalog.v1.PolicyTagManager/GetPolicyTag" => {
                    #[allow(non_camel_case_types)]
                    struct GetPolicyTagSvc<T: PolicyTagManager>(pub Arc<T>);
                    impl<
                        T: PolicyTagManager,
                    > tonic::server::UnaryService<super::GetPolicyTagRequest>
                    for GetPolicyTagSvc<T> {
                        type Response = super::PolicyTag;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PolicyTagManager>::get_policy_tag(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.cloud.datacatalog.v1.PolicyTagManager/GetIamPolicy" => {
                    #[allow(non_camel_case_types)]
                    struct GetIamPolicySvc<T: PolicyTagManager>(pub Arc<T>);
                    impl<
                        T: PolicyTagManager,
                    > tonic::server::UnaryService<
                        super::super::super::super::iam::v1::GetIamPolicyRequest,
                    > for GetIamPolicySvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PolicyTagManager>::get_iam_policy(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.cloud.datacatalog.v1.PolicyTagManager/SetIamPolicy" => {
                    #[allow(non_camel_case_types)]
                    struct SetIamPolicySvc<T: PolicyTagManager>(pub Arc<T>);
                    impl<
                        T: PolicyTagManager,
                    > tonic::server::UnaryService<
                        super::super::super::super::iam::v1::SetIamPolicyRequest,
                    > for SetIamPolicySvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PolicyTagManager>::set_iam_policy(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.cloud.datacatalog.v1.PolicyTagManager/TestIamPermissions" => {
                    #[allow(non_camel_case_types)]
                    struct TestIamPermissionsSvc<T: PolicyTagManager>(pub Arc<T>);
                    impl<
                        T: PolicyTagManager,
                    > tonic::server::UnaryService<
                        super::super::super::super::iam::v1::TestIamPermissionsRequest,
                    > for TestIamPermissionsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PolicyTagManager>::test_iam_permissions(
                                        &inner,
                                        request,
                                    )
                                    .await
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.cloud.datacatalog.v1.PolicyTagManager";
...
pub mod policy_tag_manager_serialization_server {
    ...
    pub trait PolicyTagManagerSerialization: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn replace_taxonomy(
            &self,
            request: tonic::Request<super::ReplaceTaxonomyRequest>,
        ) -> std::result::Result<tonic::Response<super::Taxonomy>, tonic::Status>;
        /// Creates new taxonomies (including their policy tags) in a given project
        /// by importing from inlined or cross-regional sources.
        ///
        ...
        async fn import_taxonomies(
            &self,
            request: tonic::Request<super::ImportTaxonomiesRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ImportTaxonomiesResponse>,
            tonic::Status,
        >;
        ...
        async fn export_taxonomies(
            &self,
            request: tonic::Request<super::ExportTaxonomiesRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ExportTaxonomiesResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.cloud.datacatalog.v1.PolicyTagManagerSerialization/ReplaceTaxonomy" => {
                    #[allow(non_camel_case_types)]
                    struct ReplaceTaxonomySvc<T: PolicyTagManagerSerialization>(
                        pub Arc<T>,
                    );
                    impl<
                        T: PolicyTagManagerSerialization,
                    > tonic::server::UnaryService<super::ReplaceTaxonomyRequest>
                    for ReplaceTaxonomySvc<T> {
                        type Response = super::Taxonomy;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PolicyTagManagerSerialization>::replace_taxonomy(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ReplaceTaxonomySvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.datacatalog.v1.PolicyTagManagerSerialization/ImportTaxonomies" => {
                    #[allow(non_camel_case_types)]
                    struct ImportTaxonomiesSvc<T: PolicyTagManagerSerialization>(
                        pub Arc<T>,
                    );
                    impl<
                        T: PolicyTagManagerSerialization,
                    > tonic::server::UnaryService<super::ImportTaxonomiesRequest>
                    for ImportTaxonomiesSvc<T> {
                        type Response = super::ImportTaxonomiesResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PolicyTagManagerSerialization>::import_taxonomies(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/google.cloud.datacatalog.v1.PolicyTagManagerSerialization/ExportTaxonomies" => {
                    #[allow(non_camel_case_types)]
                    struct ExportTaxonomiesSvc<T: PolicyTagManagerSerialization>(
                        pub Arc<T>,
                    );
                    impl<
                        T: PolicyTagManagerSerialization,
                    > tonic::server::UnaryService<super::ExportTaxonomiesRequest>
                    for ExportTaxonomiesSvc<T> {
                        type Response = super::ExportTaxonomiesResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PolicyTagManagerSerialization>::export_taxonomies(
                                        &inner,
                                        request,
                                    )
                                    .await
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.cloud.datacatalog.v1.PolicyTagManagerSerialization";
