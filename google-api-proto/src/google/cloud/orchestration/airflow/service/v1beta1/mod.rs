...
pub mod image_versions_server {
    ...
    pub const SERVICE_NAME: &str = "google.cloud.orchestration.airflow.service.v1beta1.ImageVersions";
...
pub mod environments_server {
    ...
    pub trait Environments: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn restart_web_server(
            &self,
            request: tonic::Request<super::RestartWebServerRequest>,
        ) -> std::result::Result<
            tonic::Response<
                super::super::super::super::super::super::longrunning::Operation,
            >,
        ...
        async fn check_upgrade(
            &self,
            request: tonic::Request<super::CheckUpgradeRequest>,
        ) -> std::result::Result<
            tonic::Response<
                super::super::super::super::super::super::longrunning::Operation,
            >,
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/google.cloud.orchestration.airflow.service.v1beta1.Environments/RestartWebServer" => {
                    #[allow(non_camel_case_types)]
                    struct RestartWebServerSvc<T: Environments>(pub Arc<T>);
                    impl<
                        T: Environments,
                    > tonic::server::UnaryService<super::RestartWebServerRequest>
                    for RestartWebServerSvc<T> {
                        type Response = super::super::super::super::super::super::longrunning::Operation;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Environments>::restart_web_server(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = RestartWebServerSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.orchestration.airflow.service.v1beta1.Environments/CheckUpgrade" => {
                    #[allow(non_camel_case_types)]
                    struct CheckUpgradeSvc<T: Environments>(pub Arc<T>);
                    impl<
                        T: Environments,
                    > tonic::server::UnaryService<super::CheckUpgradeRequest>
                    for CheckUpgradeSvc<T> {
                        type Response = super::super::super::super::super::super::longrunning::Operation;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Environments>::check_upgrade(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = CheckUpgradeSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.cloud.orchestration.airflow.service.v1beta1.Environments";
