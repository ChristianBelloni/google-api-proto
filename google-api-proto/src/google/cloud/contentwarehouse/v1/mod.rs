...
pub mod synonym_set_service_server {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with SynonymSetServiceServer.
    #[async_trait]
    pub trait SynonymSetService: std::marker::Send + std::marker::Sync + 'static {
        /// Creates a SynonymSet for a single context.
        /// Throws an ALREADY_EXISTS exception if a synonymset already exists
        /// for the context.
        async fn create_synonym_set(
            &self,
            request: tonic::Request<super::CreateSynonymSetRequest>,
        ) -> std::result::Result<tonic::Response<super::SynonymSet>, tonic::Status>;
        /// Gets a SynonymSet for a particular context.
        /// Throws a NOT_FOUND exception if the Synonymset
        /// does not exist
        async fn get_synonym_set(
            &self,
            request: tonic::Request<super::GetSynonymSetRequest>,
        ) -> std::result::Result<tonic::Response<super::SynonymSet>, tonic::Status>;
        /// Remove the existing SynonymSet for the context and replaces it
        /// with a new one.
        /// Throws a NOT_FOUND exception if the SynonymSet is not found.
        async fn update_synonym_set(
            &self,
            request: tonic::Request<super::UpdateSynonymSetRequest>,
        ) -> std::result::Result<tonic::Response<super::SynonymSet>, tonic::Status>;
        /// Deletes a SynonymSet for a given context.
        /// Throws a NOT_FOUND exception if the SynonymSet is not found.
        async fn delete_synonym_set(
            &self,
            request: tonic::Request<super::DeleteSynonymSetRequest>,
        ) -> std::result::Result<tonic::Response<()>, tonic::Status>;
        /// Returns all SynonymSets (for all contexts) for the specified location.
        async fn list_synonym_sets(
            &self,
            request: tonic::Request<super::ListSynonymSetsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListSynonymSetsResponse>,
            tonic::Status,
        >;
    ...
    /// A Service that manage/custom customer specified SynonymSets.
    #[derive(Debug)]
    pub struct SynonymSetServiceServer<T> {
        inner: Arc<T>,
    ...
    impl<T> SynonymSetServiceServer<T> {
        pub fn new(inner: T) -> Self {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for SynonymSetServiceServer<T>
    where
        T: SynonymSetService,
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.cloud.contentwarehouse.v1.SynonymSetService/CreateSynonymSet" => {
                    ...
                    struct CreateSynonymSetSvc<T: SynonymSetService>(pub Arc<T>);
                    impl<
                        T: SynonymSetService,
                    > tonic::server::UnaryService<super::CreateSynonymSetRequest>
                    for CreateSynonymSetSvc<T> {
                        type Response = super::SynonymSet;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as SynonymSetService>::create_synonym_set(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let fut = async move {
                        let method = CreateSynonymSetSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                ...
                "/google.cloud.contentwarehouse.v1.SynonymSetService/GetSynonymSet" => {
                    #[allow(non_camel_case_types)]
                    struct GetSynonymSetSvc<T: SynonymSetService>(pub Arc<T>);
                    impl<
                        T: SynonymSetService,
                    > tonic::server::UnaryService<super::GetSynonymSetRequest>
                    for GetSynonymSetSvc<T> {
                        type Response = super::SynonymSet;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SynonymSetService>::get_synonym_set(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetSynonymSetSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.contentwarehouse.v1.SynonymSetService/UpdateSynonymSet" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateSynonymSetSvc<T: SynonymSetService>(pub Arc<T>);
                    impl<
                        T: SynonymSetService,
                    > tonic::server::UnaryService<super::UpdateSynonymSetRequest>
                    for UpdateSynonymSetSvc<T> {
                        type Response = super::SynonymSet;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SynonymSetService>::update_synonym_set(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = UpdateSynonymSetSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.contentwarehouse.v1.SynonymSetService/DeleteSynonymSet" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteSynonymSetSvc<T: SynonymSetService>(pub Arc<T>);
                    impl<
                        T: SynonymSetService,
                    > tonic::server::UnaryService<super::DeleteSynonymSetRequest>
                    for DeleteSynonymSetSvc<T> {
                        type Response = ();
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SynonymSetService>::delete_synonym_set(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = DeleteSynonymSetSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.contentwarehouse.v1.SynonymSetService/ListSynonymSets" => {
                    #[allow(non_camel_case_types)]
                    struct ListSynonymSetsSvc<T: SynonymSetService>(pub Arc<T>);
                    impl<
                        T: SynonymSetService,
                    > tonic::server::UnaryService<super::ListSynonymSetsRequest>
                    for ListSynonymSetsSvc<T> {
                        type Response = super::ListSynonymSetsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SynonymSetService>::list_synonym_sets(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ListSynonymSetsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for SynonymSetServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "google.cloud.contentwarehouse.v1.SynonymSetService";
    impl<T> tonic::server::NamedService for SynonymSetServiceServer<T> {
...
/// Generated server implementations.
pub mod document_schema_service_server {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with DocumentSchemaServiceServer.
    #[async_trait]
    pub trait DocumentSchemaService: std::marker::Send + std::marker::Sync + 'static {
        /// Creates a document schema.
        async fn create_document_schema(
            &self,
            request: tonic::Request<super::CreateDocumentSchemaRequest>,
        ) -> std::result::Result<tonic::Response<super::DocumentSchema>, tonic::Status>;
        /// Updates a Document Schema. Returns INVALID_ARGUMENT if the name of the
        /// Document Schema is non-empty and does not equal the existing name.
        /// Supports only appending new properties, adding new ENUM possible values,
        ...
        async fn update_document_schema(
            &self,
            request: tonic::Request<super::UpdateDocumentSchemaRequest>,
        ) -> std::result::Result<tonic::Response<super::DocumentSchema>, tonic::Status>;
        /// Gets a document schema. Returns NOT_FOUND if the document schema does not
        /// exist.
        async fn get_document_schema(
            &self,
            request: tonic::Request<super::GetDocumentSchemaRequest>,
        ) -> std::result::Result<tonic::Response<super::DocumentSchema>, tonic::Status>;
        /// Deletes a document schema. Returns NOT_FOUND if the document schema does
        /// not exist. Returns BAD_REQUEST if the document schema has documents
        /// depending on it.
        async fn delete_document_schema(
            &self,
            request: tonic::Request<super::DeleteDocumentSchemaRequest>,
        ) -> std::result::Result<tonic::Response<()>, tonic::Status>;
        /// Lists document schemas.
        async fn list_document_schemas(
            &self,
            request: tonic::Request<super::ListDocumentSchemasRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListDocumentSchemasResponse>,
            tonic::Status,
        >;
    ...
    /// This service lets you manage document schema.
    #[derive(Debug)]
    pub struct DocumentSchemaServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> DocumentSchemaServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    for DocumentSchemaServiceServer<T>
    where
        T: DocumentSchemaService,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        type Response = http::Response<tonic::body::BoxBody>;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.cloud.contentwarehouse.v1.DocumentSchemaService/CreateDocumentSchema" => {
                    #[allow(non_camel_case_types)]
                    struct CreateDocumentSchemaSvc<T: DocumentSchemaService>(pub Arc<T>);
                    impl<
                        T: DocumentSchemaService,
                    > tonic::server::UnaryService<super::CreateDocumentSchemaRequest>
                    for CreateDocumentSchemaSvc<T> {
                        type Response = super::DocumentSchema;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DocumentSchemaService>::create_document_schema(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = CreateDocumentSchemaSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.contentwarehouse.v1.DocumentSchemaService/UpdateDocumentSchema" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateDocumentSchemaSvc<T: DocumentSchemaService>(pub Arc<T>);
                    impl<
                        T: DocumentSchemaService,
                    > tonic::server::UnaryService<super::UpdateDocumentSchemaRequest>
                    for UpdateDocumentSchemaSvc<T> {
                        type Response = super::DocumentSchema;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DocumentSchemaService>::update_document_schema(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = UpdateDocumentSchemaSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.contentwarehouse.v1.DocumentSchemaService/GetDocumentSchema" => {
                    #[allow(non_camel_case_types)]
                    struct GetDocumentSchemaSvc<T: DocumentSchemaService>(pub Arc<T>);
                    impl<
                        T: DocumentSchemaService,
                    > tonic::server::UnaryService<super::GetDocumentSchemaRequest>
                    for GetDocumentSchemaSvc<T> {
                        type Response = super::DocumentSchema;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DocumentSchemaService>::get_document_schema(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetDocumentSchemaSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.contentwarehouse.v1.DocumentSchemaService/DeleteDocumentSchema" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteDocumentSchemaSvc<T: DocumentSchemaService>(pub Arc<T>);
                    impl<
                        T: DocumentSchemaService,
                    > tonic::server::UnaryService<super::DeleteDocumentSchemaRequest>
                    for DeleteDocumentSchemaSvc<T> {
                        type Response = ();
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DocumentSchemaService>::delete_document_schema(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = DeleteDocumentSchemaSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.contentwarehouse.v1.DocumentSchemaService/ListDocumentSchemas" => {
                    #[allow(non_camel_case_types)]
                    struct ListDocumentSchemasSvc<T: DocumentSchemaService>(pub Arc<T>);
                    impl<
                        T: DocumentSchemaService,
                    > tonic::server::UnaryService<super::ListDocumentSchemasRequest>
                    for ListDocumentSchemasSvc<T> {
                        type Response = super::ListDocumentSchemasResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DocumentSchemaService>::list_document_schemas(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ListDocumentSchemasSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for DocumentSchemaServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.cloud.contentwarehouse.v1.DocumentSchemaService";
    impl<T> tonic::server::NamedService for DocumentSchemaServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
...
pub mod document_service_server {
    ...
    pub trait DocumentService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn lock_document(
            &self,
            request: tonic::Request<super::LockDocumentRequest>,
        ) -> std::result::Result<tonic::Response<super::Document>, tonic::Status>;
        /// Gets the access control policy for a resource. Returns NOT_FOUND error if
        /// the resource does not exist. Returns an empty policy if the resource exists
        /// but does not have a policy set.
        async fn fetch_acl(
            &self,
            request: tonic::Request<super::FetchAclRequest>,
        ) -> std::result::Result<
            tonic::Response<super::FetchAclResponse>,
            tonic::Status,
        >;
        ...
        async fn set_acl(
            &self,
            request: tonic::Request<super::SetAclRequest>,
        ) -> std::result::Result<tonic::Response<super::SetAclResponse>, tonic::Status>;
    }
    /// This service lets you manage document.
    #[derive(Debug)]
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/google.cloud.contentwarehouse.v1.DocumentService/LockDocument" => {
                    #[allow(non_camel_case_types)]
                    struct LockDocumentSvc<T: DocumentService>(pub Arc<T>);
                    impl<
                        T: DocumentService,
                    > tonic::server::UnaryService<super::LockDocumentRequest>
                    for LockDocumentSvc<T> {
                        type Response = super::Document;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DocumentService>::lock_document(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = LockDocumentSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.contentwarehouse.v1.DocumentService/FetchAcl" => {
                    #[allow(non_camel_case_types)]
                    struct FetchAclSvc<T: DocumentService>(pub Arc<T>);
                    impl<
                        T: DocumentService,
                    > tonic::server::UnaryService<super::FetchAclRequest>
                    for FetchAclSvc<T> {
                        type Response = super::FetchAclResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DocumentService>::fetch_acl(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.contentwarehouse.v1.DocumentService/SetAcl" => {
                    #[allow(non_camel_case_types)]
                    struct SetAclSvc<T: DocumentService>(pub Arc<T>);
                    impl<
                        T: DocumentService,
                    > tonic::server::UnaryService<super::SetAclRequest>
                    for SetAclSvc<T> {
                        type Response = super::SetAclResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DocumentService>::set_acl(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.cloud.contentwarehouse.v1.DocumentService";
...
pub mod pipeline_service_server {
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.cloud.contentwarehouse.v1.PipelineService/RunPipeline" => {
                    #[allow(non_camel_case_types)]
                    struct RunPipelineSvc<T: PipelineService>(pub Arc<T>);
                    impl<
                        T: PipelineService,
                    ...
                    for RunPipelineSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PipelineService>::run_pipeline(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.cloud.contentwarehouse.v1.PipelineService";
...
/// Generated server implementations.
pub mod document_link_service_server {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with DocumentLinkServiceServer.
    #[async_trait]
    pub trait DocumentLinkService: std::marker::Send + std::marker::Sync + 'static {
        /// Return all target document-links from the document.
        async fn list_linked_targets(
            &self,
            request: tonic::Request<super::ListLinkedTargetsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListLinkedTargetsResponse>,
            tonic::Status,
        >;
        ...
        async fn list_linked_sources(
            &self,
            request: tonic::Request<super::ListLinkedSourcesRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListLinkedSourcesResponse>,
            tonic::Status,
        >;
        ...
        async fn create_document_link(
            &self,
            request: tonic::Request<super::CreateDocumentLinkRequest>,
        ) -> std::result::Result<tonic::Response<super::DocumentLink>, tonic::Status>;
        /// Remove the link between the source and target documents.
        async fn delete_document_link(
            &self,
            request: tonic::Request<super::DeleteDocumentLinkRequest>,
        ) -> std::result::Result<tonic::Response<()>, tonic::Status>;
    }
    /// This service lets you manage document-links.
    /// Document-Links are treated as sub-resources under source documents.
    #[derive(Debug)]
    pub struct DocumentLinkServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> DocumentLinkServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for DocumentLinkServiceServer<T>
    where
        T: DocumentLinkService,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        type Response = http::Response<tonic::body::BoxBody>;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.cloud.contentwarehouse.v1.DocumentLinkService/ListLinkedTargets" => {
                    #[allow(non_camel_case_types)]
                    struct ListLinkedTargetsSvc<T: DocumentLinkService>(pub Arc<T>);
                    impl<
                        T: DocumentLinkService,
                    > tonic::server::UnaryService<super::ListLinkedTargetsRequest>
                    for ListLinkedTargetsSvc<T> {
                        type Response = super::ListLinkedTargetsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DocumentLinkService>::list_linked_targets(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ListLinkedTargetsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.contentwarehouse.v1.DocumentLinkService/ListLinkedSources" => {
                    #[allow(non_camel_case_types)]
                    struct ListLinkedSourcesSvc<T: DocumentLinkService>(pub Arc<T>);
                    impl<
                        T: DocumentLinkService,
                    > tonic::server::UnaryService<super::ListLinkedSourcesRequest>
                    for ListLinkedSourcesSvc<T> {
                        type Response = super::ListLinkedSourcesResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DocumentLinkService>::list_linked_sources(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ListLinkedSourcesSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.contentwarehouse.v1.DocumentLinkService/CreateDocumentLink" => {
                    #[allow(non_camel_case_types)]
                    struct CreateDocumentLinkSvc<T: DocumentLinkService>(pub Arc<T>);
                    impl<
                        T: DocumentLinkService,
                    > tonic::server::UnaryService<super::CreateDocumentLinkRequest>
                    for CreateDocumentLinkSvc<T> {
                        type Response = super::DocumentLink;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DocumentLinkService>::create_document_link(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = CreateDocumentLinkSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.contentwarehouse.v1.DocumentLinkService/DeleteDocumentLink" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteDocumentLinkSvc<T: DocumentLinkService>(pub Arc<T>);
                    impl<
                        T: DocumentLinkService,
                    > tonic::server::UnaryService<super::DeleteDocumentLinkRequest>
                    for DeleteDocumentLinkSvc<T> {
                        type Response = ();
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DocumentLinkService>::delete_document_link(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = DeleteDocumentLinkSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for DocumentLinkServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.cloud.contentwarehouse.v1.DocumentLinkService";
    impl<T> tonic::server::NamedService for DocumentLinkServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
/// Generated client implementations.
...
/// Generated server implementations.
pub mod rule_set_service_server {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with RuleSetServiceServer.
    #[async_trait]
    pub trait RuleSetService: std::marker::Send + std::marker::Sync + 'static {
        /// Creates a ruleset.
    ...
    /// Service to manage customer specific RuleSets.
    #[derive(Debug)]
    pub struct RuleSetServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for RuleSetServiceServer<T>
    where
        T: RuleSetService,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.cloud.contentwarehouse.v1.RuleSetService/CreateRuleSet" => {
                    #[allow(non_camel_case_types)]
                    struct CreateRuleSetSvc<T: RuleSetService>(pub Arc<T>);
                    impl<
                        T: RuleSetService,
                    > tonic::server::UnaryService<super::CreateRuleSetRequest>
                    for CreateRuleSetSvc<T> {
                        type Response = super::RuleSet;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RuleSetService>::create_rule_set(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.cloud.contentwarehouse.v1.RuleSetService/GetRuleSet" => {
                    #[allow(non_camel_case_types)]
                    struct GetRuleSetSvc<T: RuleSetService>(pub Arc<T>);
                    impl<
                        T: RuleSetService,
                    ...
                    for GetRuleSetSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RuleSetService>::get_rule_set(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.contentwarehouse.v1.RuleSetService/UpdateRuleSet" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateRuleSetSvc<T: RuleSetService>(pub Arc<T>);
                    impl<
                        T: RuleSetService,
                    ...
                    for UpdateRuleSetSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RuleSetService>::update_rule_set(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.cloud.contentwarehouse.v1.RuleSetService/DeleteRuleSet" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteRuleSetSvc<T: RuleSetService>(pub Arc<T>);
                    impl<
                        T: RuleSetService,
                    ...
                    for DeleteRuleSetSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RuleSetService>::delete_rule_set(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.cloud.contentwarehouse.v1.RuleSetService/ListRuleSets" => {
                    #[allow(non_camel_case_types)]
                    struct ListRuleSetsSvc<T: RuleSetService>(pub Arc<T>);
                    impl<
                        T: RuleSetService,
                    ...
                    for ListRuleSetsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RuleSetService>::list_rule_sets(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T> Clone for RuleSetServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.cloud.contentwarehouse.v1.RuleSetService";
    impl<T> tonic::server::NamedService for RuleSetServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
