...
pub mod recommender_server {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with RecommenderServer.
    #[async_trait]
    pub trait Recommender: std::marker::Send + std::marker::Sync + 'static {
        /// Lists insights for the specified Cloud Resource. Requires the
        /// recommender.*.list IAM permission for the specified insight type.
        ...
        async fn get_recommender_config(
            &self,
            request: tonic::Request<super::GetRecommenderConfigRequest>,
        ) -> std::result::Result<
            tonic::Response<super::RecommenderConfig>,
            tonic::Status,
        >;
        ...
        async fn update_recommender_config(
            &self,
            request: tonic::Request<super::UpdateRecommenderConfigRequest>,
        ) -> std::result::Result<
            tonic::Response<super::RecommenderConfig>,
            tonic::Status,
        >;
        ...
        async fn get_insight_type_config(
            &self,
            request: tonic::Request<super::GetInsightTypeConfigRequest>,
        ) -> std::result::Result<
            tonic::Response<super::InsightTypeConfig>,
            tonic::Status,
        >;
        ...
        async fn update_insight_type_config(
            &self,
            request: tonic::Request<super::UpdateInsightTypeConfigRequest>,
        ) -> std::result::Result<
            tonic::Response<super::InsightTypeConfig>,
            tonic::Status,
        >;
        /// Lists all available Recommenders.
        /// No IAM permissions are required.
        async fn list_recommenders(
            &self,
            request: tonic::Request<super::ListRecommendersRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListRecommendersResponse>,
            tonic::Status,
        >;
        /// Lists available InsightTypes.
        /// No IAM permissions are required.
        async fn list_insight_types(
            &self,
            request: tonic::Request<super::ListInsightTypesRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListInsightTypesResponse>,
            tonic::Status,
        >;
    ...
    /// based on analysis of user resources, configuration and monitoring metrics.
    #[derive(Debug)]
    pub struct RecommenderServer<T> {
        inner: Arc<T>,
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for RecommenderServer<T>
    where
        T: Recommender,
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.cloud.recommender.v1beta1.Recommender/ListInsights" => {
                    ...
                    impl<
                        T: Recommender,
                    > tonic::server::UnaryService<super::ListInsightsRequest>
                    for ListInsightsSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as Recommender>::list_insights(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.recommender.v1beta1.Recommender/GetInsight" => {
                    ...
                    impl<
                        T: Recommender,
                    > tonic::server::UnaryService<super::GetInsightRequest>
                    for GetInsightSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Recommender>::get_insight(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.recommender.v1beta1.Recommender/MarkInsightAccepted" => {
                    ...
                    for MarkInsightAcceptedSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Recommender>::mark_insight_accepted(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.cloud.recommender.v1beta1.Recommender/ListRecommendations" => {
                    ...
                    for ListRecommendationsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Recommender>::list_recommendations(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.cloud.recommender.v1beta1.Recommender/GetRecommendation" => {
                    ...
                    for GetRecommendationSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Recommender>::get_recommendation(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.cloud.recommender.v1beta1.Recommender/MarkRecommendationClaimed" => {
                    ...
                    > tonic::server::UnaryService<
                        super::MarkRecommendationClaimedRequest,
                    > for MarkRecommendationClaimedSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Recommender>::mark_recommendation_claimed(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/google.cloud.recommender.v1beta1.Recommender/MarkRecommendationSucceeded" => {
                    ...
                    impl<
                        T: Recommender,
                    > tonic::server::UnaryService<
                        super::MarkRecommendationSucceededRequest,
                    > for MarkRecommendationSucceededSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Recommender>::mark_recommendation_succeeded(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/google.cloud.recommender.v1beta1.Recommender/MarkRecommendationFailed" => {
                    ...
                    for MarkRecommendationFailedSvc<T> {
                        ...
                        fn call(
                            &mut self,
                            request: tonic::Request<
                                super::MarkRecommendationFailedRequest,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Recommender>::mark_recommendation_failed(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/google.cloud.recommender.v1beta1.Recommender/GetRecommenderConfig" => {
                    #[allow(non_camel_case_types)]
                    struct GetRecommenderConfigSvc<T: Recommender>(pub Arc<T>);
                    impl<
                        T: Recommender,
                    > tonic::server::UnaryService<super::GetRecommenderConfigRequest>
                    for GetRecommenderConfigSvc<T> {
                        type Response = super::RecommenderConfig;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Recommender>::get_recommender_config(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetRecommenderConfigSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.recommender.v1beta1.Recommender/UpdateRecommenderConfig" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateRecommenderConfigSvc<T: Recommender>(pub Arc<T>);
                    impl<
                        T: Recommender,
                    > tonic::server::UnaryService<super::UpdateRecommenderConfigRequest>
                    for UpdateRecommenderConfigSvc<T> {
                        type Response = super::RecommenderConfig;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            &mut self,
                            request: tonic::Request<
                                super::UpdateRecommenderConfigRequest,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Recommender>::update_recommender_config(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = UpdateRecommenderConfigSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.recommender.v1beta1.Recommender/GetInsightTypeConfig" => {
                    #[allow(non_camel_case_types)]
                    struct GetInsightTypeConfigSvc<T: Recommender>(pub Arc<T>);
                    impl<
                        T: Recommender,
                    > tonic::server::UnaryService<super::GetInsightTypeConfigRequest>
                    for GetInsightTypeConfigSvc<T> {
                        type Response = super::InsightTypeConfig;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Recommender>::get_insight_type_config(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetInsightTypeConfigSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.recommender.v1beta1.Recommender/UpdateInsightTypeConfig" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateInsightTypeConfigSvc<T: Recommender>(pub Arc<T>);
                    impl<
                        T: Recommender,
                    > tonic::server::UnaryService<super::UpdateInsightTypeConfigRequest>
                    for UpdateInsightTypeConfigSvc<T> {
                        type Response = super::InsightTypeConfig;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            &mut self,
                            request: tonic::Request<
                                super::UpdateInsightTypeConfigRequest,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Recommender>::update_insight_type_config(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = UpdateInsightTypeConfigSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.recommender.v1beta1.Recommender/ListRecommenders" => {
                    #[allow(non_camel_case_types)]
                    struct ListRecommendersSvc<T: Recommender>(pub Arc<T>);
                    impl<
                        T: Recommender,
                    > tonic::server::UnaryService<super::ListRecommendersRequest>
                    for ListRecommendersSvc<T> {
                        type Response = super::ListRecommendersResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Recommender>::list_recommenders(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ListRecommendersSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.recommender.v1beta1.Recommender/ListInsightTypes" => {
                    #[allow(non_camel_case_types)]
                    struct ListInsightTypesSvc<T: Recommender>(pub Arc<T>);
                    impl<
                        T: Recommender,
                    > tonic::server::UnaryService<super::ListInsightTypesRequest>
                    for ListInsightTypesSvc<T> {
                        type Response = super::ListInsightTypesResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Recommender>::list_insight_types(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ListInsightTypesSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for RecommenderServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "google.cloud.recommender.v1beta1.Recommender";
    impl<T> tonic::server::NamedService for RecommenderServer<T> {
