...
pub mod recommender_server {
    ...
    pub trait Recommender: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn mark_recommendation_dismissed(
            &self,
            request: tonic::Request<super::MarkRecommendationDismissedRequest>,
        ) -> std::result::Result<tonic::Response<super::Recommendation>, tonic::Status>;
        /// Marks the Recommendation State as Claimed. Users can use this method to
        /// indicate to the Recommender API that they are starting to apply the
        /// recommendation themselves. This stops the recommendation content from being
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/google.cloud.recommender.v1.Recommender/MarkRecommendationDismissed" => {
                    #[allow(non_camel_case_types)]
                    struct MarkRecommendationDismissedSvc<T: Recommender>(pub Arc<T>);
                    impl<
                        T: Recommender,
                    > tonic::server::UnaryService<
                        super::MarkRecommendationDismissedRequest,
                    > for MarkRecommendationDismissedSvc<T> {
                        type Response = super::Recommendation;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Recommender>::mark_recommendation_dismissed(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = MarkRecommendationDismissedSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    pub const SERVICE_NAME: &str = "google.cloud.recommender.v1.Recommender";
