...
pub mod prediction_service_server {
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/google.cloud.automl.v1beta1.PredictionService/BatchPredict" => {
                    #[allow(non_camel_case_types)]
                    struct BatchPredictSvc<T: PredictionService>(pub Arc<T>);
                    impl<
                        T: PredictionService,
                    > tonic::server::UnaryService<super::BatchPredictRequest>
                    for BatchPredictSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PredictionService>::batch_predict(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
    ...
    pub const SERVICE_NAME: &str = "google.cloud.automl.v1beta1.PredictionService";
...
/// Generated server implementations.
pub mod auto_ml_server {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with AutoMlServer.
    #[async_trait]
    pub trait AutoMl: std::marker::Send + std::marker::Sync + 'static {
        /// Creates a dataset.
        ...
        /// Gets a table spec.
        async fn get_table_spec(
            &self,
            request: tonic::Request<super::GetTableSpecRequest>,
        ) -> std::result::Result<tonic::Response<super::TableSpec>, tonic::Status>;
        /// Lists table specs in a dataset.
        async fn list_table_specs(
            &self,
        ...
        /// Returns an empty response in the
        /// [response][google.longrunning.Operation.response] field when it completes.
        async fn export_evaluated_examples(
            &self,
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for AutoMlServer<T>
    where
        T: AutoMl,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.cloud.automl.v1beta1.AutoMl/CreateDataset" => {
                    #[allow(non_camel_case_types)]
                    struct CreateDatasetSvc<T: AutoMl>(pub Arc<T>);
                    impl<
                        T: AutoMl,
                    ...
                    for CreateDatasetSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AutoMl>::create_dataset(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.automl.v1beta1.AutoMl/GetDataset" => {
                    #[allow(non_camel_case_types)]
                    struct GetDatasetSvc<T: AutoMl>(pub Arc<T>);
                    impl<T: AutoMl> tonic::server::UnaryService<super::GetDatasetRequest>
                    for GetDatasetSvc<T> {
                        type Response = super::Dataset;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AutoMl>::get_dataset(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.automl.v1beta1.AutoMl/ListDatasets" => {
                    #[allow(non_camel_case_types)]
                    struct ListDatasetsSvc<T: AutoMl>(pub Arc<T>);
                    impl<
                        T: AutoMl,
                    ...
                    for ListDatasetsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AutoMl>::list_datasets(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.automl.v1beta1.AutoMl/UpdateDataset" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateDatasetSvc<T: AutoMl>(pub Arc<T>);
                    impl<
                        T: AutoMl,
                    ...
                    for UpdateDatasetSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AutoMl>::update_dataset(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.automl.v1beta1.AutoMl/DeleteDataset" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteDatasetSvc<T: AutoMl>(pub Arc<T>);
                    impl<
                        T: AutoMl,
                    ...
                    for DeleteDatasetSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AutoMl>::delete_dataset(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.automl.v1beta1.AutoMl/ImportData" => {
                    #[allow(non_camel_case_types)]
                    struct ImportDataSvc<T: AutoMl>(pub Arc<T>);
                    impl<T: AutoMl> tonic::server::UnaryService<super::ImportDataRequest>
                    for ImportDataSvc<T> {
                        type Response = super::super::super::super::longrunning::Operation;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AutoMl>::import_data(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.automl.v1beta1.AutoMl/ExportData" => {
                    #[allow(non_camel_case_types)]
                    struct ExportDataSvc<T: AutoMl>(pub Arc<T>);
                    impl<T: AutoMl> tonic::server::UnaryService<super::ExportDataRequest>
                    for ExportDataSvc<T> {
                        type Response = super::super::super::super::longrunning::Operation;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AutoMl>::export_data(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.automl.v1beta1.AutoMl/GetAnnotationSpec" => {
                    #[allow(non_camel_case_types)]
                    struct GetAnnotationSpecSvc<T: AutoMl>(pub Arc<T>);
                    impl<
                        T: AutoMl,
                    > tonic::server::UnaryService<super::GetAnnotationSpecRequest>
                    for GetAnnotationSpecSvc<T> {
                        type Response = super::AnnotationSpec;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AutoMl>::get_annotation_spec(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.automl.v1beta1.AutoMl/GetTableSpec" => {
                    #[allow(non_camel_case_types)]
                    struct GetTableSpecSvc<T: AutoMl>(pub Arc<T>);
                    impl<
                        T: AutoMl,
                    > tonic::server::UnaryService<super::GetTableSpecRequest>
                    for GetTableSpecSvc<T> {
                        type Response = super::TableSpec;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AutoMl>::get_table_spec(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetTableSpecSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.automl.v1beta1.AutoMl/ListTableSpecs" => {
                    #[allow(non_camel_case_types)]
                    struct ListTableSpecsSvc<T: AutoMl>(pub Arc<T>);
                    impl<
                        T: AutoMl,
                    > tonic::server::UnaryService<super::ListTableSpecsRequest>
                    for ListTableSpecsSvc<T> {
                        type Response = super::ListTableSpecsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AutoMl>::list_table_specs(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ListTableSpecsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.automl.v1beta1.AutoMl/UpdateTableSpec" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateTableSpecSvc<T: AutoMl>(pub Arc<T>);
                    impl<
                        T: AutoMl,
                    > tonic::server::UnaryService<super::UpdateTableSpecRequest>
                    for UpdateTableSpecSvc<T> {
                        type Response = super::TableSpec;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AutoMl>::update_table_spec(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = UpdateTableSpecSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.automl.v1beta1.AutoMl/GetColumnSpec" => {
                    #[allow(non_camel_case_types)]
                    struct GetColumnSpecSvc<T: AutoMl>(pub Arc<T>);
                    impl<
                        T: AutoMl,
                    > tonic::server::UnaryService<super::GetColumnSpecRequest>
                    for GetColumnSpecSvc<T> {
                        type Response = super::ColumnSpec;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AutoMl>::get_column_spec(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetColumnSpecSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.automl.v1beta1.AutoMl/ListColumnSpecs" => {
                    #[allow(non_camel_case_types)]
                    struct ListColumnSpecsSvc<T: AutoMl>(pub Arc<T>);
                    impl<
                        T: AutoMl,
                    > tonic::server::UnaryService<super::ListColumnSpecsRequest>
                    for ListColumnSpecsSvc<T> {
                        type Response = super::ListColumnSpecsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AutoMl>::list_column_specs(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ListColumnSpecsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.automl.v1beta1.AutoMl/UpdateColumnSpec" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateColumnSpecSvc<T: AutoMl>(pub Arc<T>);
                    impl<
                        T: AutoMl,
                    > tonic::server::UnaryService<super::UpdateColumnSpecRequest>
                    for UpdateColumnSpecSvc<T> {
                        type Response = super::ColumnSpec;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AutoMl>::update_column_spec(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = UpdateColumnSpecSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.automl.v1beta1.AutoMl/CreateModel" => {
                    #[allow(non_camel_case_types)]
                    struct CreateModelSvc<T: AutoMl>(pub Arc<T>);
                    impl<
                        T: AutoMl,
                    ...
                    for CreateModelSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AutoMl>::create_model(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.automl.v1beta1.AutoMl/GetModel" => {
                    #[allow(non_camel_case_types)]
                    struct GetModelSvc<T: AutoMl>(pub Arc<T>);
                    impl<T: AutoMl> tonic::server::UnaryService<super::GetModelRequest>
                    for GetModelSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AutoMl>::get_model(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.automl.v1beta1.AutoMl/ListModels" => {
                    #[allow(non_camel_case_types)]
                    struct ListModelsSvc<T: AutoMl>(pub Arc<T>);
                    impl<T: AutoMl> tonic::server::UnaryService<super::ListModelsRequest>
                    for ListModelsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AutoMl>::list_models(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.automl.v1beta1.AutoMl/DeleteModel" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteModelSvc<T: AutoMl>(pub Arc<T>);
                    impl<
                        T: AutoMl,
                    ...
                    for DeleteModelSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AutoMl>::delete_model(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.automl.v1beta1.AutoMl/DeployModel" => {
                    #[allow(non_camel_case_types)]
                    struct DeployModelSvc<T: AutoMl>(pub Arc<T>);
                    impl<
                        T: AutoMl,
                    > tonic::server::UnaryService<super::DeployModelRequest>
                    for DeployModelSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AutoMl>::deploy_model(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.automl.v1beta1.AutoMl/UndeployModel" => {
                    #[allow(non_camel_case_types)]
                    struct UndeployModelSvc<T: AutoMl>(pub Arc<T>);
                    impl<
                        T: AutoMl,
                    > tonic::server::UnaryService<super::UndeployModelRequest>
                    for UndeployModelSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AutoMl>::undeploy_model(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.automl.v1beta1.AutoMl/ExportModel" => {
                    #[allow(non_camel_case_types)]
                    struct ExportModelSvc<T: AutoMl>(pub Arc<T>);
                    impl<
                        T: AutoMl,
                    > tonic::server::UnaryService<super::ExportModelRequest>
                    for ExportModelSvc<T> {
                        type Response = super::super::super::super::longrunning::Operation;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AutoMl>::export_model(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.automl.v1beta1.AutoMl/ExportEvaluatedExamples" => {
                    #[allow(non_camel_case_types)]
                    struct ExportEvaluatedExamplesSvc<T: AutoMl>(pub Arc<T>);
                    impl<
                        T: AutoMl,
                    > tonic::server::UnaryService<super::ExportEvaluatedExamplesRequest>
                    for ExportEvaluatedExamplesSvc<T> {
                        type Response = super::super::super::super::longrunning::Operation;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            request: tonic::Request<
                                super::ExportEvaluatedExamplesRequest,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AutoMl>::export_evaluated_examples(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ExportEvaluatedExamplesSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.automl.v1beta1.AutoMl/GetModelEvaluation" => {
                    #[allow(non_camel_case_types)]
                    struct GetModelEvaluationSvc<T: AutoMl>(pub Arc<T>);
                    impl<
                        T: AutoMl,
                    > tonic::server::UnaryService<super::GetModelEvaluationRequest>
                    for GetModelEvaluationSvc<T> {
                        type Response = super::ModelEvaluation;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AutoMl>::get_model_evaluation(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.automl.v1beta1.AutoMl/ListModelEvaluations" => {
                    #[allow(non_camel_case_types)]
                    struct ListModelEvaluationsSvc<T: AutoMl>(pub Arc<T>);
                    impl<
                        T: AutoMl,
                    > tonic::server::UnaryService<super::ListModelEvaluationsRequest>
                    for ListModelEvaluationsSvc<T> {
                        type Response = super::ListModelEvaluationsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AutoMl>::list_model_evaluations(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T> Clone for AutoMlServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.cloud.automl.v1beta1.AutoMl";
    impl<T> tonic::server::NamedService for AutoMlServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
