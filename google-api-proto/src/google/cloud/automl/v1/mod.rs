...
pub mod prediction_service_server {
    ...
    pub const SERVICE_NAME: &str = "google.cloud.automl.v1.PredictionService";
...
pub mod auto_ml_server {
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/google.cloud.automl.v1.AutoMl/UpdateModel" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateModelSvc<T: AutoMl>(pub Arc<T>);
                    impl<
                        T: AutoMl,
                    ...
                    for UpdateModelSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AutoMl>::update_model(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.cloud.automl.v1.AutoMl";
