...
pub struct ExecutionInfo {
    ...
    pub request_params: ::prost::alloc::collections::BTreeMap<
        ::prost::alloc::string::String,
        EventParameter,
    >,
    /// Execution parameters come out as part of the response.
    #[prost(btree_map = "string, message", tag = "7")]
    pub response_params: ::prost::alloc::collections::BTreeMap<
        ::prost::alloc::string::String,
        EventParameter,
    >,
...
pub struct IntegrationExecutionSnapshot {
    ...
    #[prost(btree_map = "string, message", tag = "6")]
    pub execution_params: ::prost::alloc::collections::BTreeMap<
        ::prost::alloc::string::String,
        EventParameter,
    >,
}
