...
pub mod security_center_settings_service_server {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with SecurityCenterSettingsServiceServer.
    #[async_trait]
    pub trait SecurityCenterSettingsService: std::marker::Send + std::marker::Sync + 'static {
        /// Retrieves the organizations service account, if it exists, otherwise it
        /// creates the organization service account. This API is idempotent and
        /// will only create a service account once. On subsequent calls it will
        /// return the previously created service account.  SHA, SCC and CTD Infra
        ...
        async fn reset_settings(
            &self,
            request: tonic::Request<super::ResetSettingsRequest>,
        ) -> std::result::Result<tonic::Response<()>, tonic::Status>;
        /// Gets a list of settings.
        async fn batch_get_settings(
            &self,
            request: tonic::Request<super::BatchGetSettingsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::BatchGetSettingsResponse>,
            tonic::Status,
        >;
        ...
        ///  customer
        ///    has not configured.
        async fn calculate_effective_settings(
            &self,
            request: tonic::Request<super::CalculateEffectiveSettingsRequest>,
        ) -> std::result::Result<tonic::Response<super::Settings>, tonic::Status>;
        /// Gets a list of effective settings.
        async fn batch_calculate_effective_settings(
            &self,
            request: tonic::Request<super::BatchCalculateEffectiveSettingsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::BatchCalculateEffectiveSettingsResponse>,
            tonic::Status,
        >;
        ...
        async fn get_component_settings(
            &self,
            request: tonic::Request<super::GetComponentSettingsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ComponentSettings>,
            tonic::Status,
        >;
        /// Updates the Component Settings.
        async fn update_component_settings(
            &self,
            request: tonic::Request<super::UpdateComponentSettingsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ComponentSettings>,
            tonic::Status,
        >;
        ...
        /// project will remove the override that was set and result in the
        /// organization-level settings being used.
        async fn reset_component_settings(
            &self,
            request: tonic::Request<super::ResetComponentSettingsRequest>,
        ) -> std::result::Result<tonic::Response<()>, tonic::Status>;
        /// Gets the Effective Component Settings.
        async fn calculate_effective_component_settings(
            &self,
            request: tonic::Request<super::CalculateEffectiveComponentSettingsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ComponentSettings>,
            tonic::Status,
        >;
        ...
        async fn list_detectors(
            &self,
            request: tonic::Request<super::ListDetectorsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListDetectorsResponse>,
            tonic::Status,
        >;
        ...
        async fn list_components(
            &self,
            request: tonic::Request<super::ListComponentsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListComponentsResponse>,
            tonic::Status,
        >;
    ...
    /// folders, projects, and clusters.
    #[derive(Debug)]
    pub struct SecurityCenterSettingsServiceServer<T> {
        inner: Arc<T>,
    ...
    impl<T> SecurityCenterSettingsServiceServer<T> {
        pub fn new(inner: T) -> Self {
    ...
    for SecurityCenterSettingsServiceServer<T>
    where
        T: SecurityCenterSettingsService,
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.cloud.securitycenter.settings.v1beta1.SecurityCenterSettingsService/GetServiceAccount" => {
                    ...
                    struct GetServiceAccountSvc<T: SecurityCenterSettingsService>(
                        pub Arc<T>,
                    );
                    impl<
                        T: SecurityCenterSettingsService,
                    ...
                    for GetServiceAccountSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as SecurityCenterSettingsService>::get_service_account(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/google.cloud.securitycenter.settings.v1beta1.SecurityCenterSettingsService/GetSettings" => {
                    #[allow(non_camel_case_types)]
                    struct GetSettingsSvc<T: SecurityCenterSettingsService>(pub Arc<T>);
                    impl<
                        T: SecurityCenterSettingsService,
                    ...
                    for GetSettingsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SecurityCenterSettingsService>::get_settings(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/google.cloud.securitycenter.settings.v1beta1.SecurityCenterSettingsService/UpdateSettings" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateSettingsSvc<T: SecurityCenterSettingsService>(
                        pub Arc<T>,
                    );
                    impl<
                        T: SecurityCenterSettingsService,
                    ...
                    for UpdateSettingsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SecurityCenterSettingsService>::update_settings(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/google.cloud.securitycenter.settings.v1beta1.SecurityCenterSettingsService/ResetSettings" => {
                    #[allow(non_camel_case_types)]
                    struct ResetSettingsSvc<T: SecurityCenterSettingsService>(
                        pub Arc<T>,
                    );
                    impl<
                        T: SecurityCenterSettingsService,
                    > tonic::server::UnaryService<super::ResetSettingsRequest>
                    for ResetSettingsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SecurityCenterSettingsService>::reset_settings(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/google.cloud.securitycenter.settings.v1beta1.SecurityCenterSettingsService/BatchGetSettings" => {
                    #[allow(non_camel_case_types)]
                    struct BatchGetSettingsSvc<T: SecurityCenterSettingsService>(
                        pub Arc<T>,
                    );
                    impl<
                        T: SecurityCenterSettingsService,
                    > tonic::server::UnaryService<super::BatchGetSettingsRequest>
                    for BatchGetSettingsSvc<T> {
                        type Response = super::BatchGetSettingsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SecurityCenterSettingsService>::batch_get_settings(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = BatchGetSettingsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.securitycenter.settings.v1beta1.SecurityCenterSettingsService/CalculateEffectiveSettings" => {
                    #[allow(non_camel_case_types)]
                    struct CalculateEffectiveSettingsSvc<
                        T: SecurityCenterSettingsService,
                    >(
                        pub Arc<T>,
                    );
                    ...
                    > tonic::server::UnaryService<
                        super::CalculateEffectiveSettingsRequest,
                    > for CalculateEffectiveSettingsSvc<T> {
                        type Response = super::Settings;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SecurityCenterSettingsService>::calculate_effective_settings(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = CalculateEffectiveSettingsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.securitycenter.settings.v1beta1.SecurityCenterSettingsService/BatchCalculateEffectiveSettings" => {
                    #[allow(non_camel_case_types)]
                    struct BatchCalculateEffectiveSettingsSvc<
                        T: SecurityCenterSettingsService,
                    >(
                        pub Arc<T>,
                    );
                    ...
                    > tonic::server::UnaryService<
                        super::BatchCalculateEffectiveSettingsRequest,
                    > for BatchCalculateEffectiveSettingsSvc<T> {
                        type Response = super::BatchCalculateEffectiveSettingsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SecurityCenterSettingsService>::batch_calculate_effective_settings(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = BatchCalculateEffectiveSettingsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.securitycenter.settings.v1beta1.SecurityCenterSettingsService/GetComponentSettings" => {
                    #[allow(non_camel_case_types)]
                    struct GetComponentSettingsSvc<T: SecurityCenterSettingsService>(
                        pub Arc<T>,
                    );
                    impl<
                        T: SecurityCenterSettingsService,
                    > tonic::server::UnaryService<super::GetComponentSettingsRequest>
                    for GetComponentSettingsSvc<T> {
                        type Response = super::ComponentSettings;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SecurityCenterSettingsService>::get_component_settings(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetComponentSettingsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.securitycenter.settings.v1beta1.SecurityCenterSettingsService/UpdateComponentSettings" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateComponentSettingsSvc<T: SecurityCenterSettingsService>(
                        pub Arc<T>,
                    );
                    impl<
                        T: SecurityCenterSettingsService,
                    > tonic::server::UnaryService<super::UpdateComponentSettingsRequest>
                    for UpdateComponentSettingsSvc<T> {
                        type Response = super::ComponentSettings;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            &mut self,
                            request: tonic::Request<
                                super::UpdateComponentSettingsRequest,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SecurityCenterSettingsService>::update_component_settings(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = UpdateComponentSettingsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.securitycenter.settings.v1beta1.SecurityCenterSettingsService/ResetComponentSettings" => {
                    #[allow(non_camel_case_types)]
                    struct ResetComponentSettingsSvc<T: SecurityCenterSettingsService>(
                        pub Arc<T>,
                    );
                    impl<
                        T: SecurityCenterSettingsService,
                    > tonic::server::UnaryService<super::ResetComponentSettingsRequest>
                    for ResetComponentSettingsSvc<T> {
                        type Response = ();
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SecurityCenterSettingsService>::reset_component_settings(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ResetComponentSettingsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.securitycenter.settings.v1beta1.SecurityCenterSettingsService/CalculateEffectiveComponentSettings" => {
                    #[allow(non_camel_case_types)]
                    struct CalculateEffectiveComponentSettingsSvc<
                        T: SecurityCenterSettingsService,
                    >(
                        pub Arc<T>,
                    );
                    ...
                    > tonic::server::UnaryService<
                        super::CalculateEffectiveComponentSettingsRequest,
                    > for CalculateEffectiveComponentSettingsSvc<T> {
                        type Response = super::ComponentSettings;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SecurityCenterSettingsService>::calculate_effective_component_settings(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = CalculateEffectiveComponentSettingsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.securitycenter.settings.v1beta1.SecurityCenterSettingsService/ListDetectors" => {
                    #[allow(non_camel_case_types)]
                    struct ListDetectorsSvc<T: SecurityCenterSettingsService>(
                        pub Arc<T>,
                    );
                    impl<
                        T: SecurityCenterSettingsService,
                    > tonic::server::UnaryService<super::ListDetectorsRequest>
                    for ListDetectorsSvc<T> {
                        type Response = super::ListDetectorsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SecurityCenterSettingsService>::list_detectors(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ListDetectorsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.securitycenter.settings.v1beta1.SecurityCenterSettingsService/ListComponents" => {
                    #[allow(non_camel_case_types)]
                    struct ListComponentsSvc<T: SecurityCenterSettingsService>(
                        pub Arc<T>,
                    );
                    impl<
                        T: SecurityCenterSettingsService,
                    > tonic::server::UnaryService<super::ListComponentsRequest>
                    for ListComponentsSvc<T> {
                        type Response = super::ListComponentsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SecurityCenterSettingsService>::list_components(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ListComponentsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for SecurityCenterSettingsServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "google.cloud.securitycenter.settings.v1beta1.SecurityCenterSettingsService";
    impl<T> tonic::server::NamedService for SecurityCenterSettingsServiceServer<T> {
