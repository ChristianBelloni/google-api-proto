...
pub mod speech_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/google.cloud.speech.v1p1beta1.Speech/LongRunningRecognize" => {
                    ...
                    impl<
                        T: Speech,
                    > tonic::server::UnaryService<super::LongRunningRecognizeRequest>
                    for LongRunningRecognizeSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Speech>::long_running_recognize(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "google.cloud.speech.v1p1beta1.Speech";
...
/// Generated server implementations.
pub mod adaptation_server {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with AdaptationServer.
    #[async_trait]
    pub trait Adaptation: std::marker::Send + std::marker::Sync + 'static {
        /// Create a set of phrase hints. Each item in the set can be a single word or
        /// a multi-word phrase. The items in the PhraseSet are favored by the
        /// recognition model when you send a call that includes the PhraseSet.
        ...
        /// List phrase sets.
        async fn list_phrase_set(
            &self,
            request: tonic::Request<super::ListPhraseSetRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListPhraseSetResponse>,
            tonic::Status,
        >;
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for AdaptationServer<T>
    where
        T: Adaptation,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.cloud.speech.v1p1beta1.Adaptation/CreatePhraseSet" => {
                    #[allow(non_camel_case_types)]
                    struct CreatePhraseSetSvc<T: Adaptation>(pub Arc<T>);
                    impl<
                        T: Adaptation,
                    ...
                    for CreatePhraseSetSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Adaptation>::create_phrase_set(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.speech.v1p1beta1.Adaptation/GetPhraseSet" => {
                    #[allow(non_camel_case_types)]
                    struct GetPhraseSetSvc<T: Adaptation>(pub Arc<T>);
                    impl<
                        T: Adaptation,
                    ...
                    for GetPhraseSetSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Adaptation>::get_phrase_set(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.speech.v1p1beta1.Adaptation/ListPhraseSet" => {
                    #[allow(non_camel_case_types)]
                    struct ListPhraseSetSvc<T: Adaptation>(pub Arc<T>);
                    impl<
                        T: Adaptation,
                    > tonic::server::UnaryService<super::ListPhraseSetRequest>
                    for ListPhraseSetSvc<T> {
                        type Response = super::ListPhraseSetResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Adaptation>::list_phrase_set(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ListPhraseSetSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.speech.v1p1beta1.Adaptation/UpdatePhraseSet" => {
                    #[allow(non_camel_case_types)]
                    struct UpdatePhraseSetSvc<T: Adaptation>(pub Arc<T>);
                    impl<
                        T: Adaptation,
                    ...
                    for UpdatePhraseSetSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Adaptation>::update_phrase_set(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.speech.v1p1beta1.Adaptation/DeletePhraseSet" => {
                    #[allow(non_camel_case_types)]
                    struct DeletePhraseSetSvc<T: Adaptation>(pub Arc<T>);
                    impl<
                        T: Adaptation,
                    ...
                    for DeletePhraseSetSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Adaptation>::delete_phrase_set(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.speech.v1p1beta1.Adaptation/CreateCustomClass" => {
                    #[allow(non_camel_case_types)]
                    struct CreateCustomClassSvc<T: Adaptation>(pub Arc<T>);
                    impl<
                        T: Adaptation,
                    ...
                    for CreateCustomClassSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Adaptation>::create_custom_class(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.cloud.speech.v1p1beta1.Adaptation/GetCustomClass" => {
                    #[allow(non_camel_case_types)]
                    struct GetCustomClassSvc<T: Adaptation>(pub Arc<T>);
                    impl<
                        T: Adaptation,
                    ...
                    for GetCustomClassSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Adaptation>::get_custom_class(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.speech.v1p1beta1.Adaptation/ListCustomClasses" => {
                    #[allow(non_camel_case_types)]
                    struct ListCustomClassesSvc<T: Adaptation>(pub Arc<T>);
                    impl<
                        T: Adaptation,
                    ...
                    for ListCustomClassesSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Adaptation>::list_custom_classes(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.cloud.speech.v1p1beta1.Adaptation/UpdateCustomClass" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateCustomClassSvc<T: Adaptation>(pub Arc<T>);
                    impl<
                        T: Adaptation,
                    ...
                    for UpdateCustomClassSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Adaptation>::update_custom_class(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.cloud.speech.v1p1beta1.Adaptation/DeleteCustomClass" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteCustomClassSvc<T: Adaptation>(pub Arc<T>);
                    impl<
                        T: Adaptation,
                    ...
                    for DeleteCustomClassSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Adaptation>::delete_custom_class(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
    ...
    impl<T> Clone for AdaptationServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.cloud.speech.v1p1beta1.Adaptation";
    impl<T> tonic::server::NamedService for AdaptationServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
