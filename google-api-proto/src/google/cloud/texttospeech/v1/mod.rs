...
pub mod text_to_speech_server {
    ...
    pub const SERVICE_NAME: &str = "google.cloud.texttospeech.v1.TextToSpeech";
...
pub mod text_to_speech_long_audio_synthesize_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.cloud.texttospeech.v1.TextToSpeechLongAudioSynthesize";
