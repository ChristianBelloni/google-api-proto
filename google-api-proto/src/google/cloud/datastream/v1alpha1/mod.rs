...
pub mod datastream_server {
    ...
    pub trait Datastream: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn fetch_errors(
            &self,
            request: tonic::Request<super::FetchErrorsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::super::super::super::longrunning::Operation>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/google.cloud.datastream.v1alpha1.Datastream/FetchErrors" => {
                    #[allow(non_camel_case_types)]
                    struct FetchErrorsSvc<T: Datastream>(pub Arc<T>);
                    impl<
                        T: Datastream,
                    > tonic::server::UnaryService<super::FetchErrorsRequest>
                    for FetchErrorsSvc<T> {
                        type Response = super::super::super::super::longrunning::Operation;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Datastream>::fetch_errors(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = FetchErrorsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    pub const SERVICE_NAME: &str = "google.cloud.datastream.v1alpha1.Datastream";
