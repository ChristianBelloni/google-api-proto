...
pub mod batch_service_server {
    ...
    pub trait BatchService: std::marker::Send + std::marker::Sync + 'static {
        ...
        >;
        /// Create a Resource Allowance.
        async fn create_resource_allowance(
            &self,
            request: tonic::Request<super::CreateResourceAllowanceRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ResourceAllowance>,
            tonic::Status,
        >;
        /// Get a ResourceAllowance specified by its resource name.
        async fn get_resource_allowance(
            &self,
            request: tonic::Request<super::GetResourceAllowanceRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ResourceAllowance>,
            tonic::Status,
        >;
        /// Delete a ResourceAllowance.
        async fn delete_resource_allowance(
            &self,
            request: tonic::Request<super::DeleteResourceAllowanceRequest>,
        ) -> std::result::Result<
            tonic::Response<super::super::super::super::longrunning::Operation>,
            tonic::Status,
        >;
        /// List all ResourceAllowances for a project within a region.
        async fn list_resource_allowances(
            &self,
            request: tonic::Request<super::ListResourceAllowancesRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListResourceAllowancesResponse>,
            tonic::Status,
        >;
        /// Update a Resource Allowance.
        async fn update_resource_allowance(
            &self,
            request: tonic::Request<super::UpdateResourceAllowanceRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ResourceAllowance>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/google.cloud.batch.v1alpha.BatchService/CancelJob" => {
                    #[allow(non_camel_case_types)]
                    struct CancelJobSvc<T: BatchService>(pub Arc<T>);
                    impl<
                        T: BatchService,
                    ...
                    for CancelJobSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as BatchService>::cancel_job(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.batch.v1alpha.BatchService/UpdateJob" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateJobSvc<T: BatchService>(pub Arc<T>);
                    impl<
                        T: BatchService,
                    ...
                    for UpdateJobSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as BatchService>::update_job(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.batch.v1alpha.BatchService/CreateResourceAllowance" => {
                    #[allow(non_camel_case_types)]
                    struct CreateResourceAllowanceSvc<T: BatchService>(pub Arc<T>);
                    impl<
                        T: BatchService,
                    > tonic::server::UnaryService<super::CreateResourceAllowanceRequest>
                    for CreateResourceAllowanceSvc<T> {
                        type Response = super::ResourceAllowance;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            request: tonic::Request<
                                super::CreateResourceAllowanceRequest,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as BatchService>::create_resource_allowance(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = CreateResourceAllowanceSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.batch.v1alpha.BatchService/GetResourceAllowance" => {
                    #[allow(non_camel_case_types)]
                    struct GetResourceAllowanceSvc<T: BatchService>(pub Arc<T>);
                    impl<
                        T: BatchService,
                    > tonic::server::UnaryService<super::GetResourceAllowanceRequest>
                    for GetResourceAllowanceSvc<T> {
                        type Response = super::ResourceAllowance;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as BatchService>::get_resource_allowance(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetResourceAllowanceSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.batch.v1alpha.BatchService/DeleteResourceAllowance" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteResourceAllowanceSvc<T: BatchService>(pub Arc<T>);
                    impl<
                        T: BatchService,
                    > tonic::server::UnaryService<super::DeleteResourceAllowanceRequest>
                    for DeleteResourceAllowanceSvc<T> {
                        type Response = super::super::super::super::longrunning::Operation;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            &mut self,
                            request: tonic::Request<
                                super::DeleteResourceAllowanceRequest,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as BatchService>::delete_resource_allowance(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = DeleteResourceAllowanceSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.batch.v1alpha.BatchService/ListResourceAllowances" => {
                    #[allow(non_camel_case_types)]
                    struct ListResourceAllowancesSvc<T: BatchService>(pub Arc<T>);
                    impl<
                        T: BatchService,
                    > tonic::server::UnaryService<super::ListResourceAllowancesRequest>
                    for ListResourceAllowancesSvc<T> {
                        type Response = super::ListResourceAllowancesResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as BatchService>::list_resource_allowances(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ListResourceAllowancesSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.batch.v1alpha.BatchService/UpdateResourceAllowance" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateResourceAllowanceSvc<T: BatchService>(pub Arc<T>);
                    impl<
                        T: BatchService,
                    > tonic::server::UnaryService<super::UpdateResourceAllowanceRequest>
                    for UpdateResourceAllowanceSvc<T> {
                        type Response = super::ResourceAllowance;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            &mut self,
                            request: tonic::Request<
                                super::UpdateResourceAllowanceRequest,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as BatchService>::update_resource_allowance(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = UpdateResourceAllowanceSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    pub const SERVICE_NAME: &str = "google.cloud.batch.v1alpha.BatchService";
