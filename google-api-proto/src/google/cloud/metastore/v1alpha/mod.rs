...
pub struct DataplexConfig {
    ...
    pub lake_resources: ::prost::alloc::collections::BTreeMap<
        ::prost::alloc::string::String,
        Lake,
    >,
}
...
pub struct HiveMetastoreConfig {
    ...
    pub auxiliary_versions: ::prost::alloc::collections::BTreeMap<
        ::prost::alloc::string::String,
...
pub mod dataproc_metastore_server {
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/google.cloud.metastore.v1alpha.DataprocMetastore/RemoveIamPolicy" => {
                    #[allow(non_camel_case_types)]
                    struct RemoveIamPolicySvc<T: DataprocMetastore>(pub Arc<T>);
                    impl<
                        T: DataprocMetastore,
                    ...
                    for RemoveIamPolicySvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DataprocMetastore>::remove_iam_policy(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
    ...
    pub const SERVICE_NAME: &str = "google.cloud.metastore.v1alpha.DataprocMetastore";
...
pub mod dataproc_metastore_federation_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.cloud.metastore.v1alpha.DataprocMetastoreFederation";
