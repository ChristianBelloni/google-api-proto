...
pub mod dataproc_metastore_server {
    ...
    pub const SERVICE_NAME: &str = "google.cloud.metastore.v1beta.DataprocMetastore";
...
pub mod dataproc_metastore_federation_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.cloud.metastore.v1beta.DataprocMetastoreFederation";
