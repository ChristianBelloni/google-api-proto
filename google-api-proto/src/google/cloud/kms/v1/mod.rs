...
pub mod autokey_admin_server {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with AutokeyAdminServer.
    #[async_trait]
    pub trait AutokeyAdmin: std::marker::Send + std::marker::Sync + 'static {
        /// Updates the [AutokeyConfig][google.cloud.kms.v1.AutokeyConfig] for a
        /// folder. The caller must have both `cloudkms.autokeyConfigs.update`
        /// permission on the parent folder and `cloudkms.cryptoKeys.setIamPolicy`
        /// permission on the provided key project. A
        ...
        async fn update_autokey_config(
            &self,
            request: tonic::Request<super::UpdateAutokeyConfigRequest>,
        ) -> std::result::Result<tonic::Response<super::AutokeyConfig>, tonic::Status>;
        /// Returns the [AutokeyConfig][google.cloud.kms.v1.AutokeyConfig] for a
        /// folder.
        async fn get_autokey_config(
            &self,
            request: tonic::Request<super::GetAutokeyConfigRequest>,
        ) -> std::result::Result<tonic::Response<super::AutokeyConfig>, tonic::Status>;
        /// Returns the effective Cloud KMS Autokey configuration for a given project.
        async fn show_effective_autokey_config(
            &self,
            request: tonic::Request<super::ShowEffectiveAutokeyConfigRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ShowEffectiveAutokeyConfigResponse>,
            tonic::Status,
        >;
    ...
    /// Managed Encryption Key (CMEK) use, on-demand.
    #[derive(Debug)]
    pub struct AutokeyAdminServer<T> {
        inner: Arc<T>,
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for AutokeyAdminServer<T>
    where
        T: AutokeyAdmin,
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.cloud.kms.v1.AutokeyAdmin/UpdateAutokeyConfig" => {
                    ...
                    struct UpdateAutokeyConfigSvc<T: AutokeyAdmin>(pub Arc<T>);
                    impl<
                        T: AutokeyAdmin,
                    > tonic::server::UnaryService<super::UpdateAutokeyConfigRequest>
                    for UpdateAutokeyConfigSvc<T> {
                        type Response = super::AutokeyConfig;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as AutokeyAdmin>::update_autokey_config(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let fut = async move {
                        let method = UpdateAutokeyConfigSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                ...
                "/google.cloud.kms.v1.AutokeyAdmin/GetAutokeyConfig" => {
                    #[allow(non_camel_case_types)]
                    struct GetAutokeyConfigSvc<T: AutokeyAdmin>(pub Arc<T>);
                    impl<
                        T: AutokeyAdmin,
                    > tonic::server::UnaryService<super::GetAutokeyConfigRequest>
                    for GetAutokeyConfigSvc<T> {
                        type Response = super::AutokeyConfig;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AutokeyAdmin>::get_autokey_config(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetAutokeyConfigSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.kms.v1.AutokeyAdmin/ShowEffectiveAutokeyConfig" => {
                    #[allow(non_camel_case_types)]
                    struct ShowEffectiveAutokeyConfigSvc<T: AutokeyAdmin>(pub Arc<T>);
                    impl<
                        T: AutokeyAdmin,
                    > tonic::server::UnaryService<
                        super::ShowEffectiveAutokeyConfigRequest,
                    > for ShowEffectiveAutokeyConfigSvc<T> {
                        type Response = super::ShowEffectiveAutokeyConfigResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AutokeyAdmin>::show_effective_autokey_config(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ShowEffectiveAutokeyConfigSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for AutokeyAdminServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "google.cloud.kms.v1.AutokeyAdmin";
    impl<T> tonic::server::NamedService for AutokeyAdminServer<T> {
...
/// Generated server implementations.
pub mod ekm_service_server {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with EkmServiceServer.
    #[async_trait]
    pub trait EkmService: std::marker::Send + std::marker::Sync + 'static {
        /// Lists [EkmConnections][google.cloud.kms.v1.EkmConnection].
        async fn list_ekm_connections(
            &self,
            request: tonic::Request<super::ListEkmConnectionsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListEkmConnectionsResponse>,
            tonic::Status,
        >;
        ...
        async fn get_ekm_connection(
            &self,
            request: tonic::Request<super::GetEkmConnectionRequest>,
        ) -> std::result::Result<tonic::Response<super::EkmConnection>, tonic::Status>;
        /// Creates a new [EkmConnection][google.cloud.kms.v1.EkmConnection] in a given
        /// Project and Location.
        async fn create_ekm_connection(
            &self,
            request: tonic::Request<super::CreateEkmConnectionRequest>,
        ) -> std::result::Result<tonic::Response<super::EkmConnection>, tonic::Status>;
        /// Updates an [EkmConnection][google.cloud.kms.v1.EkmConnection]'s metadata.
        async fn update_ekm_connection(
            &self,
            request: tonic::Request<super::UpdateEkmConnectionRequest>,
        ) -> std::result::Result<tonic::Response<super::EkmConnection>, tonic::Status>;
        /// Returns the [EkmConfig][google.cloud.kms.v1.EkmConfig] singleton resource
        /// for a given project and location.
        async fn get_ekm_config(
            &self,
            request: tonic::Request<super::GetEkmConfigRequest>,
        ) -> std::result::Result<tonic::Response<super::EkmConfig>, tonic::Status>;
        /// Updates the [EkmConfig][google.cloud.kms.v1.EkmConfig] singleton resource
        /// for a given project and location.
        async fn update_ekm_config(
            &self,
            request: tonic::Request<super::UpdateEkmConfigRequest>,
        ) -> std::result::Result<tonic::Response<super::EkmConfig>, tonic::Status>;
        /// Verifies that Cloud KMS can successfully connect to the external key
        /// manager specified by an [EkmConnection][google.cloud.kms.v1.EkmConnection].
        /// If there is an error connecting to the EKM, this method returns a
        ...
        async fn verify_connectivity(
            &self,
            request: tonic::Request<super::VerifyConnectivityRequest>,
        ) -> std::result::Result<
            tonic::Response<super::VerifyConnectivityResponse>,
            tonic::Status,
        >;
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for EkmServiceServer<T>
    where
        T: EkmService,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.cloud.kms.v1.EkmService/ListEkmConnections" => {
                    #[allow(non_camel_case_types)]
                    struct ListEkmConnectionsSvc<T: EkmService>(pub Arc<T>);
                    impl<
                        T: EkmService,
                    > tonic::server::UnaryService<super::ListEkmConnectionsRequest>
                    for ListEkmConnectionsSvc<T> {
                        type Response = super::ListEkmConnectionsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as EkmService>::list_ekm_connections(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ListEkmConnectionsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.kms.v1.EkmService/GetEkmConnection" => {
                    #[allow(non_camel_case_types)]
                    struct GetEkmConnectionSvc<T: EkmService>(pub Arc<T>);
                    impl<
                        T: EkmService,
                    > tonic::server::UnaryService<super::GetEkmConnectionRequest>
                    for GetEkmConnectionSvc<T> {
                        type Response = super::EkmConnection;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as EkmService>::get_ekm_connection(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetEkmConnectionSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.kms.v1.EkmService/CreateEkmConnection" => {
                    #[allow(non_camel_case_types)]
                    struct CreateEkmConnectionSvc<T: EkmService>(pub Arc<T>);
                    impl<
                        T: EkmService,
                    > tonic::server::UnaryService<super::CreateEkmConnectionRequest>
                    for CreateEkmConnectionSvc<T> {
                        type Response = super::EkmConnection;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as EkmService>::create_ekm_connection(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = CreateEkmConnectionSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.kms.v1.EkmService/UpdateEkmConnection" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateEkmConnectionSvc<T: EkmService>(pub Arc<T>);
                    impl<
                        T: EkmService,
                    > tonic::server::UnaryService<super::UpdateEkmConnectionRequest>
                    for UpdateEkmConnectionSvc<T> {
                        type Response = super::EkmConnection;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as EkmService>::update_ekm_connection(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = UpdateEkmConnectionSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.kms.v1.EkmService/GetEkmConfig" => {
                    #[allow(non_camel_case_types)]
                    struct GetEkmConfigSvc<T: EkmService>(pub Arc<T>);
                    impl<
                        T: EkmService,
                    > tonic::server::UnaryService<super::GetEkmConfigRequest>
                    for GetEkmConfigSvc<T> {
                        type Response = super::EkmConfig;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as EkmService>::get_ekm_config(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetEkmConfigSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.kms.v1.EkmService/UpdateEkmConfig" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateEkmConfigSvc<T: EkmService>(pub Arc<T>);
                    impl<
                        T: EkmService,
                    > tonic::server::UnaryService<super::UpdateEkmConfigRequest>
                    for UpdateEkmConfigSvc<T> {
                        type Response = super::EkmConfig;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as EkmService>::update_ekm_config(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = UpdateEkmConfigSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.kms.v1.EkmService/VerifyConnectivity" => {
                    #[allow(non_camel_case_types)]
                    struct VerifyConnectivitySvc<T: EkmService>(pub Arc<T>);
                    impl<
                        T: EkmService,
                    > tonic::server::UnaryService<super::VerifyConnectivityRequest>
                    for VerifyConnectivitySvc<T> {
                        type Response = super::VerifyConnectivityResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as EkmService>::verify_connectivity(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = VerifyConnectivitySvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for EkmServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.cloud.kms.v1.EkmService";
    impl<T> tonic::server::NamedService for EkmServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
/// Request message for
...
pub struct RawEncryptRequest {
    ...
    pub initialization_vector: ::prost::bytes::Bytes,
    /// Optional. An optional CRC32C checksum of the
...
pub mod key_management_service_server {
    ...
    pub trait KeyManagementService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn raw_encrypt(
            &self,
            request: tonic::Request<super::RawEncryptRequest>,
        ) -> std::result::Result<
            tonic::Response<super::RawEncryptResponse>,
            tonic::Status,
        >;
        ...
        async fn raw_decrypt(
            &self,
            request: tonic::Request<super::RawDecryptRequest>,
        ) -> std::result::Result<
            tonic::Response<super::RawDecryptResponse>,
            tonic::Status,
        >;
        ...
        async fn mac_sign(
            &self,
            request: tonic::Request<super::MacSignRequest>,
        ...
        async fn mac_verify(
            &self,
            request: tonic::Request<super::MacVerifyRequest>,
        ) -> std::result::Result<
            tonic::Response<super::MacVerifyResponse>,
            tonic::Status,
        >;
        ...
        async fn generate_random_bytes(
            &self,
            request: tonic::Request<super::GenerateRandomBytesRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GenerateRandomBytesResponse>,
            tonic::Status,
        >;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.cloud.kms.v1.KeyManagementService/ListKeyRings" => {
                    ...
                    for ListKeyRingsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as KeyManagementService>::list_key_rings(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.cloud.kms.v1.KeyManagementService/ListCryptoKeys" => {
                    ...
                    for ListCryptoKeysSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as KeyManagementService>::list_crypto_keys(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/google.cloud.kms.v1.KeyManagementService/ListCryptoKeyVersions" => {
                    ...
                    for ListCryptoKeyVersionsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as KeyManagementService>::list_crypto_key_versions(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/google.cloud.kms.v1.KeyManagementService/ListImportJobs" => {
                    ...
                    for ListImportJobsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as KeyManagementService>::list_import_jobs(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/google.cloud.kms.v1.KeyManagementService/GetKeyRing" => {
                    ...
                    impl<
                        T: KeyManagementService,
                    > tonic::server::UnaryService<super::GetKeyRingRequest>
                    for GetKeyRingSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as KeyManagementService>::get_key_ring(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.cloud.kms.v1.KeyManagementService/GetCryptoKey" => {
                    ...
                    for GetCryptoKeySvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as KeyManagementService>::get_crypto_key(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.cloud.kms.v1.KeyManagementService/GetCryptoKeyVersion" => {
                    ...
                    for GetCryptoKeyVersionSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as KeyManagementService>::get_crypto_key_version(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/google.cloud.kms.v1.KeyManagementService/GetPublicKey" => {
                    ...
                    for GetPublicKeySvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as KeyManagementService>::get_public_key(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.cloud.kms.v1.KeyManagementService/GetImportJob" => {
                    ...
                    for GetImportJobSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as KeyManagementService>::get_import_job(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.cloud.kms.v1.KeyManagementService/CreateKeyRing" => {
                    ...
                    for CreateKeyRingSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as KeyManagementService>::create_key_ring(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/google.cloud.kms.v1.KeyManagementService/CreateCryptoKey" => {
                    ...
                    for CreateCryptoKeySvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as KeyManagementService>::create_crypto_key(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/google.cloud.kms.v1.KeyManagementService/CreateCryptoKeyVersion" => {
                    #[allow(non_camel_case_types)]
                    struct CreateCryptoKeyVersionSvc<T: KeyManagementService>(
                        pub Arc<T>,
                    );
                    impl<
                        T: KeyManagementService,
                    ...
                    for CreateCryptoKeyVersionSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as KeyManagementService>::create_crypto_key_version(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/google.cloud.kms.v1.KeyManagementService/ImportCryptoKeyVersion" => {
                    #[allow(non_camel_case_types)]
                    struct ImportCryptoKeyVersionSvc<T: KeyManagementService>(
                        pub Arc<T>,
                    );
                    impl<
                        T: KeyManagementService,
                    ...
                    for ImportCryptoKeyVersionSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as KeyManagementService>::import_crypto_key_version(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/google.cloud.kms.v1.KeyManagementService/CreateImportJob" => {
                    ...
                    for CreateImportJobSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as KeyManagementService>::create_import_job(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/google.cloud.kms.v1.KeyManagementService/UpdateCryptoKey" => {
                    ...
                    for UpdateCryptoKeySvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as KeyManagementService>::update_crypto_key(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/google.cloud.kms.v1.KeyManagementService/UpdateCryptoKeyVersion" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateCryptoKeyVersionSvc<T: KeyManagementService>(
                        pub Arc<T>,
                    );
                    impl<
                        T: KeyManagementService,
                    ...
                    for UpdateCryptoKeyVersionSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as KeyManagementService>::update_crypto_key_version(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/google.cloud.kms.v1.KeyManagementService/UpdateCryptoKeyPrimaryVersion" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateCryptoKeyPrimaryVersionSvc<T: KeyManagementService>(
                        pub Arc<T>,
                    );
                    impl<
                        T: KeyManagementService,
                    > tonic::server::UnaryService<
                        super::UpdateCryptoKeyPrimaryVersionRequest,
                    > for UpdateCryptoKeyPrimaryVersionSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as KeyManagementService>::update_crypto_key_primary_version(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/google.cloud.kms.v1.KeyManagementService/DestroyCryptoKeyVersion" => {
                    #[allow(non_camel_case_types)]
                    struct DestroyCryptoKeyVersionSvc<T: KeyManagementService>(
                        pub Arc<T>,
                    );
                    impl<
                        T: KeyManagementService,
                    ...
                    for DestroyCryptoKeyVersionSvc<T> {
                        ...
                        fn call(
                            &mut self,
                            request: tonic::Request<
                                super::DestroyCryptoKeyVersionRequest,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as KeyManagementService>::destroy_crypto_key_version(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/google.cloud.kms.v1.KeyManagementService/RestoreCryptoKeyVersion" => {
                    #[allow(non_camel_case_types)]
                    struct RestoreCryptoKeyVersionSvc<T: KeyManagementService>(
                        pub Arc<T>,
                    );
                    impl<
                        T: KeyManagementService,
                    ...
                    for RestoreCryptoKeyVersionSvc<T> {
                        ...
                        fn call(
                            &mut self,
                            request: tonic::Request<
                                super::RestoreCryptoKeyVersionRequest,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as KeyManagementService>::restore_crypto_key_version(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/google.cloud.kms.v1.KeyManagementService/RawEncrypt" => {
                    #[allow(non_camel_case_types)]
                    struct RawEncryptSvc<T: KeyManagementService>(pub Arc<T>);
                    impl<
                        T: KeyManagementService,
                    > tonic::server::UnaryService<super::RawEncryptRequest>
                    for RawEncryptSvc<T> {
                        type Response = super::RawEncryptResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as KeyManagementService>::raw_encrypt(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = RawEncryptSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.kms.v1.KeyManagementService/RawDecrypt" => {
                    #[allow(non_camel_case_types)]
                    struct RawDecryptSvc<T: KeyManagementService>(pub Arc<T>);
                    impl<
                        T: KeyManagementService,
                    > tonic::server::UnaryService<super::RawDecryptRequest>
                    for RawDecryptSvc<T> {
                        type Response = super::RawDecryptResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as KeyManagementService>::raw_decrypt(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = RawDecryptSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.kms.v1.KeyManagementService/AsymmetricSign" => {
                    ...
                    for AsymmetricSignSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as KeyManagementService>::asymmetric_sign(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/google.cloud.kms.v1.KeyManagementService/AsymmetricDecrypt" => {
                    ...
                    for AsymmetricDecryptSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as KeyManagementService>::asymmetric_decrypt(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/google.cloud.kms.v1.KeyManagementService/MacSign" => {
                    #[allow(non_camel_case_types)]
                    struct MacSignSvc<T: KeyManagementService>(pub Arc<T>);
                    impl<
                        T: KeyManagementService,
                    > tonic::server::UnaryService<super::MacSignRequest>
                    for MacSignSvc<T> {
                        type Response = super::MacSignResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as KeyManagementService>::mac_sign(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.kms.v1.KeyManagementService/MacVerify" => {
                    #[allow(non_camel_case_types)]
                    struct MacVerifySvc<T: KeyManagementService>(pub Arc<T>);
                    impl<
                        T: KeyManagementService,
                    > tonic::server::UnaryService<super::MacVerifyRequest>
                    for MacVerifySvc<T> {
                        type Response = super::MacVerifyResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as KeyManagementService>::mac_verify(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.cloud.kms.v1.KeyManagementService/GenerateRandomBytes" => {
                    #[allow(non_camel_case_types)]
                    struct GenerateRandomBytesSvc<T: KeyManagementService>(pub Arc<T>);
                    impl<
                        T: KeyManagementService,
                    > tonic::server::UnaryService<super::GenerateRandomBytesRequest>
                    for GenerateRandomBytesSvc<T> {
                        type Response = super::GenerateRandomBytesResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as KeyManagementService>::generate_random_bytes(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GenerateRandomBytesSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.cloud.kms.v1.KeyManagementService";
...
/// Generated server implementations.
pub mod autokey_server {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with AutokeyServer.
    #[async_trait]
    pub trait Autokey: std::marker::Send + std::marker::Sync + 'static {
        /// Creates a new [KeyHandle][google.cloud.kms.v1.KeyHandle], triggering the
        /// provisioning of a new [CryptoKey][google.cloud.kms.v1.CryptoKey] for CMEK
        /// use with the given resource type in the configured key project and the same
        /// location. [GetOperation][Operations.GetOperation] should be used to resolve
        ...
        async fn create_key_handle(
            &self,
            request: tonic::Request<super::CreateKeyHandleRequest>,
        ) -> std::result::Result<
            tonic::Response<super::super::super::super::longrunning::Operation>,
            tonic::Status,
        >;
        ...
        async fn get_key_handle(
            &self,
            request: tonic::Request<super::GetKeyHandleRequest>,
        ) -> std::result::Result<tonic::Response<super::KeyHandle>, tonic::Status>;
        /// Lists [KeyHandles][google.cloud.kms.v1.KeyHandle].
        async fn list_key_handles(
            &self,
            request: tonic::Request<super::ListKeyHandlesRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListKeyHandlesResponse>,
            tonic::Status,
        >;
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for AutokeyServer<T>
    where
        T: Autokey,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.cloud.kms.v1.Autokey/CreateKeyHandle" => {
                    #[allow(non_camel_case_types)]
                    struct CreateKeyHandleSvc<T: Autokey>(pub Arc<T>);
                    impl<
                        T: Autokey,
                    > tonic::server::UnaryService<super::CreateKeyHandleRequest>
                    for CreateKeyHandleSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Autokey>::create_key_handle(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = CreateKeyHandleSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.kms.v1.Autokey/GetKeyHandle" => {
                    #[allow(non_camel_case_types)]
                    struct GetKeyHandleSvc<T: Autokey>(pub Arc<T>);
                    impl<
                        T: Autokey,
                    > tonic::server::UnaryService<super::GetKeyHandleRequest>
                    for GetKeyHandleSvc<T> {
                        type Response = super::KeyHandle;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Autokey>::get_key_handle(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetKeyHandleSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.kms.v1.Autokey/ListKeyHandles" => {
                    #[allow(non_camel_case_types)]
                    struct ListKeyHandlesSvc<T: Autokey>(pub Arc<T>);
                    impl<
                        T: Autokey,
                    > tonic::server::UnaryService<super::ListKeyHandlesRequest>
                    for ListKeyHandlesSvc<T> {
                        type Response = super::ListKeyHandlesResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Autokey>::list_key_handles(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ListKeyHandlesSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for AutokeyServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.cloud.kms.v1.Autokey";
    impl<T> tonic::server::NamedService for AutokeyServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
