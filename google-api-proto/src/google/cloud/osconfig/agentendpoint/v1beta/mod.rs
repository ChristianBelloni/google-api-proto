...
pub mod agent_endpoint_service_server {
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/google.cloud.osconfig.agentendpoint.v1beta.AgentEndpointService/LookupEffectiveGuestPolicy" => {
                    #[allow(non_camel_case_types)]
                    struct LookupEffectiveGuestPolicySvc<T: AgentEndpointService>(
                        pub Arc<T>,
                    );
                    impl<
                        T: AgentEndpointService,
                    ...
                    > for LookupEffectiveGuestPolicySvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AgentEndpointService>::lookup_effective_guest_policy(
                                        &inner,
                                        request,
                                    )
                                    .await
    ...
    pub const SERVICE_NAME: &str = "google.cloud.osconfig.agentendpoint.v1beta.AgentEndpointService";
