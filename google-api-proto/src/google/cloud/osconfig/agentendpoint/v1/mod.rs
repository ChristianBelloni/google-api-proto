...
pub mod agent_endpoint_service_server {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with AgentEndpointServiceServer.
    #[async_trait]
    pub trait AgentEndpointService: std::marker::Send + std::marker::Sync + 'static {
        /// Server streaming response type for the ReceiveTaskNotification method.
        type ReceiveTaskNotificationStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<
                    super::ReceiveTaskNotificationResponse,
                    tonic::Status,
                >,
            >
            + std::marker::Send
            + 'static;
        /// Stream established by client to receive Task notifications.
        async fn receive_task_notification(
            &self,
            request: tonic::Request<super::ReceiveTaskNotificationRequest>,
        ) -> std::result::Result<
            tonic::Response<Self::ReceiveTaskNotificationStream>,
            tonic::Status,
        >;
        /// Signals the start of a task execution and returns the task info.
        async fn start_next_task(
            &self,
            request: tonic::Request<super::StartNextTaskRequest>,
        ) -> std::result::Result<
            tonic::Response<super::StartNextTaskResponse>,
            tonic::Status,
        >;
        ...
        async fn report_task_progress(
            &self,
            request: tonic::Request<super::ReportTaskProgressRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ReportTaskProgressResponse>,
            tonic::Status,
        >;
        ...
        async fn report_task_complete(
            &self,
            request: tonic::Request<super::ReportTaskCompleteRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ReportTaskCompleteResponse>,
            tonic::Status,
        >;
        ...
        async fn report_inventory(
            &self,
            request: tonic::Request<super::ReportInventoryRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ReportInventoryResponse>,
            tonic::Status,
        >;
    ...
    /// OS Config agent endpoint API.
    #[derive(Debug)]
    pub struct AgentEndpointServiceServer<T> {
        inner: Arc<T>,
    ...
    impl<T> AgentEndpointServiceServer<T> {
        pub fn new(inner: T) -> Self {
    ...
    for AgentEndpointServiceServer<T>
    where
        T: AgentEndpointService,
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.cloud.osconfig.agentendpoint.v1.AgentEndpointService/ReceiveTaskNotification" => {
                    ...
                    struct ReceiveTaskNotificationSvc<T: AgentEndpointService>(
                        pub Arc<T>,
                    );
                    impl<
                        T: AgentEndpointService,
                    > tonic::server::ServerStreamingService<
                        super::ReceiveTaskNotificationRequest,
                    > for ReceiveTaskNotificationSvc<T> {
                        type Response = super::ReceiveTaskNotificationResponse;
                        type ResponseStream = T::ReceiveTaskNotificationStream;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as AgentEndpointService>::receive_task_notification(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let fut = async move {
                        let method = ReceiveTaskNotificationSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                ...
                "/google.cloud.osconfig.agentendpoint.v1.AgentEndpointService/StartNextTask" => {
                    #[allow(non_camel_case_types)]
                    struct StartNextTaskSvc<T: AgentEndpointService>(pub Arc<T>);
                    impl<
                        T: AgentEndpointService,
                    > tonic::server::UnaryService<super::StartNextTaskRequest>
                    for StartNextTaskSvc<T> {
                        type Response = super::StartNextTaskResponse;
                        type Future = BoxFuture<
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AgentEndpointService>::start_next_task(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = StartNextTaskSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.osconfig.agentendpoint.v1.AgentEndpointService/ReportTaskProgress" => {
                    #[allow(non_camel_case_types)]
                    struct ReportTaskProgressSvc<T: AgentEndpointService>(pub Arc<T>);
                    impl<
                        T: AgentEndpointService,
                    > tonic::server::UnaryService<super::ReportTaskProgressRequest>
                    for ReportTaskProgressSvc<T> {
                        type Response = super::ReportTaskProgressResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AgentEndpointService>::report_task_progress(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ReportTaskProgressSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.osconfig.agentendpoint.v1.AgentEndpointService/ReportTaskComplete" => {
                    #[allow(non_camel_case_types)]
                    struct ReportTaskCompleteSvc<T: AgentEndpointService>(pub Arc<T>);
                    impl<
                        T: AgentEndpointService,
                    > tonic::server::UnaryService<super::ReportTaskCompleteRequest>
                    for ReportTaskCompleteSvc<T> {
                        type Response = super::ReportTaskCompleteResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AgentEndpointService>::report_task_complete(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ReportTaskCompleteSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.osconfig.agentendpoint.v1.AgentEndpointService/RegisterAgent" => {
                    #[allow(non_camel_case_types)]
                    struct RegisterAgentSvc<T: AgentEndpointService>(pub Arc<T>);
                    impl<
                        T: AgentEndpointService,
                    ...
                    for RegisterAgentSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AgentEndpointService>::register_agent(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.cloud.osconfig.agentendpoint.v1.AgentEndpointService/ReportInventory" => {
                    #[allow(non_camel_case_types)]
                    struct ReportInventorySvc<T: AgentEndpointService>(pub Arc<T>);
                    impl<
                        T: AgentEndpointService,
                    > tonic::server::UnaryService<super::ReportInventoryRequest>
                    for ReportInventorySvc<T> {
                        type Response = super::ReportInventoryResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AgentEndpointService>::report_inventory(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ReportInventorySvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for AgentEndpointServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "google.cloud.osconfig.agentendpoint.v1.AgentEndpointService";
    impl<T> tonic::server::NamedService for AgentEndpointServiceServer<T> {
