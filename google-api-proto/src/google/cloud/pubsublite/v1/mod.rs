...
pub mod cursor_service_server {
    ...
    #[async_trait]
    pub trait CursorService: std::marker::Send + std::marker::Sync + 'static {
    ...
    /// progress within a topic partition for a given subscription.
    #[derive(Debug)]
    pub struct CursorServiceServer<T> {
        inner: Arc<T>,
    ...
    impl<T> Clone for CursorServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "google.cloud.pubsublite.v1.CursorService";
    impl<T> tonic::server::NamedService for CursorServiceServer<T> {
...
pub mod subscriber_service_server {
    ...
    #[async_trait]
    pub trait SubscriberService: std::marker::Send + std::marker::Sync + 'static {
    ...
    /// from subscriptions.
    #[derive(Debug)]
    pub struct SubscriberServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> SubscriberServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T> Clone for SubscriberServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.cloud.pubsublite.v1.SubscriberService";
    impl<T> tonic::server::NamedService for SubscriberServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
/// Generated server implementations.
pub mod partition_assignment_service_server {
    ...
    #[async_trait]
    pub trait PartitionAssignmentService: std::marker::Send + std::marker::Sync + 'static {
    ...
    /// partitions it should connect to.
    #[derive(Debug)]
    pub struct PartitionAssignmentServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> PartitionAssignmentServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T> Clone for PartitionAssignmentServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.cloud.pubsublite.v1.PartitionAssignmentService";
    impl<T> tonic::server::NamedService for PartitionAssignmentServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
...
pub mod publisher_service_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.cloud.pubsublite.v1.PublisherService";
...
pub mod topic_stats_service_server {
    ...
    #[async_trait]
    pub trait TopicStatsService: std::marker::Send + std::marker::Sync + 'static {
        /// Compute statistics about a range of messages in a given topic and
        /// partition.
    ...
    /// This service allows users to get stats about messages in their topic.
    #[derive(Debug)]
    pub struct TopicStatsServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> TopicStatsServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T> Clone for TopicStatsServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.cloud.pubsublite.v1.TopicStatsService";
    impl<T> tonic::server::NamedService for TopicStatsServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
...
pub mod admin_service_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.cloud.pubsublite.v1.AdminService";
