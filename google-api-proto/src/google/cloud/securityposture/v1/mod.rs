...
pub mod security_posture_server {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with SecurityPostureServer.
    #[async_trait]
    pub trait SecurityPosture: std::marker::Send + std::marker::Sync + 'static {
        /// (-- This option restricts the visibility of the API to only projects that
        /// will
        /// (-- be labeled as `PREVIEW` or `GOOGLE_INTERNAL` by the service.
        /// (-- option (google.api.api_visibility).restriction =
        ...
        async fn list_postures(
            &self,
            request: tonic::Request<super::ListPosturesRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListPosturesResponse>,
            tonic::Status,
        >;
        ...
        async fn list_posture_revisions(
            &self,
            request: tonic::Request<super::ListPostureRevisionsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListPostureRevisionsResponse>,
            tonic::Status,
        >;
        ...
        async fn get_posture(
            &self,
            request: tonic::Request<super::GetPostureRequest>,
        ) -> std::result::Result<tonic::Response<super::Posture>, tonic::Status>;
        /// Creates a new Posture resource.
        /// If a Posture with the specified name already exists in the specified
        /// organization and location, the long running operation returns a
        ...
        async fn create_posture(
            &self,
            request: tonic::Request<super::CreatePostureRequest>,
        ) -> std::result::Result<
            tonic::Response<super::super::super::super::longrunning::Operation>,
            tonic::Status,
        >;
        ...
        async fn update_posture(
            &self,
            request: tonic::Request<super::UpdatePostureRequest>,
        ) -> std::result::Result<
            tonic::Response<super::super::super::super::longrunning::Operation>,
            tonic::Status,
        >;
        ...
        async fn delete_posture(
            &self,
            request: tonic::Request<super::DeletePostureRequest>,
        ) -> std::result::Result<
            tonic::Response<super::super::super::super::longrunning::Operation>,
            tonic::Status,
        >;
        ...
        async fn extract_posture(
            &self,
            request: tonic::Request<super::ExtractPostureRequest>,
        ) -> std::result::Result<
            tonic::Response<super::super::super::super::longrunning::Operation>,
            tonic::Status,
        >;
        ...
        async fn list_posture_deployments(
            &self,
            request: tonic::Request<super::ListPostureDeploymentsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListPostureDeploymentsResponse>,
            tonic::Status,
        >;
        ...
        async fn get_posture_deployment(
            &self,
            request: tonic::Request<super::GetPostureDeploymentRequest>,
        ) -> std::result::Result<
            tonic::Response<super::PostureDeployment>,
            tonic::Status,
        >;
        ...
        async fn create_posture_deployment(
            &self,
            request: tonic::Request<super::CreatePostureDeploymentRequest>,
        ) -> std::result::Result<
            tonic::Response<super::super::super::super::longrunning::Operation>,
            tonic::Status,
        >;
        ...
        async fn update_posture_deployment(
            &self,
            request: tonic::Request<super::UpdatePostureDeploymentRequest>,
        ) -> std::result::Result<
            tonic::Response<super::super::super::super::longrunning::Operation>,
            tonic::Status,
        >;
        ...
        async fn delete_posture_deployment(
            &self,
            request: tonic::Request<super::DeletePostureDeploymentRequest>,
        ) -> std::result::Result<
            tonic::Response<super::super::super::super::longrunning::Operation>,
            tonic::Status,
        >;
        ...
        async fn list_posture_templates(
            &self,
            request: tonic::Request<super::ListPostureTemplatesRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListPostureTemplatesResponse>,
            tonic::Status,
        >;
        ...
        async fn get_posture_template(
            &self,
            request: tonic::Request<super::GetPostureTemplateRequest>,
        ) -> std::result::Result<tonic::Response<super::PostureTemplate>, tonic::Status>;
    }
    /// Service describing handlers for resources.
    #[derive(Debug)]
    pub struct SecurityPostureServer<T> {
        inner: Arc<T>,
    ...
    impl<T> SecurityPostureServer<T> {
        pub fn new(inner: T) -> Self {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for SecurityPostureServer<T>
    where
        T: SecurityPosture,
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.cloud.securityposture.v1.SecurityPosture/ListPostures" => {
                    ...
                    struct ListPosturesSvc<T: SecurityPosture>(pub Arc<T>);
                    impl<
                        T: SecurityPosture,
                    > tonic::server::UnaryService<super::ListPosturesRequest>
                    for ListPosturesSvc<T> {
                        type Response = super::ListPosturesResponse;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as SecurityPosture>::list_postures(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let fut = async move {
                        let method = ListPosturesSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                ...
                "/google.cloud.securityposture.v1.SecurityPosture/ListPostureRevisions" => {
                    #[allow(non_camel_case_types)]
                    struct ListPostureRevisionsSvc<T: SecurityPosture>(pub Arc<T>);
                    impl<
                        T: SecurityPosture,
                    > tonic::server::UnaryService<super::ListPostureRevisionsRequest>
                    for ListPostureRevisionsSvc<T> {
                        type Response = super::ListPostureRevisionsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SecurityPosture>::list_posture_revisions(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ListPostureRevisionsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.securityposture.v1.SecurityPosture/GetPosture" => {
                    #[allow(non_camel_case_types)]
                    struct GetPostureSvc<T: SecurityPosture>(pub Arc<T>);
                    impl<
                        T: SecurityPosture,
                    > tonic::server::UnaryService<super::GetPostureRequest>
                    for GetPostureSvc<T> {
                        type Response = super::Posture;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SecurityPosture>::get_posture(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetPostureSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.securityposture.v1.SecurityPosture/CreatePosture" => {
                    #[allow(non_camel_case_types)]
                    struct CreatePostureSvc<T: SecurityPosture>(pub Arc<T>);
                    impl<
                        T: SecurityPosture,
                    > tonic::server::UnaryService<super::CreatePostureRequest>
                    for CreatePostureSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SecurityPosture>::create_posture(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = CreatePostureSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.securityposture.v1.SecurityPosture/UpdatePosture" => {
                    #[allow(non_camel_case_types)]
                    struct UpdatePostureSvc<T: SecurityPosture>(pub Arc<T>);
                    impl<
                        T: SecurityPosture,
                    > tonic::server::UnaryService<super::UpdatePostureRequest>
                    for UpdatePostureSvc<T> {
                        type Response = super::super::super::super::longrunning::Operation;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SecurityPosture>::update_posture(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = UpdatePostureSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.securityposture.v1.SecurityPosture/DeletePosture" => {
                    #[allow(non_camel_case_types)]
                    struct DeletePostureSvc<T: SecurityPosture>(pub Arc<T>);
                    impl<
                        T: SecurityPosture,
                    > tonic::server::UnaryService<super::DeletePostureRequest>
                    for DeletePostureSvc<T> {
                        type Response = super::super::super::super::longrunning::Operation;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SecurityPosture>::delete_posture(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = DeletePostureSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.securityposture.v1.SecurityPosture/ExtractPosture" => {
                    #[allow(non_camel_case_types)]
                    struct ExtractPostureSvc<T: SecurityPosture>(pub Arc<T>);
                    impl<
                        T: SecurityPosture,
                    > tonic::server::UnaryService<super::ExtractPostureRequest>
                    for ExtractPostureSvc<T> {
                        type Response = super::super::super::super::longrunning::Operation;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SecurityPosture>::extract_posture(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ExtractPostureSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.securityposture.v1.SecurityPosture/ListPostureDeployments" => {
                    #[allow(non_camel_case_types)]
                    struct ListPostureDeploymentsSvc<T: SecurityPosture>(pub Arc<T>);
                    impl<
                        T: SecurityPosture,
                    > tonic::server::UnaryService<super::ListPostureDeploymentsRequest>
                    for ListPostureDeploymentsSvc<T> {
                        type Response = super::ListPostureDeploymentsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SecurityPosture>::list_posture_deployments(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ListPostureDeploymentsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.securityposture.v1.SecurityPosture/GetPostureDeployment" => {
                    #[allow(non_camel_case_types)]
                    struct GetPostureDeploymentSvc<T: SecurityPosture>(pub Arc<T>);
                    impl<
                        T: SecurityPosture,
                    > tonic::server::UnaryService<super::GetPostureDeploymentRequest>
                    for GetPostureDeploymentSvc<T> {
                        type Response = super::PostureDeployment;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SecurityPosture>::get_posture_deployment(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetPostureDeploymentSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.securityposture.v1.SecurityPosture/CreatePostureDeployment" => {
                    #[allow(non_camel_case_types)]
                    struct CreatePostureDeploymentSvc<T: SecurityPosture>(pub Arc<T>);
                    impl<
                        T: SecurityPosture,
                    > tonic::server::UnaryService<super::CreatePostureDeploymentRequest>
                    for CreatePostureDeploymentSvc<T> {
                        type Response = super::super::super::super::longrunning::Operation;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            request: tonic::Request<
                                super::CreatePostureDeploymentRequest,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SecurityPosture>::create_posture_deployment(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = CreatePostureDeploymentSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.securityposture.v1.SecurityPosture/UpdatePostureDeployment" => {
                    #[allow(non_camel_case_types)]
                    struct UpdatePostureDeploymentSvc<T: SecurityPosture>(pub Arc<T>);
                    impl<
                        T: SecurityPosture,
                    > tonic::server::UnaryService<super::UpdatePostureDeploymentRequest>
                    for UpdatePostureDeploymentSvc<T> {
                        type Response = super::super::super::super::longrunning::Operation;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            &mut self,
                            request: tonic::Request<
                                super::UpdatePostureDeploymentRequest,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SecurityPosture>::update_posture_deployment(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = UpdatePostureDeploymentSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.securityposture.v1.SecurityPosture/DeletePostureDeployment" => {
                    #[allow(non_camel_case_types)]
                    struct DeletePostureDeploymentSvc<T: SecurityPosture>(pub Arc<T>);
                    impl<
                        T: SecurityPosture,
                    > tonic::server::UnaryService<super::DeletePostureDeploymentRequest>
                    for DeletePostureDeploymentSvc<T> {
                        type Response = super::super::super::super::longrunning::Operation;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            &mut self,
                            request: tonic::Request<
                                super::DeletePostureDeploymentRequest,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SecurityPosture>::delete_posture_deployment(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = DeletePostureDeploymentSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.securityposture.v1.SecurityPosture/ListPostureTemplates" => {
                    #[allow(non_camel_case_types)]
                    struct ListPostureTemplatesSvc<T: SecurityPosture>(pub Arc<T>);
                    impl<
                        T: SecurityPosture,
                    > tonic::server::UnaryService<super::ListPostureTemplatesRequest>
                    for ListPostureTemplatesSvc<T> {
                        type Response = super::ListPostureTemplatesResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SecurityPosture>::list_posture_templates(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ListPostureTemplatesSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/google.cloud.securityposture.v1.SecurityPosture/GetPostureTemplate" => {
                    #[allow(non_camel_case_types)]
                    struct GetPostureTemplateSvc<T: SecurityPosture>(pub Arc<T>);
                    impl<
                        T: SecurityPosture,
                    > tonic::server::UnaryService<super::GetPostureTemplateRequest>
                    for GetPostureTemplateSvc<T> {
                        type Response = super::PostureTemplate;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SecurityPosture>::get_posture_template(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetPostureTemplateSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for SecurityPostureServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "google.cloud.securityposture.v1.SecurityPosture";
    impl<T> tonic::server::NamedService for SecurityPostureServer<T> {
