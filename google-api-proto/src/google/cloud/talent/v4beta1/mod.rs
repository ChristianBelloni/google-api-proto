...
pub mod completion_server {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with CompletionServer.
    #[async_trait]
    pub trait Completion: std::marker::Send + std::marker::Sync + 'static {
        /// Completes the specified prefix with keyword suggestions.
        /// Intended for use by a job search auto-complete search box.
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for CompletionServer<T>
    where
        T: Completion,
                ...
                "/google.cloud.talent.v4beta1.Completion/CompleteQuery" => {
                    ...
                    for CompleteQuerySvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as Completion>::complete_query(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T> Clone for CompletionServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "google.cloud.talent.v4beta1.Completion";
    impl<T> tonic::server::NamedService for CompletionServer<T> {
...
pub mod tenant_service_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.cloud.talent.v4beta1.TenantService";
...
pub mod job_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn get_job(
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("google.cloud.talent.v4beta1.JobService", "GetJob"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("google.cloud.talent.v4beta1.JobService", "ListJobs"),
                );
            self.inner.unary(req, path, codec).await
        }
...
pub mod job_service_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/google.cloud.talent.v4beta1.JobService/BatchCreateJobs" => {
                    ...
                    impl<
                        T: JobService,
                    > tonic::server::UnaryService<super::BatchCreateJobsRequest>
                    for BatchCreateJobsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as JobService>::batch_create_jobs(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.talent.v4beta1.JobService/BatchUpdateJobs" => {
                    ...
                    impl<
                        T: JobService,
                    > tonic::server::UnaryService<super::BatchUpdateJobsRequest>
                    for BatchUpdateJobsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as JobService>::batch_update_jobs(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.talent.v4beta1.JobService/BatchDeleteJobs" => {
                    ...
                    impl<
                        T: JobService,
                    > tonic::server::UnaryService<super::BatchDeleteJobsRequest>
                    for BatchDeleteJobsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as JobService>::batch_delete_jobs(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.talent.v4beta1.JobService/SearchJobs" => {
                    ...
                    impl<
                        T: JobService,
                    > tonic::server::UnaryService<super::SearchJobsRequest>
                    for SearchJobsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as JobService>::search_jobs(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.talent.v4beta1.JobService/SearchJobsForAlert" => {
                    ...
                    for SearchJobsForAlertSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as JobService>::search_jobs_for_alert(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.cloud.talent.v4beta1.JobService";
...
pub mod company_service_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/google.cloud.talent.v4beta1.CompanyService/CreateCompany" => {
                    ...
                    impl<
                        T: CompanyService,
                    > tonic::server::UnaryService<super::CreateCompanyRequest>
                    for CreateCompanySvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as CompanyService>::create_company(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.talent.v4beta1.CompanyService/UpdateCompany" => {
                    ...
                    impl<
                        T: CompanyService,
                    > tonic::server::UnaryService<super::UpdateCompanyRequest>
                    for UpdateCompanySvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as CompanyService>::update_company(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.cloud.talent.v4beta1.CompanyService/DeleteCompany" => {
                    ...
                    impl<
                        T: CompanyService,
                    > tonic::server::UnaryService<super::DeleteCompanyRequest>
                    for DeleteCompanySvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as CompanyService>::delete_company(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.cloud.talent.v4beta1.CompanyService";
...
pub mod event_service_server {
                ...
                "/google.cloud.talent.v4beta1.EventService/CreateClientEvent" => {
                    ...
                    for CreateClientEventSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as EventService>::create_client_event(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "google.cloud.talent.v4beta1.EventService";
