...
pub mod web_risk_service_v1_beta1_server {
    ...
    #[async_trait]
    pub trait WebRiskServiceV1Beta1: std::marker::Send + std::marker::Sync + 'static {
        /// Gets the most recent threat list diffs.
    ...
    /// website and in client applications.
    #[derive(Debug)]
    pub struct WebRiskServiceV1Beta1Server<T> {
        inner: Arc<T>,
    ...
    impl<T> WebRiskServiceV1Beta1Server<T> {
        pub fn new(inner: T) -> Self {
    ...
    impl<T> Clone for WebRiskServiceV1Beta1Server<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "google.cloud.webrisk.v1beta1.WebRiskServiceV1Beta1";
    impl<T> tonic::server::NamedService for WebRiskServiceV1Beta1Server<T> {
