...
pub mod conformance_service_server {
    ...
    impl<T> ConformanceServiceServer<T> {
        pub fn new(inner: T) -> Self {
    ...
    pub const SERVICE_NAME: &str = "google.api.expr.conformance.v1alpha1.ConformanceService";
    impl<T> tonic::server::NamedService for ConformanceServiceServer<T> {
