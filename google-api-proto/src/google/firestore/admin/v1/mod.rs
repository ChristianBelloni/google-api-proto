...
pub mod firestore_admin_server {
    ...
    pub trait FirestoreAdmin: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn bulk_delete_documents(
            &self,
            request: tonic::Request<super::BulkDeleteDocumentsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::super::super::super::longrunning::Operation>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/google.firestore.admin.v1.FirestoreAdmin/BulkDeleteDocuments" => {
                    #[allow(non_camel_case_types)]
                    struct BulkDeleteDocumentsSvc<T: FirestoreAdmin>(pub Arc<T>);
                    impl<
                        T: FirestoreAdmin,
                    > tonic::server::UnaryService<super::BulkDeleteDocumentsRequest>
                    for BulkDeleteDocumentsSvc<T> {
                        type Response = super::super::super::super::longrunning::Operation;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as FirestoreAdmin>::bulk_delete_documents(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/google.firestore.admin.v1.FirestoreAdmin/CreateDatabase" => {
                    #[allow(non_camel_case_types)]
                    struct CreateDatabaseSvc<T: FirestoreAdmin>(pub Arc<T>);
                    impl<
                        T: FirestoreAdmin,
                    ...
                    for CreateDatabaseSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as FirestoreAdmin>::create_database(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.firestore.admin.v1.FirestoreAdmin/GetDatabase" => {
                    #[allow(non_camel_case_types)]
                    struct GetDatabaseSvc<T: FirestoreAdmin>(pub Arc<T>);
                    impl<
                        T: FirestoreAdmin,
                    ...
                    for GetDatabaseSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as FirestoreAdmin>::get_database(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.firestore.admin.v1.FirestoreAdmin/ListDatabases" => {
                    #[allow(non_camel_case_types)]
                    struct ListDatabasesSvc<T: FirestoreAdmin>(pub Arc<T>);
                    impl<
                        T: FirestoreAdmin,
                    ...
                    for ListDatabasesSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as FirestoreAdmin>::list_databases(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.firestore.admin.v1.FirestoreAdmin/UpdateDatabase" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateDatabaseSvc<T: FirestoreAdmin>(pub Arc<T>);
                    impl<
                        T: FirestoreAdmin,
                    ...
                    for UpdateDatabaseSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as FirestoreAdmin>::update_database(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.firestore.admin.v1.FirestoreAdmin/DeleteDatabase" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteDatabaseSvc<T: FirestoreAdmin>(pub Arc<T>);
                    impl<
                        T: FirestoreAdmin,
                    ...
                    for DeleteDatabaseSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as FirestoreAdmin>::delete_database(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.firestore.admin.v1.FirestoreAdmin/GetBackup" => {
                    #[allow(non_camel_case_types)]
                    struct GetBackupSvc<T: FirestoreAdmin>(pub Arc<T>);
                    impl<
                        T: FirestoreAdmin,
                    ...
                    for GetBackupSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as FirestoreAdmin>::get_backup(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.firestore.admin.v1.FirestoreAdmin/ListBackups" => {
                    #[allow(non_camel_case_types)]
                    struct ListBackupsSvc<T: FirestoreAdmin>(pub Arc<T>);
                    impl<
                        T: FirestoreAdmin,
                    ...
                    for ListBackupsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as FirestoreAdmin>::list_backups(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.firestore.admin.v1.FirestoreAdmin/DeleteBackup" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteBackupSvc<T: FirestoreAdmin>(pub Arc<T>);
                    impl<
                        T: FirestoreAdmin,
                    ...
                    for DeleteBackupSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as FirestoreAdmin>::delete_backup(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/google.firestore.admin.v1.FirestoreAdmin/RestoreDatabase" => {
                    #[allow(non_camel_case_types)]
                    struct RestoreDatabaseSvc<T: FirestoreAdmin>(pub Arc<T>);
                    impl<
                        T: FirestoreAdmin,
                    ...
                    for RestoreDatabaseSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as FirestoreAdmin>::restore_database(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.firestore.admin.v1.FirestoreAdmin/CreateBackupSchedule" => {
                    #[allow(non_camel_case_types)]
                    struct CreateBackupScheduleSvc<T: FirestoreAdmin>(pub Arc<T>);
                    impl<
                        T: FirestoreAdmin,
                    ...
                    for CreateBackupScheduleSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as FirestoreAdmin>::create_backup_schedule(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/google.firestore.admin.v1.FirestoreAdmin/GetBackupSchedule" => {
                    #[allow(non_camel_case_types)]
                    struct GetBackupScheduleSvc<T: FirestoreAdmin>(pub Arc<T>);
                    impl<
                        T: FirestoreAdmin,
                    ...
                    for GetBackupScheduleSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as FirestoreAdmin>::get_backup_schedule(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/google.firestore.admin.v1.FirestoreAdmin/ListBackupSchedules" => {
                    #[allow(non_camel_case_types)]
                    struct ListBackupSchedulesSvc<T: FirestoreAdmin>(pub Arc<T>);
                    impl<
                        T: FirestoreAdmin,
                    ...
                    for ListBackupSchedulesSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as FirestoreAdmin>::list_backup_schedules(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/google.firestore.admin.v1.FirestoreAdmin/UpdateBackupSchedule" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateBackupScheduleSvc<T: FirestoreAdmin>(pub Arc<T>);
                    impl<
                        T: FirestoreAdmin,
                    ...
                    for UpdateBackupScheduleSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as FirestoreAdmin>::update_backup_schedule(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/google.firestore.admin.v1.FirestoreAdmin/DeleteBackupSchedule" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteBackupScheduleSvc<T: FirestoreAdmin>(pub Arc<T>);
                    impl<
                        T: FirestoreAdmin,
                    ...
                    for DeleteBackupScheduleSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as FirestoreAdmin>::delete_backup_schedule(
                                        &inner,
                                        request,
                                    )
                                    .await
