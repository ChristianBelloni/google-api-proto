...
pub mod trip_service_server {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with TripServiceServer.
    #[async_trait]
    pub trait TripService: std::marker::Send + std::marker::Sync + 'static {
        /// Creates a trip in the Fleet Engine and returns the new trip.
        async fn create_trip(
            &self,
            request: tonic::Request<super::CreateTripRequest>,
        ) -> std::result::Result<tonic::Response<super::Trip>, tonic::Status>;
        /// Get information about a single trip.
        async fn get_trip(
            &self,
            request: tonic::Request<super::GetTripRequest>,
        ) -> std::result::Result<tonic::Response<super::Trip>, tonic::Status>;
        /// Report billable trip usage.
        async fn report_billable_trip(
            &self,
            request: tonic::Request<super::ReportBillableTripRequest>,
        ) -> std::result::Result<tonic::Response<()>, tonic::Status>;
        /// Get all the trips for a specific vehicle.
        async fn search_trips(
            &self,
            request: tonic::Request<super::SearchTripsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::SearchTripsResponse>,
            tonic::Status,
        >;
        ...
        async fn update_trip(
            &self,
            request: tonic::Request<super::UpdateTripRequest>,
        ) -> std::result::Result<tonic::Response<super::Trip>, tonic::Status>;
    }
    /// Trip management service.
    #[derive(Debug)]
    pub struct TripServiceServer<T> {
        inner: Arc<T>,
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for TripServiceServer<T>
    where
        T: TripService,
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/maps.fleetengine.v1.TripService/CreateTrip" => {
                    ...
                    struct CreateTripSvc<T: TripService>(pub Arc<T>);
                    impl<
                        T: TripService,
                    > tonic::server::UnaryService<super::CreateTripRequest>
                    for CreateTripSvc<T> {
                        type Response = super::Trip;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as TripService>::create_trip(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let fut = async move {
                        let method = CreateTripSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                ...
                "/maps.fleetengine.v1.TripService/GetTrip" => {
                    #[allow(non_camel_case_types)]
                    struct GetTripSvc<T: TripService>(pub Arc<T>);
                    impl<
                        T: TripService,
                    > tonic::server::UnaryService<super::GetTripRequest>
                    for GetTripSvc<T> {
                        type Response = super::Trip;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as TripService>::get_trip(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/maps.fleetengine.v1.TripService/ReportBillableTrip" => {
                    #[allow(non_camel_case_types)]
                    struct ReportBillableTripSvc<T: TripService>(pub Arc<T>);
                    impl<
                        T: TripService,
                    > tonic::server::UnaryService<super::ReportBillableTripRequest>
                    for ReportBillableTripSvc<T> {
                        type Response = ();
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as TripService>::report_billable_trip(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ReportBillableTripSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/maps.fleetengine.v1.TripService/SearchTrips" => {
                    #[allow(non_camel_case_types)]
                    struct SearchTripsSvc<T: TripService>(pub Arc<T>);
                    impl<
                        T: TripService,
                    > tonic::server::UnaryService<super::SearchTripsRequest>
                    for SearchTripsSvc<T> {
                        type Response = super::SearchTripsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as TripService>::search_trips(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = SearchTripsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/maps.fleetengine.v1.TripService/UpdateTrip" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateTripSvc<T: TripService>(pub Arc<T>);
                    impl<
                        T: TripService,
                    > tonic::server::UnaryService<super::UpdateTripRequest>
                    for UpdateTripSvc<T> {
                        type Response = super::Trip;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as TripService>::update_trip(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = UpdateTripSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for TripServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "maps.fleetengine.v1.TripService";
    impl<T> tonic::server::NamedService for TripServiceServer<T> {
...
pub mod vehicle_service_server {
    ...
    #[async_trait]
    pub trait VehicleService: std::marker::Send + std::marker::Sync + 'static {
        /// Instantiates a new vehicle associated with an on-demand rideshare or
        /// deliveries provider. Each `Vehicle` must have a unique vehicle ID.
        ///
        /// The following `Vehicle` fields are required when creating a `Vehicle`:
        ...
        async fn update_vehicle_attributes(
            &self,
            request: tonic::Request<super::UpdateVehicleAttributesRequest>,
        ) -> std::result::Result<
            tonic::Response<super::UpdateVehicleAttributesResponse>,
            tonic::Status,
        >;
        ...
        async fn search_vehicles(
            &self,
            request: tonic::Request<super::SearchVehiclesRequest>,
        ) -> std::result::Result<
            tonic::Response<super::SearchVehiclesResponse>,
            tonic::Status,
        >;
    ...
    /// Vehicle management service.
    #[derive(Debug)]
    pub struct VehicleServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/maps.fleetengine.v1.VehicleService/UpdateVehicleAttributes" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateVehicleAttributesSvc<T: VehicleService>(pub Arc<T>);
                    impl<
                        T: VehicleService,
                    > tonic::server::UnaryService<super::UpdateVehicleAttributesRequest>
                    for UpdateVehicleAttributesSvc<T> {
                        type Response = super::UpdateVehicleAttributesResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            request: tonic::Request<
                                super::UpdateVehicleAttributesRequest,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as VehicleService>::update_vehicle_attributes(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = UpdateVehicleAttributesSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/maps.fleetengine.v1.VehicleService/SearchVehicles" => {
                    #[allow(non_camel_case_types)]
                    struct SearchVehiclesSvc<T: VehicleService>(pub Arc<T>);
                    impl<
                        T: VehicleService,
                    > tonic::server::UnaryService<super::SearchVehiclesRequest>
                    for SearchVehiclesSvc<T> {
                        type Response = super::SearchVehiclesResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as VehicleService>::search_vehicles(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = SearchVehiclesSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for VehicleServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "maps.fleetengine.v1.VehicleService";
    impl<T> tonic::server::NamedService for VehicleServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
