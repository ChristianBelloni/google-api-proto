...
pub mod delivery_service_server {
    ...
    pub trait DeliveryService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn create_delivery_vehicle(
            &self,
            request: tonic::Request<super::CreateDeliveryVehicleRequest>,
        ) -> std::result::Result<tonic::Response<super::DeliveryVehicle>, tonic::Status>;
        /// Returns the specified `DeliveryVehicle` instance.
        async fn get_delivery_vehicle(
            &self,
            request: tonic::Request<super::GetDeliveryVehicleRequest>,
        ) -> std::result::Result<tonic::Response<super::DeliveryVehicle>, tonic::Status>;
        /// Writes updated `DeliveryVehicle` data to Fleet Engine, and assigns
        /// `Tasks` to the `DeliveryVehicle`. You cannot update the name of the
        /// `DeliveryVehicle`. You *can* update `remaining_vehicle_journey_segments`,
        ...
        async fn update_delivery_vehicle(
            &self,
            request: tonic::Request<super::UpdateDeliveryVehicleRequest>,
        ) -> std::result::Result<tonic::Response<super::DeliveryVehicle>, tonic::Status>;
        /// Creates and returns a batch of new `Task` objects.
        async fn batch_create_tasks(
            &self,
            request: tonic::Request<super::BatchCreateTasksRequest>,
        ) -> std::result::Result<
            tonic::Response<super::BatchCreateTasksResponse>,
            tonic::Status,
        >;
        ...
        async fn get_task_tracking_info(
            &self,
            request: tonic::Request<super::GetTaskTrackingInfoRequest>,
        ) -> std::result::Result<
            tonic::Response<super::TaskTrackingInfo>,
            tonic::Status,
        >;
        ...
        async fn list_delivery_vehicles(
            &self,
            request: tonic::Request<super::ListDeliveryVehiclesRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListDeliveryVehiclesResponse>,
            tonic::Status,
        >;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/maps.fleetengine.delivery.v1.DeliveryService/CreateDeliveryVehicle" => {
                    ...
                    struct CreateDeliveryVehicleSvc<T: DeliveryService>(pub Arc<T>);
                    impl<
                        T: DeliveryService,
                    > tonic::server::UnaryService<super::CreateDeliveryVehicleRequest>
                    for CreateDeliveryVehicleSvc<T> {
                        type Response = super::DeliveryVehicle;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as DeliveryService>::create_delivery_vehicle(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let fut = async move {
                        let method = CreateDeliveryVehicleSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                ...
                "/maps.fleetengine.delivery.v1.DeliveryService/GetDeliveryVehicle" => {
                    #[allow(non_camel_case_types)]
                    struct GetDeliveryVehicleSvc<T: DeliveryService>(pub Arc<T>);
                    impl<
                        T: DeliveryService,
                    > tonic::server::UnaryService<super::GetDeliveryVehicleRequest>
                    for GetDeliveryVehicleSvc<T> {
                        type Response = super::DeliveryVehicle;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DeliveryService>::get_delivery_vehicle(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetDeliveryVehicleSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/maps.fleetengine.delivery.v1.DeliveryService/UpdateDeliveryVehicle" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateDeliveryVehicleSvc<T: DeliveryService>(pub Arc<T>);
                    impl<
                        T: DeliveryService,
                    > tonic::server::UnaryService<super::UpdateDeliveryVehicleRequest>
                    for UpdateDeliveryVehicleSvc<T> {
                        type Response = super::DeliveryVehicle;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DeliveryService>::update_delivery_vehicle(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = UpdateDeliveryVehicleSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/maps.fleetengine.delivery.v1.DeliveryService/BatchCreateTasks" => {
                    #[allow(non_camel_case_types)]
                    struct BatchCreateTasksSvc<T: DeliveryService>(pub Arc<T>);
                    impl<
                        T: DeliveryService,
                    > tonic::server::UnaryService<super::BatchCreateTasksRequest>
                    for BatchCreateTasksSvc<T> {
                        type Response = super::BatchCreateTasksResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DeliveryService>::batch_create_tasks(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = BatchCreateTasksSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/maps.fleetengine.delivery.v1.DeliveryService/CreateTask" => {
                    #[allow(non_camel_case_types)]
                    struct CreateTaskSvc<T: DeliveryService>(pub Arc<T>);
                    impl<
                        T: DeliveryService,
                    ...
                    for CreateTaskSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DeliveryService>::create_task(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/maps.fleetengine.delivery.v1.DeliveryService/GetTask" => {
                    #[allow(non_camel_case_types)]
                    struct GetTaskSvc<T: DeliveryService>(pub Arc<T>);
                    impl<
                        T: DeliveryService,
                    ...
                    for GetTaskSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DeliveryService>::get_task(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/maps.fleetengine.delivery.v1.DeliveryService/UpdateTask" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateTaskSvc<T: DeliveryService>(pub Arc<T>);
                    impl<
                        T: DeliveryService,
                    ...
                    for UpdateTaskSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DeliveryService>::update_task(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/maps.fleetengine.delivery.v1.DeliveryService/ListTasks" => {
                    #[allow(non_camel_case_types)]
                    struct ListTasksSvc<T: DeliveryService>(pub Arc<T>);
                    impl<
                        T: DeliveryService,
                    ...
                    for ListTasksSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DeliveryService>::list_tasks(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/maps.fleetengine.delivery.v1.DeliveryService/GetTaskTrackingInfo" => {
                    #[allow(non_camel_case_types)]
                    struct GetTaskTrackingInfoSvc<T: DeliveryService>(pub Arc<T>);
                    impl<
                        T: DeliveryService,
                    > tonic::server::UnaryService<super::GetTaskTrackingInfoRequest>
                    for GetTaskTrackingInfoSvc<T> {
                        type Response = super::TaskTrackingInfo;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DeliveryService>::get_task_tracking_info(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetTaskTrackingInfoSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/maps.fleetengine.delivery.v1.DeliveryService/ListDeliveryVehicles" => {
                    #[allow(non_camel_case_types)]
                    struct ListDeliveryVehiclesSvc<T: DeliveryService>(pub Arc<T>);
                    impl<
                        T: DeliveryService,
                    > tonic::server::UnaryService<super::ListDeliveryVehiclesRequest>
                    for ListDeliveryVehiclesSvc<T> {
                        type Response = super::ListDeliveryVehiclesResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DeliveryService>::list_delivery_vehicles(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ListDeliveryVehiclesSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    pub const SERVICE_NAME: &str = "maps.fleetengine.delivery.v1.DeliveryService";
